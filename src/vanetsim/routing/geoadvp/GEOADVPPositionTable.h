...
#ifndef __INET_GEOADVPPOSITIONTABLE_H
#define __INET_GEOADVPPOSITIONTABLE_H
 ...
 */
class INET_API GEOADVPPositionTable
{
  private:
  ...
  public:
    ...
    friend std::ostream& operator << (std::ostream& o, const GEOADVPPositionTable& t);
};

} // namespace inet

#endif // ifndef __INET_GEOADVPPOSITIONTABLE_H
