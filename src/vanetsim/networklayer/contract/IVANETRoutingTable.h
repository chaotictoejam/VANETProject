 ...
 */
class INET_API IVANETRoutingTable
{
  public:
    virtual ~IVANETRoutingTable() {};
     ...
     */
    virtual IVANETRoute *findBestMatchingRoute(const L3Address& dest) const = 0;
     ...
     */
    virtual IVANETRoute *getRoute(int k) const = 0;

    /**
     * Finds and returns the default route, or nullptr if it doesn't exist
     */
    virtual IVANETRoute *getDefaultRoute() const = 0;    //XXX is this a universal concept?
     ...
     */
    virtual void addRoute(IVANETRoute *entry) = 0;
     ...
     */
    virtual IVANETRoute *removeRoute(IVANETRoute *entry) = 0;
     ...
     */
    virtual bool deleteRoute(IVANETRoute *entry) = 0;
