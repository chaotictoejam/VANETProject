...
#ifndef __GlobalWirelessWirelessLinkInspectorVanet_H_
#define __GlobalWirelessWirelessLinkInspectorVanet_H_
#include <vector>
#include <map>
#include <omnetpp.h>
#include "INETDefs.h"
...
class GlobalWirelessLinkInspectorVanet : public cSimpleModule
{
    public:
        class Link
        {
     ...
     public:
        GlobalWirelessLinkInspectorVanet();
        virtual ~GlobalWirelessLinkInspectorVanet();
