...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("VanetLocatorOpcode");
    if (!e) enums.getInstance()->add(e = new cEnum("VanetLocatorOpcode"));
...
Register_Class(VanetLocatorPkt);

VanetLocatorPkt::VanetLocatorPkt(const char *name, int kind) : ::cPacket(name,kind)
{
...
VanetLocatorPkt::VanetLocatorPkt(const VanetLocatorPkt& other) : ::cPacket(other)
{
    copy(other);
}

VanetLocatorPkt::~VanetLocatorPkt()
{
}

VanetLocatorPkt& VanetLocatorPkt::operator=(const VanetLocatorPkt& other)
{
...
void VanetLocatorPkt::copy(const VanetLocatorPkt& other)
{
...
void VanetLocatorPkt::parsimPack(cCommBuffer *b)
{
...
void VanetLocatorPkt::parsimUnpack(cCommBuffer *b)
{
...
int VanetLocatorPkt::getOpcode() const
{
    return opcode_var;
}

void VanetLocatorPkt::setOpcode(int opcode)
{
    this->opcode_var = opcode;
}

VanetAddress& VanetLocatorPkt::getOrigin()
{
    return origin_var;
}

void VanetLocatorPkt::setOrigin(const VanetAddress& origin)
{
    this->origin_var = origin;
}

unsigned int VanetLocatorPkt::getSequence() const
{
    return sequence_var;
}

void VanetLocatorPkt::setSequence(unsigned int sequence)
{
    this->sequence_var = sequence;
}

MACAddress& VanetLocatorPkt::getApMACAddress()
{
    return apMACAddress_var;
}

void VanetLocatorPkt::setApMACAddress(const MACAddress& apMACAddress)
{
    this->apMACAddress_var = apMACAddress;
}

MACAddress& VanetLocatorPkt::getStaMACAddress()
{
    return staMACAddress_var;
}

void VanetLocatorPkt::setStaMACAddress(const MACAddress& staMACAddress)
{
    this->staMACAddress_var = staMACAddress;
}

IPv4Address& VanetLocatorPkt::getApIPAddress()
{
    return apIPAddress_var;
}

void VanetLocatorPkt::setApIPAddress(const IPv4Address& apIPAddress)
{
    this->apIPAddress_var = apIPAddress;
}

IPv4Address& VanetLocatorPkt::getStaIPAddress()
{
    return staIPAddress_var;
}

void VanetLocatorPkt::setStaIPAddress(const IPv4Address& staIPAddress)
{
    this->staIPAddress_var = staIPAddress;
}

class VanetLocatorPktDescriptor : public cClassDescriptor
{
  public:
    VanetLocatorPktDescriptor();
    virtual ~VanetLocatorPktDescriptor();
...
Register_ClassDescriptor(VanetLocatorPktDescriptor);

VanetLocatorPktDescriptor::VanetLocatorPktDescriptor() : cClassDescriptor("VanetLocatorPkt", "cPacket")
{
}

VanetLocatorPktDescriptor::~VanetLocatorPktDescriptor()
{
}

bool VanetLocatorPktDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<VanetLocatorPkt *>(obj)!=NULL;
}

const char *VanetLocatorPktDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int VanetLocatorPktDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 7+basedesc->getFieldCount(object) : 7;
}

unsigned int VanetLocatorPktDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *VanetLocatorPktDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int VanetLocatorPktDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *VanetLocatorPktDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *VanetLocatorPktDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "VanetLocatorOpcode";
            return NULL;
        default: return NULL;
    }
}

int VanetLocatorPktDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    VanetLocatorPkt *pp = (VanetLocatorPkt *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string VanetLocatorPktDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool VanetLocatorPktDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *VanetLocatorPktDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *VanetLocatorPktDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
