/* -*- mode:c++ -*- ********************************************************
 * file:        MovingVANETMobilityBase.h
 *
...
#ifndef MOVING_VANET_MOBILITY_BASE_H
#define MOVING_VANET_MOBILITY_BASE_H
 ...
 */
class MovingVANETMobilityBase : public VANETMobilityBase
{
  protected:
  ...
  protected:
    MovingVANETMobilityBase();

    virtual ~MovingVANETMobilityBase();
