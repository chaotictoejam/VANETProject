...
#ifndef __INETVEINS_RTPPAYLOADSENDER_H
#define __INETVEINS_RTPPAYLOADSENDER_H
 ...
 */
class INETVEINS_API RTPPayloadSender : public cSimpleModule
{
  public:
    /**
     * Constructor.
...
#endif // ifndef __INETVEINS_RTPPAYLOADSENDER_H
