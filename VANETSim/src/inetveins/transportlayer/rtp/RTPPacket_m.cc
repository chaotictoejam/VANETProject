...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::rtp::RTPPacketEnums");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::rtp::RTPPacketEnums"));
...
RTPPacketDescriptor::RTPPacketDescriptor() : cClassDescriptor("inetveins::rtp::RTPPacket", "cPacket")
{
}
