...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::rtp::RTPSenderControlMessageCommands");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::rtp::RTPSenderControlMessageCommands"));
...
RTPSenderControlMessageDescriptor::RTPSenderControlMessageDescriptor() : cClassDescriptor("inetveins::rtp::RTPSenderControlMessage", "cPacket")
{
}
