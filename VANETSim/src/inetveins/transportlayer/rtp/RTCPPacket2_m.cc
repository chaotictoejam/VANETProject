//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/transportlayer/rtp/RTCPPacket2.msg.
//
...
RTCPReceiverReportPacket_Base::RTCPReceiverReportPacket_Base(const char *name, int kind) : ::inetveins::rtp::RTCPPacket(name,kind)
{
...
RTCPReceiverReportPacket_Base::RTCPReceiverReportPacket_Base(const RTCPReceiverReportPacket_Base& other) : ::inetveins::rtp::RTCPPacket(other)
{
    take(&(this->receptionReports_var));
    copy(other);
}
...
RTCPReceiverReportPacket_Base& RTCPReceiverReportPacket_Base::operator=(const RTCPReceiverReportPacket_Base& other)
{
    ...
    ::inetveins::rtp::RTCPPacket::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::rtp::RTCPPacket::parsimPack(b);
...
{
    ::inetveins::rtp::RTCPPacket::parsimUnpack(b);
...
RTCPReceiverReportPacketDescriptor::RTCPReceiverReportPacketDescriptor() : cClassDescriptor("inetveins::rtp::RTCPReceiverReportPacket", "inetveins::rtp::RTCPPacket")
{
}
...
RTCPSDESPacket_Base::RTCPSDESPacket_Base(const char *name, int kind) : ::inetveins::rtp::RTCPPacket(name,kind)
{
...
RTCPSDESPacket_Base::RTCPSDESPacket_Base(const RTCPSDESPacket_Base& other) : ::inetveins::rtp::RTCPPacket(other)
{
    take(&(this->sdesChunks_var));
    copy(other);
}
...
RTCPSDESPacketDescriptor::RTCPSDESPacketDescriptor() : cClassDescriptor("inetveins::rtp::RTCPSDESPacket", "inetveins::rtp::RTCPPacket")
{
}
...
RTCPByePacket_Base::RTCPByePacket_Base(const char *name, int kind) : ::inetveins::rtp::RTCPPacket(name,kind)
{
...
RTCPByePacket_Base::RTCPByePacket_Base(const RTCPByePacket_Base& other) : ::inetveins::rtp::RTCPPacket(other)
{
    copy(other);
}
...
RTCPByePacketDescriptor::RTCPByePacketDescriptor() : cClassDescriptor("inetveins::rtp::RTCPByePacket", "inetveins::rtp::RTCPPacket")
{
}
