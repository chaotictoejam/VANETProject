...
#ifndef __INETVEINS_RTCPPACKET1_H
#define __INETVEINS_RTCPPACKET1_H

#include "inetveins/common/INETVEINSDefs.h"

#include "inetveins/transportlayer/rtp/RTCPPacket1_m.h"

namespace inetveins {

namespace rtp {

class INETVEINS_API RTCPPacket : public RTCPPacket_Base
{
  public:
...
class INETVEINS_API RTCPCompoundPacket : public RTCPCompoundPacket_Base
{
  public:
...
#endif    // __INETVEINS_RTCPPACKET1_H_
