//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/transportlayer/rtp/RTPSenderStatusMessage.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::rtp::RTPSenderStatus");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::rtp::RTPSenderStatus"));
...
RTPSenderStatusMessageDescriptor::RTPSenderStatusMessageDescriptor() : cClassDescriptor("inetveins::rtp::RTPSenderStatusMessage", "cPacket")
{
}
