//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/transportlayer/rtp/RTPInnerPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::rtp::RTP_INP_TYPE");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::rtp::RTP_INP_TYPE"));
...
RTPInnerPacketDescriptor::RTPInnerPacketDescriptor() : cClassDescriptor("inetveins::rtp::RTPInnerPacket", "cPacket")
{
}
...
const char *RTPInnerPacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::rtp::RTP_INP_TYPE";
            return NULL;
        default: return NULL;
    }
}
