//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/transportlayer/rtp/RTCPPacket1.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::rtp::RTCPPacketType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::rtp::RTCPPacketType"));
...
RTCPPacketDescriptor::RTCPPacketDescriptor() : cClassDescriptor("inetveins::rtp::RTCPPacket", "cPacket")
{
}
...
const char *RTCPPacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 3:
            if (!strcmp(propertyname,"enum")) return "inetveins::rtp::RTCPPacketType";
            return NULL;
        default: return NULL;
    }
}
...
RTCPCompoundPacketDescriptor::RTCPCompoundPacketDescriptor() : cClassDescriptor("inetveins::rtp::RTCPCompoundPacket", "cPacket")
{
}
