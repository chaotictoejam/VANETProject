//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/transportlayer/rtp/RTPParticipantInfo.msg.
//
...
RTPParticipantInfoDescriptor::RTPParticipantInfoDescriptor() : cClassDescriptor("inetveins::rtp::RTPParticipantInfo", "cNamedObject")
{
}
