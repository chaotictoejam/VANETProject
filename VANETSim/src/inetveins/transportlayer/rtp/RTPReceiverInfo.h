...
#ifndef __INETVEINS_RTPRECEIVERINFO_H
#define __INETVEINS_RTPRECEIVERINFO_H
 ...
 */
class INETVEINS_API RTPReceiverInfo : public RTPParticipantInfo
{
  public:
...
#endif // ifndef __INETVEINS_RTPRECEIVERINFO_H
