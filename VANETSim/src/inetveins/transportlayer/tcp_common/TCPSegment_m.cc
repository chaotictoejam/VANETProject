...
TCPPayloadMessageDescriptor::TCPPayloadMessageDescriptor() : cClassDescriptor("inetveins::tcp::TCPPayloadMessage", "")
{
}
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::tcp::TCPOptionNumbers");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::tcp::TCPOptionNumbers"));
...
SackItemDescriptor::SackItemDescriptor() : cClassDescriptor("inetveins::tcp::SackItem", "cObject")
{
}
...
Sack_Base::Sack_Base() : ::inetveins::tcp::SackItem()
{
}

Sack_Base::Sack_Base(const Sack_Base& other) : ::inetveins::tcp::SackItem(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::tcp::SackItem::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::tcp::SackItem::parsimPack(b);
}

void Sack_Base::parsimUnpack(cCommBuffer *b)
{
    ::inetveins::tcp::SackItem::parsimUnpack(b);
}
...
SackDescriptor::SackDescriptor() : cClassDescriptor("inetveins::tcp::Sack", "inetveins::tcp::SackItem")
{
}
...
TCPOptionDescriptor::TCPOptionDescriptor() : cClassDescriptor("inetveins::tcp::TCPOption", "cObject")
{
}
...
const char *TCPOptionDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::tcp::TCPOptionNumbers";
            return NULL;
        default: return NULL;
    }
}
...
TCPOptionEnd::TCPOptionEnd() : ::inetveins::tcp::TCPOption()
{
    this->setKind(TCPOPTION_END_OF_OPTION_LIST);
    this->setLength(1);
}

TCPOptionEnd::TCPOptionEnd(const TCPOptionEnd& other) : ::inetveins::tcp::TCPOption(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::tcp::TCPOption::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::tcp::TCPOption::parsimPack(b);
}

void TCPOptionEnd::parsimUnpack(cCommBuffer *b)
{
    ::inetveins::tcp::TCPOption::parsimUnpack(b);
}
...
TCPOptionEndDescriptor::TCPOptionEndDescriptor() : cClassDescriptor("inetveins::tcp::TCPOptionEnd", "inetveins::tcp::TCPOption")
{
}
...
TCPOptionNop::TCPOptionNop() : ::inetveins::tcp::TCPOption()
{
    this->setKind(TCPOPTION_NO_OPERATION);
    this->setLength(1);
}

TCPOptionNop::TCPOptionNop(const TCPOptionNop& other) : ::inetveins::tcp::TCPOption(other)
{
    copy(other);
}
...
TCPOptionNopDescriptor::TCPOptionNopDescriptor() : cClassDescriptor("inetveins::tcp::TCPOptionNop", "inetveins::tcp::TCPOption")
{
}
...
TCPOptionMaxSegmentSize::TCPOptionMaxSegmentSize() : ::inetveins::tcp::TCPOption()
{
...
TCPOptionMaxSegmentSize::TCPOptionMaxSegmentSize(const TCPOptionMaxSegmentSize& other) : ::inetveins::tcp::TCPOption(other)
{
    copy(other);
}
...
TCPOptionMaxSegmentSizeDescriptor::TCPOptionMaxSegmentSizeDescriptor() : cClassDescriptor("inetveins::tcp::TCPOptionMaxSegmentSize", "inetveins::tcp::TCPOption")
{
}
...
TCPOptionWindowScale::TCPOptionWindowScale() : ::inetveins::tcp::TCPOption()
{
...
TCPOptionWindowScale::TCPOptionWindowScale(const TCPOptionWindowScale& other) : ::inetveins::tcp::TCPOption(other)
{
    copy(other);
}
...
TCPOptionWindowScaleDescriptor::TCPOptionWindowScaleDescriptor() : cClassDescriptor("inetveins::tcp::TCPOptionWindowScale", "inetveins::tcp::TCPOption")
{
}
...
TCPOptionSackPermitted::TCPOptionSackPermitted() : ::inetveins::tcp::TCPOption()
{
    this->setKind(TCPOPTION_SACK_PERMITTED);
    this->setLength(2);
}

TCPOptionSackPermitted::TCPOptionSackPermitted(const TCPOptionSackPermitted& other) : ::inetveins::tcp::TCPOption(other)
{
    copy(other);
}
...
TCPOptionSackPermittedDescriptor::TCPOptionSackPermittedDescriptor() : cClassDescriptor("inetveins::tcp::TCPOptionSackPermitted", "inetveins::tcp::TCPOption")
{
}
...
TCPOptionSack::TCPOptionSack() : ::inetveins::tcp::TCPOption()
{
...
TCPOptionSack::TCPOptionSack(const TCPOptionSack& other) : ::inetveins::tcp::TCPOption(other)
{
    sackItem_arraysize = 0;
    this->sackItem_var = 0;
    copy(other);
...
TCPOptionSackDescriptor::TCPOptionSackDescriptor() : cClassDescriptor("inetveins::tcp::TCPOptionSack", "inetveins::tcp::TCPOption")
{
}
...
TCPOptionTimestamp::TCPOptionTimestamp() : ::inetveins::tcp::TCPOption()
{
...
TCPOptionTimestamp::TCPOptionTimestamp(const TCPOptionTimestamp& other) : ::inetveins::tcp::TCPOption(other)
{
    copy(other);
}
...
TCPOptionTimestampDescriptor::TCPOptionTimestampDescriptor() : cClassDescriptor("inetveins::tcp::TCPOptionTimestamp", "inetveins::tcp::TCPOption")
{
}
...
TCPOptionUnknown::TCPOptionUnknown() : ::inetveins::tcp::TCPOption()
{
    this->setKind(-1);
...
TCPOptionUnknown::TCPOptionUnknown(const TCPOptionUnknown& other) : ::inetveins::tcp::TCPOption(other)
{
    bytes_arraysize = 0;
    this->bytes_var = 0;
    copy(other);
...
TCPOptionUnknownDescriptor::TCPOptionUnknownDescriptor() : cClassDescriptor("inetveins::tcp::TCPOptionUnknown", "inetveins::tcp::TCPOption")
{
}
...
TCPSegmentDescriptor::TCPSegmentDescriptor() : cClassDescriptor("inetveins::tcp::TCPSegment", "cPacket")
{
}
