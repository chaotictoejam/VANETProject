...
TCPConnection *TCPConnection::cloneListeningConnection()
{
    ...
    conn->sendQueue = check_and_cast<TCPSendQueue *>(inetveins::utils::createOne(sendQueueClass));
    conn->sendQueue->setConnection(conn);

    const char *receiveQueueClass = receiveQueue->getClassName();
    conn->receiveQueue = check_and_cast<TCPReceiveQueue *>(inetveins::utils::createOne(receiveQueueClass));
    ...
    conn->tcpAlgorithm = check_and_cast<TCPAlgorithm *>(inetveins::utils::createOne(tcpAlgorithmClass));
...
void TCPConnection::initConnection(TCPOpenCommand *openCmd)
{
    ...
    tcpAlgorithm = check_and_cast<TCPAlgorithm *>(inetveins::utils::createOne(tcpAlgorithmClass));
