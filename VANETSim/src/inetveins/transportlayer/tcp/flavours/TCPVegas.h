...
#ifndef __INETVEINS_TCPVEGAS_H
#define __INETVEINS_TCPVEGAS_H
 ...
 */
class INETVEINS_API TCPVegasStateVariables : public TCPBaseAlgStateVariables
{
  public:
...
class INETVEINS_API TCPVegas : public TCPBaseAlg
{
  protected:
...
#endif // ifndef __INETVEINS_TCPVEGAS_H
