...
#ifndef __INETVEINS_SCTPRECEIVESTREAM_H
#define __INETVEINS_SCTPRECEIVESTREAM_H
...
class INETVEINS_API SCTPReceiveStream : public cObject
{
  protected:
    uint16 streamId;
...
#endif // ifndef __INETVEINS_SCTPRECEIVESTREAM_H
