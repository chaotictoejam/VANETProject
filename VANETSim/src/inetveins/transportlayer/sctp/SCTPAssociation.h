...
#include "inetveins/transportlayer/sctp/SCTPGapList.h"
#include "inetveins/transportlayer/sctp/SCTPQueue.h"
#include "inetveins/transportlayer/sctp/SCTPSendStream.h"
#include "inetveins/transportlayer/sctp/SCTPReceiveStream.h"
...
class INETVEINS_API SCTPPathVariables : public cObject
{
  public:
...
class INETVEINS_API SCTPDataVariables : public cObject
{
  public:
    SCTPDataVariables();
    ~SCTPDataVariables();
...
class INETVEINS_API SCTPStateVariables : public cObject
{
  public:
    SCTPStateVariables();
    ~SCTPStateVariables();
...
class INETVEINS_API SCTPAssociation : public cObject
{
    friend class SCTP;
