 ...
 */
class INETVEINS_API SCTPMessage : public SCTPMessage_Base, public ITransportPacket
{
  protected:
...
class INETVEINS_API SCTPErrorChunk : public SCTPErrorChunk_Base
{
  protected:
...
class INETVEINS_API SCTPStreamResetChunk : public SCTPStreamResetChunk_Base
{
  protected:
    std::vector<cPacket *> parameterList;
...
class INETVEINS_API SCTPAsconfChunk : public SCTPAsconfChunk_Base
{
  protected:
    std::vector<cPacket *> parameterList;
...
class INETVEINS_API SCTPAsconfAckChunk : public SCTPAsconfAckChunk_Base
{
  protected:
    std::vector<cPacket *> parameterList;
  ...
  public:
     ...
     * Returns the kth parameter in this SCTP Reset Chunk
     */
    virtual cPacketPtr& getAsconfResponse(uint32 k) override;
