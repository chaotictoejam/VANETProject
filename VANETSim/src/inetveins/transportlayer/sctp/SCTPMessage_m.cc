...
SCTPMessageDescriptor::SCTPMessageDescriptor() : cClassDescriptor("inetveins::sctp::SCTPMessage", "cPacket")
{
}
...
SCTPChunkDescriptor::SCTPChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPChunk", "cPacket")
{
}
...
SCTPInitChunk::SCTPInitChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->initTag_var = 0;
    this->a_rwnd_var = 0;
    ...
    this->ipv4Supported_var = 0;
    this->ipv6Supported_var = 0;
...
SCTPInitChunk::SCTPInitChunk(const SCTPInitChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    addresses_arraysize = 0;
    this->addresses_var = 0;
    unrecognizedParameters_arraysize = 0;
...
{
    if (this==&other) return *this;
    ::inetveins::sctp::SCTPChunk::operator=(other);
    copy(other);
    return *this;
}
...
void SCTPInitChunk::copy(const SCTPInitChunk& other)
{
    ...
    this->ipv4Supported_var = other.ipv4Supported_var;
    this->ipv6Supported_var = other.ipv6Supported_var;
    delete [] this->addresses_var;
    this->addresses_var = (other.addresses_arraysize==0) ? NULL : new L3Address[other.addresses_arraysize];
...
{
    ::inetveins::sctp::SCTPChunk::parsimPack(b);
    ...
    doPacking(b,this->ipv4Supported_var);
    doPacking(b,this->ipv6Supported_var);
...
{
    ::inetveins::sctp::SCTPChunk::parsimUnpack(b);
    ...
    doUnpacking(b,this->ipv4Supported_var);
    doUnpacking(b,this->ipv6Supported_var);
    delete [] this->addresses_var;
    b->unpack(addresses_arraysize);
    if (addresses_arraysize==0) {
        this->addresses_var = 0;
    } else {
        this->addresses_var = new L3Address[addresses_arraysize];
...
SCTPInitChunkDescriptor::SCTPInitChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPInitChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPInitAckChunk::SCTPInitAckChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->initTag_var = 0;
    this->a_rwnd_var = 0;
    this->noOutStreams_var = 0;
...
SCTPInitAckChunk::SCTPInitAckChunk(const SCTPInitAckChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    addresses_arraysize = 0;
    this->addresses_var = 0;
    cookie_arraysize = 0;
...
SCTPInitAckChunkDescriptor::SCTPInitAckChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPInitAckChunk", "inetveins::sctp::SCTPChunk")
{
}
...
const char *SCTPInitAckChunkDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 8: return opp_typename(typeid(L3Address));
        case 11: return opp_typename(typeid(cPacketPtr));
        default: return NULL;
    };
}
...
SCTPCookieEchoChunk::SCTPCookieEchoChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    cookie_arraysize = 0;
    this->cookie_var = 0;
    this->stateCookie_var = nullptr;
...
SCTPCookieEchoChunk::SCTPCookieEchoChunk(const SCTPCookieEchoChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    cookie_arraysize = 0;
    this->cookie_var = 0;
    unrecognizedParameters_arraysize = 0;
...
SCTPCookieEchoChunkDescriptor::SCTPCookieEchoChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPCookieEchoChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPCookieDescriptor::SCTPCookieDescriptor() : cClassDescriptor("inetveins::sctp::SCTPCookie", "cPacket")
{
}
...
SCTPCookieAckChunk::SCTPCookieAckChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
}

SCTPCookieAckChunk::SCTPCookieAckChunk(const SCTPCookieAckChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPCookieAckChunkDescriptor::SCTPCookieAckChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPCookieAckChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPDataMsgDescriptor::SCTPDataMsgDescriptor() : cClassDescriptor("inetveins::sctp::SCTPDataMsg", "cPacket")
{
}
...
SCTPDataChunk::SCTPDataChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->eBit_var = 0;
    this->bBit_var = 0;
    this->uBit_var = 0;
...
SCTPDataChunk::SCTPDataChunk(const SCTPDataChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPDataChunkDescriptor::SCTPDataChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPDataChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPForwardTsnChunk::SCTPForwardTsnChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
...
SCTPForwardTsnChunk::SCTPForwardTsnChunk(const SCTPForwardTsnChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    sid_arraysize = 0;
    this->sid_var = 0;
    ssn_arraysize = 0;
...
SCTPForwardTsnChunkDescriptor::SCTPForwardTsnChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPForwardTsnChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPSackChunk::SCTPSackChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
...
SCTPSackChunk::SCTPSackChunk(const SCTPSackChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    gapStart_arraysize = 0;
    this->gapStart_var = 0;
    gapStop_arraysize = 0;
...
SCTPSackChunkDescriptor::SCTPSackChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPSackChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPAbortChunk::SCTPAbortChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->T_Bit_var = 0;
}

SCTPAbortChunk::SCTPAbortChunk(const SCTPAbortChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPAbortChunkDescriptor::SCTPAbortChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPAbortChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPHeartbeatChunk::SCTPHeartbeatChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
...
SCTPHeartbeatChunk::SCTPHeartbeatChunk(const SCTPHeartbeatChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    info_arraysize = 0;
    this->info_var = 0;
    copy(other);
...
SCTPHeartbeatChunkDescriptor::SCTPHeartbeatChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPHeartbeatChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPHeartbeatAckChunk::SCTPHeartbeatAckChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->timeField_var = 0;
    info_arraysize = 0;
    this->info_var = 0;
...
SCTPHeartbeatAckChunk::SCTPHeartbeatAckChunk(const SCTPHeartbeatAckChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    info_arraysize = 0;
    this->info_var = 0;
    copy(other);
...
SCTPHeartbeatAckChunkDescriptor::SCTPHeartbeatAckChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPHeartbeatAckChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPShutdownChunk::SCTPShutdownChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->cumTsnAck_var = 0;
}

SCTPShutdownChunk::SCTPShutdownChunk(const SCTPShutdownChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPShutdownChunkDescriptor::SCTPShutdownChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPShutdownChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPShutdownAckChunk::SCTPShutdownAckChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
}

SCTPShutdownAckChunk::SCTPShutdownAckChunk(const SCTPShutdownAckChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPShutdownAckChunkDescriptor::SCTPShutdownAckChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPShutdownAckChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPShutdownCompleteChunk::SCTPShutdownCompleteChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->TBit_var = 0;
}

SCTPShutdownCompleteChunk::SCTPShutdownCompleteChunk(const SCTPShutdownCompleteChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPShutdownCompleteChunkDescriptor::SCTPShutdownCompleteChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPShutdownCompleteChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPErrorChunk_Base::SCTPErrorChunk_Base(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->TBit_var = 0;
    this->MBit_var = 0;
}

SCTPErrorChunk_Base::SCTPErrorChunk_Base(const SCTPErrorChunk_Base& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPErrorChunkDescriptor::SCTPErrorChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPErrorChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPParameterDescriptor::SCTPParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPParameter", "cPacket")
{
}
...
SCTPPacketDropChunk::SCTPPacketDropChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->cFlag_var = 0;
    this->tFlag_var = 0;
    this->bFlag_var = 0;
...
SCTPPacketDropChunk::SCTPPacketDropChunk(const SCTPPacketDropChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPPacketDropChunkDescriptor::SCTPPacketDropChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPPacketDropChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPStreamResetChunk_Base::SCTPStreamResetChunk_Base(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
}

SCTPStreamResetChunk_Base::SCTPStreamResetChunk_Base(const SCTPStreamResetChunk_Base& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPStreamResetChunkDescriptor::SCTPStreamResetChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPStreamResetChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPOutgoingSSNResetRequestParameter::SCTPOutgoingSSNResetRequestParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->srReqSn_var = 0;
    this->srResSn_var = 0;
    this->lastTsn_var = 0;
...
SCTPOutgoingSSNResetRequestParameter::SCTPOutgoingSSNResetRequestParameter(const SCTPOutgoingSSNResetRequestParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    streamNumbers_arraysize = 0;
    this->streamNumbers_var = 0;
    copy(other);
...
{
    if (this==&other) return *this;
    ::inetveins::sctp::SCTPParameter::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::sctp::SCTPParameter::parsimPack(b);
...
{
    ::inetveins::sctp::SCTPParameter::parsimUnpack(b);
...
SCTPOutgoingSSNResetRequestParameterDescriptor::SCTPOutgoingSSNResetRequestParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPOutgoingSSNResetRequestParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPIncomingSSNResetRequestParameter::SCTPIncomingSSNResetRequestParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->srReqSn_var = 0;
    streamNumbers_arraysize = 0;
    this->streamNumbers_var = 0;
...
SCTPIncomingSSNResetRequestParameter::SCTPIncomingSSNResetRequestParameter(const SCTPIncomingSSNResetRequestParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    streamNumbers_arraysize = 0;
    this->streamNumbers_var = 0;
    copy(other);
...
SCTPIncomingSSNResetRequestParameterDescriptor::SCTPIncomingSSNResetRequestParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPIncomingSSNResetRequestParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPSSNTSNResetRequestParameter::SCTPSSNTSNResetRequestParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->srReqSn_var = 0;
}

SCTPSSNTSNResetRequestParameter::SCTPSSNTSNResetRequestParameter(const SCTPSSNTSNResetRequestParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    copy(other);
}
...
SCTPSSNTSNResetRequestParameterDescriptor::SCTPSSNTSNResetRequestParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPSSNTSNResetRequestParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPStreamResetResponseParameter::SCTPStreamResetResponseParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->srResSn_var = 0;
    this->result_var = 0;
...
SCTPStreamResetResponseParameter::SCTPStreamResetResponseParameter(const SCTPStreamResetResponseParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    copy(other);
}
...
SCTPStreamResetResponseParameterDescriptor::SCTPStreamResetResponseParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPStreamResetResponseParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPResetTimerDescriptor::SCTPResetTimerDescriptor() : cClassDescriptor("inetveins::sctp::SCTPResetTimer", "cPacket")
{
}
...
SCTPAuthenticationChunk::SCTPAuthenticationChunk(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
...
SCTPAuthenticationChunk::SCTPAuthenticationChunk(const SCTPAuthenticationChunk& other) : ::inetveins::sctp::SCTPChunk(other)
{
    HMAC_arraysize = 0;
    this->HMAC_var = 0;
    copy(other);
...
SCTPAuthenticationChunkDescriptor::SCTPAuthenticationChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPAuthenticationChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPAsconfChunk_Base::SCTPAsconfChunk_Base(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->serialNumber_var = 0;
    this->peerVTag_var = 0;
}

SCTPAsconfChunk_Base::SCTPAsconfChunk_Base(const SCTPAsconfChunk_Base& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPAsconfChunkDescriptor::SCTPAsconfChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPAsconfChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPAsconfAckChunk_Base::SCTPAsconfAckChunk_Base(const char *name, int kind) : ::inetveins::sctp::SCTPChunk(name,kind)
{
    this->serialNumber_var = 0;
}

SCTPAsconfAckChunk_Base::SCTPAsconfAckChunk_Base(const SCTPAsconfAckChunk_Base& other) : ::inetveins::sctp::SCTPChunk(other)
{
    copy(other);
}
...
SCTPAsconfAckChunkDescriptor::SCTPAsconfAckChunkDescriptor() : cClassDescriptor("inetveins::sctp::SCTPAsconfAckChunk", "inetveins::sctp::SCTPChunk")
{
}
...
SCTPAddIPParameter::SCTPAddIPParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->requestCorrelationId_var = 0;
}

SCTPAddIPParameter::SCTPAddIPParameter(const SCTPAddIPParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    copy(other);
}
...
SCTPAddIPParameterDescriptor::SCTPAddIPParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPAddIPParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPDeleteIPParameter::SCTPDeleteIPParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->requestCorrelationId_var = 0;
}

SCTPDeleteIPParameter::SCTPDeleteIPParameter(const SCTPDeleteIPParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    copy(other);
}
...
SCTPDeleteIPParameterDescriptor::SCTPDeleteIPParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPDeleteIPParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPSetPrimaryIPParameter::SCTPSetPrimaryIPParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->requestCorrelationId_var = 0;
}

SCTPSetPrimaryIPParameter::SCTPSetPrimaryIPParameter(const SCTPSetPrimaryIPParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    copy(other);
}
...
SCTPSetPrimaryIPParameterDescriptor::SCTPSetPrimaryIPParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPSetPrimaryIPParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPSupportedExtensionsParameter::SCTPSupportedExtensionsParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    chunkTypes_arraysize = 0;
    this->chunkTypes_var = 0;
}

SCTPSupportedExtensionsParameter::SCTPSupportedExtensionsParameter(const SCTPSupportedExtensionsParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    chunkTypes_arraysize = 0;
    this->chunkTypes_var = 0;
    copy(other);
...
SCTPSupportedExtensionsParameterDescriptor::SCTPSupportedExtensionsParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPSupportedExtensionsParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPErrorCauseParameter::SCTPErrorCauseParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->responseCorrelationId_var = 0;
    this->errorCauseType_var = 0;
}

SCTPErrorCauseParameter::SCTPErrorCauseParameter(const SCTPErrorCauseParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    copy(other);
}
...
SCTPErrorCauseParameterDescriptor::SCTPErrorCauseParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPErrorCauseParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPSimpleErrorCauseParameter::SCTPSimpleErrorCauseParameter(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->value_var = 0;
}

SCTPSimpleErrorCauseParameter::SCTPSimpleErrorCauseParameter(const SCTPSimpleErrorCauseParameter& other) : ::inetveins::sctp::SCTPParameter(other)
{
    copy(other);
}
...
SCTPSimpleErrorCauseParameterDescriptor::SCTPSimpleErrorCauseParameterDescriptor() : cClassDescriptor("inetveins::sctp::SCTPSimpleErrorCauseParameter", "inetveins::sctp::SCTPParameter")
{
}
...
SCTPSuccessIndication::SCTPSuccessIndication(const char *name, int kind) : ::inetveins::sctp::SCTPParameter(name,kind)
{
    this->responseCorrelationId_var = 0;
}

SCTPSuccessIndication::SCTPSuccessIndication(const SCTPSuccessIndication& other) : ::inetveins::sctp::SCTPParameter(other)
{
    copy(other);
}
...
SCTPSuccessIndicationDescriptor::SCTPSuccessIndicationDescriptor() : cClassDescriptor("inetveins::sctp::SCTPSuccessIndication", "inetveins::sctp::SCTPParameter")
{
}
...
void NatMessage::copy(const NatMessage& other)
{
    ...
    this->peer1Addresses_var = (other.peer1Addresses_arraysize==0) ? NULL : new L3Address[other.peer1Addresses_arraysize];
    ...
    this->peer2Addresses_var = (other.peer2Addresses_arraysize==0) ? NULL : new L3Address[other.peer2Addresses_arraysize];
...
void NatMessage::parsimUnpack(cCommBuffer *b)
{
    ...
    if (peer1Addresses_arraysize==0) {
        ...
        this->peer1Addresses_var = new L3Address[peer1Addresses_arraysize];
    ...
    if (peer2Addresses_arraysize==0) {
        ...
        this->peer2Addresses_var = new L3Address[peer2Addresses_arraysize];
...
{
    L3Address *peer1Addresses_var2 = (size==0) ? NULL : new L3Address[size];
...
{
    L3Address *peer2Addresses_var2 = (size==0) ? NULL : new L3Address[size];
...
NatMessageDescriptor::NatMessageDescriptor() : cClassDescriptor("inetveins::sctp::NatMessage", "cPacket")
{
}
