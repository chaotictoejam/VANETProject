...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::UdpConstants");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::UdpConstants"));
...
UDPPacketDescriptor::UDPPacketDescriptor() : cClassDescriptor("inetveins::UDPPacket", "cPacket")
{
}
