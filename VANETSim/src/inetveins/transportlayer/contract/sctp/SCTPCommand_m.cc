//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/transportlayer/contract/sctp/SCTPCommand.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::SCTPErrorCode");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::SCTPErrorCode"));
);
...
SCTPCommandDescriptor::SCTPCommandDescriptor() : cClassDescriptor("inetveins::SCTPCommand", "cPacket")
{
}
...
SCTPErrorInfo::SCTPErrorInfo(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
    this->errorCode_var = 0;
    this->messageText_var = 0;
}

SCTPErrorInfo::SCTPErrorInfo(const SCTPErrorInfo& other) : ::inetveins::SCTPCommand(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::SCTPCommand::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::SCTPCommand::parsimPack(b);
...
{
    ::inetveins::SCTPCommand::parsimUnpack(b);
...
SCTPErrorInfoDescriptor::SCTPErrorInfoDescriptor() : cClassDescriptor("inetveins::SCTPErrorInfo", "inetveins::SCTPCommand")
{
}
...
const char *SCTPErrorInfoDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::SCTPErrorCode";
            return NULL;
        default: return NULL;
    }
}
...
SCTPOpenCommand::SCTPOpenCommand(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
    this->fork_var = false;
...
SCTPOpenCommand::SCTPOpenCommand(const SCTPOpenCommand& other) : ::inetveins::SCTPCommand(other)
{
    copy(other);
}
...
SCTPOpenCommandDescriptor::SCTPOpenCommandDescriptor() : cClassDescriptor("inetveins::SCTPOpenCommand", "inetveins::SCTPCommand")
{
}
...
SCTPSendInfo::SCTPSendInfo(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
    this->prMethod_var = 0;
    this->last_var = 0;
    this->ppid_var = 0;
...
SCTPSendInfo::SCTPSendInfo(const SCTPSendInfo& other) : ::inetveins::SCTPCommand(other)
{
    copy(other);
}
...
SCTPSendInfoDescriptor::SCTPSendInfoDescriptor() : cClassDescriptor("inetveins::SCTPSendInfo", "inetveins::SCTPCommand")
{
}
...
SCTPRcvInfo::SCTPRcvInfo(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
    this->ppid_var = 0;
    this->tsn_var = 0;
    this->cumTsn_var = 0;
...
SCTPRcvInfo::SCTPRcvInfo(const SCTPRcvInfo& other) : ::inetveins::SCTPCommand(other)
{
    copy(other);
}
...
SCTPRcvInfoDescriptor::SCTPRcvInfoDescriptor() : cClassDescriptor("inetveins::SCTPRcvInfo", "inetveins::SCTPCommand")
{
}
...
SCTPConnectInfo::SCTPConnectInfo(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
    this->status_var = 0;
    this->inboundStreams_var = 0;
    this->outboundStreams_var = 0;
...
SCTPConnectInfo::SCTPConnectInfo(const SCTPConnectInfo& other) : ::inetveins::SCTPCommand(other)
{
    copy(other);
}
...
SCTPConnectInfoDescriptor::SCTPConnectInfoDescriptor() : cClassDescriptor("inetveins::SCTPConnectInfo", "inetveins::SCTPCommand")
{
}
...
SCTPStatusInfo::SCTPStatusInfo(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
    this->state_var = 0;
...
SCTPStatusInfo::SCTPStatusInfo(const SCTPStatusInfo& other) : ::inetveins::SCTPCommand(other)
{
    copy(other);
}
...
SCTPStatusInfoDescriptor::SCTPStatusInfoDescriptor() : cClassDescriptor("inetveins::SCTPStatusInfo", "inetveins::SCTPCommand")
{
}
...
SCTPPathInfo::SCTPPathInfo(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
}

SCTPPathInfo::SCTPPathInfo(const SCTPPathInfo& other) : ::inetveins::SCTPCommand(other)
{
    copy(other);
}
...
SCTPPathInfoDescriptor::SCTPPathInfoDescriptor() : cClassDescriptor("inetveins::SCTPPathInfo", "inetveins::SCTPCommand")
{
}
...
SCTPResetInfo::SCTPResetInfo(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
...
SCTPResetInfo::SCTPResetInfo(const SCTPResetInfo& other) : ::inetveins::SCTPCommand(other)
{
    streams_arraysize = 0;
    this->streams_var = 0;
    copy(other);
...
SCTPResetInfoDescriptor::SCTPResetInfoDescriptor() : cClassDescriptor("inetveins::SCTPResetInfo", "inetveins::SCTPCommand")
{
}
...
SCTPInfo::SCTPInfo(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
    this->text_var = 0;
}

SCTPInfo::SCTPInfo(const SCTPInfo& other) : ::inetveins::SCTPCommand(other)
{
    copy(other);
}
...
SCTPInfoDescriptor::SCTPInfoDescriptor() : cClassDescriptor("inetveins::SCTPInfo", "inetveins::SCTPCommand")
{
}
...
SCTPSendQueueAbated::SCTPSendQueueAbated(const char *name, int kind) : ::inetveins::SCTPCommand(name,kind)
{
...
SCTPSendQueueAbated::SCTPSendQueueAbated(const SCTPSendQueueAbated& other) : ::inetveins::SCTPCommand(other)
{
    queuedForStream_arraysize = 0;
    this->queuedForStream_var = 0;
    copy(other);
...
SCTPSendQueueAbatedDescriptor::SCTPSendQueueAbatedDescriptor() : cClassDescriptor("inetveins::SCTPSendQueueAbated", "inetveins::SCTPCommand")
{
}
...
SCTPSimpleMessageDescriptor::SCTPSimpleMessageDescriptor() : cClassDescriptor("inetveins::SCTPSimpleMessage", "cPacket")
{
}
