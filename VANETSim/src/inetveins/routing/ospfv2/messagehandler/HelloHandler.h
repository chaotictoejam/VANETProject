...
#ifndef __INETVEINS_HELLOHANDLER_H
#define __INETVEINS_HELLOHANDLER_H
...
class INETVEINS_API HelloHandler : public IMessageHandler
{
  public:
...
#endif // ifndef __INETVEINS_HELLOHANDLER_H
