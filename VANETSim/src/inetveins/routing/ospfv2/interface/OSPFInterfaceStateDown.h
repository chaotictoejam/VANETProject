...
#ifndef __INETVEINS_OSPFINTERFACESTATEDOWN_H
#define __INETVEINS_OSPFINTERFACESTATEDOWN_H
...
class INETVEINS_API InterfaceStateDown : public InterfaceState
{
  public:
...
#endif // ifndef __INETVEINS_OSPFINTERFACESTATEDOWN_H
