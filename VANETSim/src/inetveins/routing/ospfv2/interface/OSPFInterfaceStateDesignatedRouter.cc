...
#include "inetveins/routing/ospfv2/interface/OSPFInterfaceStateDesignatedRouter.h"
...
void InterfaceStateDesignatedRouter::processEvent(Interface *intf, Interface::InterfaceEventType event)
{
