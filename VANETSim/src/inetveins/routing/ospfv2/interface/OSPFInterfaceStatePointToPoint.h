...
#ifndef __INETVEINS_OSPFINTERFACESTATEPOINTTOPOINT_H
#define __INETVEINS_OSPFINTERFACESTATEPOINTTOPOINT_H
...
class INETVEINS_API InterfaceStatePointToPoint : public InterfaceState
{
  public:
...
#endif // ifndef __INETVEINS_OSPFINTERFACESTATEPOINTTOPOINT_H
