//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/routing/ospfv2/OSPFPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ospf::OSPFPacketType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ospf::OSPFPacketType"));
...
OSPFOptionsDescriptor::OSPFOptionsDescriptor() : cClassDescriptor("inetveins::ospf::OSPFOptions", "")
{
}
...
OSPFPacketDescriptor::OSPFPacketDescriptor() : cClassDescriptor("inetveins::ospf::OSPFPacket", "cPacket")
{
}
...
const char *OSPFPacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 1:
            if (!strcmp(propertyname,"enum")) return "inetveins::ospf::OSPFPacketType";
            return NULL;
        default: return NULL;
    }
}
...
OSPFHelloPacket::OSPFHelloPacket(const char *name, int kind) : ::inetveins::ospf::OSPFPacket(name,kind)
{
...
OSPFHelloPacket::OSPFHelloPacket(const OSPFHelloPacket& other) : ::inetveins::ospf::OSPFPacket(other)
{
    neighbor_arraysize = 0;
    this->neighbor_var = 0;
    copy(other);
...
{
    if (this==&other) return *this;
    ::inetveins::ospf::OSPFPacket::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::ospf::OSPFPacket::parsimPack(b);
...
{
    ::inetveins::ospf::OSPFPacket::parsimUnpack(b);
...
OSPFHelloPacketDescriptor::OSPFHelloPacketDescriptor() : cClassDescriptor("inetveins::ospf::OSPFHelloPacket", "inetveins::ospf::OSPFPacket")
{
}
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ospf::LSAType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ospf::LSAType"));
...
OSPFLSAHeaderDescriptor::OSPFLSAHeaderDescriptor() : cClassDescriptor("inetveins::ospf::OSPFLSAHeader", "cObject")
{
}
...
const char *OSPFLSAHeaderDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 2:
            if (!strcmp(propertyname,"enum")) return "inetveins::ospf::LSAType";
            return NULL;
        default: return NULL;
    }
}
...
OSPFLSADescriptor::OSPFLSADescriptor() : cClassDescriptor("inetveins::ospf::OSPFLSA", "cObject")
{
}
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ospf::LinkType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ospf::LinkType"));
...
TOSDataDescriptor::TOSDataDescriptor() : cClassDescriptor("inetveins::ospf::TOSData", "")
{
}
...
LinkDescriptor::LinkDescriptor() : cClassDescriptor("inetveins::ospf::Link", "cObject")
{
}
...
const char *LinkDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 2:
            if (!strcmp(propertyname,"enum")) return "inetveins::ospf::LinkType";
            return NULL;
        default: return NULL;
    }
}
...
OSPFRouterLSA::OSPFRouterLSA() : ::inetveins::ospf::OSPFLSA()
{
...
OSPFRouterLSA::OSPFRouterLSA(const OSPFRouterLSA& other) : ::inetveins::ospf::OSPFLSA(other)
{
    links_arraysize = 0;
    this->links_var = 0;
    copy(other);
...
{
    if (this==&other) return *this;
    ::inetveins::ospf::OSPFLSA::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::ospf::OSPFLSA::parsimPack(b);
...
{
    ::inetveins::ospf::OSPFLSA::parsimUnpack(b);
...
OSPFRouterLSADescriptor::OSPFRouterLSADescriptor() : cClassDescriptor("inetveins::ospf::OSPFRouterLSA", "inetveins::ospf::OSPFLSA")
{
}
...
OSPFNetworkLSA::OSPFNetworkLSA() : ::inetveins::ospf::OSPFLSA()
{
    attachedRouters_arraysize = 0;
    this->attachedRouters_var = 0;
}

OSPFNetworkLSA::OSPFNetworkLSA(const OSPFNetworkLSA& other) : ::inetveins::ospf::OSPFLSA(other)
{
    attachedRouters_arraysize = 0;
    this->attachedRouters_var = 0;
    copy(other);
...
OSPFNetworkLSADescriptor::OSPFNetworkLSADescriptor() : cClassDescriptor("inetveins::ospf::OSPFNetworkLSA", "inetveins::ospf::OSPFLSA")
{
}
...
OSPFSummaryLSA::OSPFSummaryLSA() : ::inetveins::ospf::OSPFLSA()
{
...
OSPFSummaryLSA::OSPFSummaryLSA(const OSPFSummaryLSA& other) : ::inetveins::ospf::OSPFLSA(other)
{
    tosData_arraysize = 0;
    this->tosData_var = 0;
    copy(other);
...
OSPFSummaryLSADescriptor::OSPFSummaryLSADescriptor() : cClassDescriptor("inetveins::ospf::OSPFSummaryLSA", "inetveins::ospf::OSPFLSA")
{
}
...
ExternalTOSInfoDescriptor::ExternalTOSInfoDescriptor() : cClassDescriptor("inetveins::ospf::ExternalTOSInfo", "")
{
}
...
OSPFASExternalLSAContentsDescriptor::OSPFASExternalLSAContentsDescriptor() : cClassDescriptor("inetveins::ospf::OSPFASExternalLSAContents", "cObject")
{
}
...
OSPFASExternalLSA::OSPFASExternalLSA() : ::inetveins::ospf::OSPFLSA()
{
}

OSPFASExternalLSA::OSPFASExternalLSA(const OSPFASExternalLSA& other) : ::inetveins::ospf::OSPFLSA(other)
{
    copy(other);
}
...
OSPFASExternalLSADescriptor::OSPFASExternalLSADescriptor() : cClassDescriptor("inetveins::ospf::OSPFASExternalLSA", "inetveins::ospf::OSPFLSA")
{
}
...
OSPFDDOptionsDescriptor::OSPFDDOptionsDescriptor() : cClassDescriptor("inetveins::ospf::OSPFDDOptions", "")
{
}
...
OSPFDatabaseDescriptionPacket::OSPFDatabaseDescriptionPacket(const char *name, int kind) : ::inetveins::ospf::OSPFPacket(name,kind)
{
...
OSPFDatabaseDescriptionPacket::OSPFDatabaseDescriptionPacket(const OSPFDatabaseDescriptionPacket& other) : ::inetveins::ospf::OSPFPacket(other)
{
    lsaHeaders_arraysize = 0;
    this->lsaHeaders_var = 0;
    copy(other);
...
OSPFDatabaseDescriptionPacketDescriptor::OSPFDatabaseDescriptionPacketDescriptor() : cClassDescriptor("inetveins::ospf::OSPFDatabaseDescriptionPacket", "inetveins::ospf::OSPFPacket")
{
}
...
LSARequestDescriptor::LSARequestDescriptor() : cClassDescriptor("inetveins::ospf::LSARequest", "")
{
}
...
OSPFLinkStateRequestPacket::OSPFLinkStateRequestPacket(const char *name, int kind) : ::inetveins::ospf::OSPFPacket(name,kind)
{
    requests_arraysize = 0;
    this->requests_var = 0;
}

OSPFLinkStateRequestPacket::OSPFLinkStateRequestPacket(const OSPFLinkStateRequestPacket& other) : ::inetveins::ospf::OSPFPacket(other)
{
    requests_arraysize = 0;
    this->requests_var = 0;
    copy(other);
...
OSPFLinkStateRequestPacketDescriptor::OSPFLinkStateRequestPacketDescriptor() : cClassDescriptor("inetveins::ospf::OSPFLinkStateRequestPacket", "inetveins::ospf::OSPFPacket")
{
}
...
OSPFLinkStateUpdatePacket::OSPFLinkStateUpdatePacket(const char *name, int kind) : ::inetveins::ospf::OSPFPacket(name,kind)
{
...
OSPFLinkStateUpdatePacket::OSPFLinkStateUpdatePacket(const OSPFLinkStateUpdatePacket& other) : ::inetveins::ospf::OSPFPacket(other)
{
    routerLSAs_arraysize = 0;
    this->routerLSAs_var = 0;
    networkLSAs_arraysize = 0;
...
OSPFLinkStateUpdatePacketDescriptor::OSPFLinkStateUpdatePacketDescriptor() : cClassDescriptor("inetveins::ospf::OSPFLinkStateUpdatePacket", "inetveins::ospf::OSPFPacket")
{
}
...
OSPFLinkStateAcknowledgementPacket::OSPFLinkStateAcknowledgementPacket(const char *name, int kind) : ::inetveins::ospf::OSPFPacket(name,kind)
{
    lsaHeaders_arraysize = 0;
    this->lsaHeaders_var = 0;
}

OSPFLinkStateAcknowledgementPacket::OSPFLinkStateAcknowledgementPacket(const OSPFLinkStateAcknowledgementPacket& other) : ::inetveins::ospf::OSPFPacket(other)
{
    lsaHeaders_arraysize = 0;
    this->lsaHeaders_var = 0;
    copy(other);
...
OSPFLinkStateAcknowledgementPacketDescriptor::OSPFLinkStateAcknowledgementPacketDescriptor() : cClassDescriptor("inetveins::ospf::OSPFLinkStateAcknowledgementPacket", "inetveins::ospf::OSPFPacket")
{
}
