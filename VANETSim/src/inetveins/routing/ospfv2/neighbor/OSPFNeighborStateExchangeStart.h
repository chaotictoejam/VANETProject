...
#ifndef __INETVEINS_OSPFNEIGHBORSTATEEXCHANGESTART_H
#define __INETVEINS_OSPFNEIGHBORSTATEEXCHANGESTART_H
...
class INETVEINS_API NeighborStateExchangeStart : public NeighborState
{
  public:
...
#endif // ifndef __INETVEINS_OSPFNEIGHBORSTATEEXCHANGESTART_H
