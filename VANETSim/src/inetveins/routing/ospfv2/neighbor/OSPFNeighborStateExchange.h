...
#ifndef __INETVEINS_OSPFNEIGHBORSTATEEXCHANGE_H
#define __INETVEINS_OSPFNEIGHBORSTATEEXCHANGE_H
...
class INETVEINS_API NeighborStateExchange : public NeighborState
{
  public:
...
#endif // ifndef __INETVEINS_OSPFNEIGHBORSTATEEXCHANGE_H
