...
#ifndef __INETVEINS_OSPFNEIGHBORSTATE_H
#define __INETVEINS_OSPFNEIGHBORSTATE_H
...
class INETVEINS_API NeighborState
{
  protected:
...
#endif // ifndef __INETVEINS_OSPFNEIGHBORSTATE_H
