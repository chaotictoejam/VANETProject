...
#ifndef __INETVEINS_OSPFNEIGHBORSTATEATTEMPT_H
#define __INETVEINS_OSPFNEIGHBORSTATEATTEMPT_H
...
class INETVEINS_API NeighborStateAttempt : public NeighborState
{
  public:
...
#endif // ifndef __INETVEINS_OSPFNEIGHBORSTATEATTEMPT_H
