...
#ifndef __INETVEINS_OSPFNEIGHBORSTATETWOWAY_H
#define __INETVEINS_OSPFNEIGHBORSTATETWOWAY_H
...
class INETVEINS_API NeighborStateTwoWay : public NeighborState
{
  public:
...
#endif // ifndef __INETVEINS_OSPFNEIGHBORSTATETWOWAY_H
