...
#ifndef __INETVEINS_OSPFNEIGHBORSTATEDOWN_H
#define __INETVEINS_OSPFNEIGHBORSTATEDOWN_H
...
class INETVEINS_API NeighborStateDown : public NeighborState
{
  public:
...
#endif // ifndef __INETVEINS_OSPFNEIGHBORSTATEDOWN_H
