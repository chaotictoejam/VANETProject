...
class INETVEINS_API RoutingInfo
{
  private:
...
class INETVEINS_API LSATrackingInfo
{
  public:
    enum InstallSource {
        ORIGINATED = 0,
...
class INETVEINS_API RouterLSA : public OSPFRouterLSA,
    public RoutingInfo,
...
class INETVEINS_API NetworkLSA : public OSPFNetworkLSA,
    public RoutingInfo,
    public LSATrackingInfo
{
  public:
...
class INETVEINS_API SummaryLSA : public OSPFSummaryLSA,
    public RoutingInfo,
    public LSATrackingInfo
{
  protected:
...
class INETVEINS_API ASExternalLSA : public OSPFASExternalLSA,
    public RoutingInfo,
    public LSATrackingInfo
{
  protected:
