...
BGPParameterValuesDescriptor::BGPParameterValuesDescriptor() : cClassDescriptor("inetveins::bgp::BGPParameterValues", "")
{
}
...
BGPOptionalParametersDescriptor::BGPOptionalParametersDescriptor() : cClassDescriptor("inetveins::bgp::BGPOptionalParameters", "")
{
}
...
BGPOpenMessage::BGPOpenMessage(const char *name, int kind) : ::inetveins::bgp::BGPHeader(name,kind)
{
...
BGPOpenMessage::BGPOpenMessage(const BGPOpenMessage& other) : ::inetveins::bgp::BGPHeader(other)
{
    optionalParameters_arraysize = 0;
    this->optionalParameters_var = 0;
    copy(other);
...
BGPOpenMessageDescriptor::BGPOpenMessageDescriptor() : cClassDescriptor("inetveins::bgp::BGPOpenMessage", "inetveins::bgp::BGPHeader")
{
}
