//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/routing/bgpv4/BGPMessage/BGPUpdate.msg.
//
...
BGPUpdateWithdrawnRoutesDescriptor::BGPUpdateWithdrawnRoutesDescriptor() : cClassDescriptor("inetveins::bgp::BGPUpdateWithdrawnRoutes", "")
{
}
...
BGPUpdateNLRIDescriptor::BGPUpdateNLRIDescriptor() : cClassDescriptor("inetveins::bgp::BGPUpdateNLRI", "")
{
}
...
BGPUpdatePathAttributeListDescriptor::BGPUpdatePathAttributeListDescriptor() : cClassDescriptor("inetveins::bgp::BGPUpdatePathAttributeList", "cObject")
{
}
...
BGPUpdateMessage_Base::BGPUpdateMessage_Base(const char *name, int kind) : ::inetveins::bgp::BGPHeader(name,kind)
{
...
BGPUpdateMessage_Base::BGPUpdateMessage_Base(const BGPUpdateMessage_Base& other) : ::inetveins::bgp::BGPHeader(other)
{
    withdrawnRoutes_arraysize = 0;
    this->withdrawnRoutes_var = 0;
    pathAttributeList_arraysize = 0;
...
{
    if (this==&other) return *this;
    ::inetveins::bgp::BGPHeader::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::bgp::BGPHeader::parsimPack(b);
...
{
    ::inetveins::bgp::BGPHeader::parsimUnpack(b);
    delete [] this->withdrawnRoutes_var;
...
BGPUpdateMessageDescriptor::BGPUpdateMessageDescriptor() : cClassDescriptor("inetveins::bgp::BGPUpdateMessage", "inetveins::bgp::BGPHeader")
{
}
