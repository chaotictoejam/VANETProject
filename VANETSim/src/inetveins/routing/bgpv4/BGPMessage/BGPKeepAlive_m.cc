//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/routing/bgpv4/BGPMessage/BGPKeepAlive.msg.
//
...
BGPKeepAliveMessage::BGPKeepAliveMessage(const char *name, int kind) : ::inetveins::bgp::BGPHeader(name,kind)
{
    this->setType(BGP_KEEPALIVE);
}

BGPKeepAliveMessage::BGPKeepAliveMessage(const BGPKeepAliveMessage& other) : ::inetveins::bgp::BGPHeader(other)
{
    copy(other);
}
...
BGPKeepAliveMessageDescriptor::BGPKeepAliveMessageDescriptor() : cClassDescriptor("inetveins::bgp::BGPKeepAliveMessage", "inetveins::bgp::BGPHeader")
{
}
