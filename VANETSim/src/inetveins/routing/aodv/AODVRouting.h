...
#include "inetveins/routing/aodv/AODVControlPackets_m.h"
#include <map>
...
class INETVEINS_API AODVRouting : public cSimpleModule, public ILifecycle, public INetfilter::IHook, public cListener
{
  protected:
    /*
