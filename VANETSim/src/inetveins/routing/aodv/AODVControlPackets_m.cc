//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/routing/aodv/AODVControlPackets.msg.
//
...
UnreachableNodeDescriptor::UnreachableNodeDescriptor() : cClassDescriptor("inetveins::UnreachableNode", "")
{
}
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::AODVControlPacketType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::AODVControlPacketType"));
    e->insert(RREQ, "RREQ");
    e->insert(RREP, "RREP");
    e->insert(RERR, "RERR");
...
AODVControlPacketDescriptor::AODVControlPacketDescriptor() : cClassDescriptor("inetveins::AODVControlPacket", "cPacket")
{
}
...
AODVRREQ::AODVRREQ(const char *name) : ::inetveins::AODVControlPacket(name)
{
...
AODVRREQ::AODVRREQ(const AODVRREQ& other) : ::inetveins::AODVControlPacket(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::AODVControlPacket::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::AODVControlPacket::parsimPack(b);
    doPacking(b,this->packetType_var);
...
{
    ::inetveins::AODVControlPacket::parsimUnpack(b);
    doUnpacking(b,this->packetType_var);
...
AODVRREQDescriptor::AODVRREQDescriptor() : cClassDescriptor("inetveins::AODVRREQ", "inetveins::AODVControlPacket")
{
}
...
AODVRREP::AODVRREP(const char *name) : ::inetveins::AODVControlPacket(name)
{
...
AODVRREP::AODVRREP(const AODVRREP& other) : ::inetveins::AODVControlPacket(other)
{
    copy(other);
}
...
AODVRREPDescriptor::AODVRREPDescriptor() : cClassDescriptor("inetveins::AODVRREP", "inetveins::AODVControlPacket")
{
}
...
AODVRERR::AODVRERR(const char *name) : ::inetveins::AODVControlPacket(name)
{
...
AODVRERR::AODVRERR(const AODVRERR& other) : ::inetveins::AODVControlPacket(other)
{
    unreachableNodes_arraysize = 0;
    this->unreachableNodes_var = 0;
    copy(other);
...
AODVRERRDescriptor::AODVRERRDescriptor() : cClassDescriptor("inetveins::AODVRERR", "inetveins::AODVControlPacket")
{
}
...
AODVRREPACK::AODVRREPACK(const char *name) : ::inetveins::AODVControlPacket(name)
{
    this->packetType_var = RREPACK;
}

AODVRREPACK::AODVRREPACK(const AODVRREPACK& other) : ::inetveins::AODVControlPacket(other)
{
    copy(other);
}
...
AODVRREPACKDescriptor::AODVRREPACKDescriptor() : cClassDescriptor("inetveins::AODVRREPACK", "inetveins::AODVControlPacket")
{
}
...
WaitForRREPDescriptor::WaitForRREPDescriptor() : cClassDescriptor("inetveins::WaitForRREP", "cMessage")
{
}
