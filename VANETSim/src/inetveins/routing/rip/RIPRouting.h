...
#ifndef __INETVEINS_RIPROUTING_H
#define __INETVEINS_RIPROUTING_H
 ...
 */
class INETVEINS_API RIPRouting : public cSimpleModule, protected cListener, public ILifecycle
{
...
#endif // ifndef __INETVEINS_RIPROUTING_H
