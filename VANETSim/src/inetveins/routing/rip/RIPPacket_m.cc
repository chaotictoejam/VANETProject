...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::RIPCommand");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::RIPCommand"));
...
RIPEntryDescriptor::RIPEntryDescriptor() : cClassDescriptor("inetveins::RIPEntry", "")
{
}
...
const char *RIPEntryDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::RIP_AF";
            return NULL;
        default: return NULL;
    }
}
...
RIPPacketDescriptor::RIPPacketDescriptor() : cClassDescriptor("inetveins::RIPPacket", "cPacket")
{
}
...
const char *RIPPacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::RIPCommand";
            return NULL;
        default: return NULL;
    }
}
