...
#include "inetveins/routing/gpsr/PositionTable.h"
#include "inetveins/transportlayer/udp/UDPPacket.h"
#include "inetveins/routing/gpsr/GPSR_m.h"
...
class INETVEINS_API GPSR : public cSimpleModule, public ILifecycle, public cListener, public INetfilter::IHook
{
  private:
    // GPSR parameters
  ...
  private:
    ...
    const GPSROption *getGpsrOptionFromNetworkDatagram(INetworkDatagram *datagram) const { return const_cast<GPSR *>(this)->getGpsrOptionFromNetworkDatagram(datagram); }
