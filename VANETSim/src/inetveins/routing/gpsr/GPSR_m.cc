...
GPSRBeaconDescriptor::GPSRBeaconDescriptor() : cClassDescriptor("inetveins::GPSRBeacon", "cPacket")
{
}
...
GPSROption::GPSROption() : ::inetveins::TLVOptionBase()
{
    this->routingMode_var = (GPSRForwardingMode)-1;
}

GPSROption::GPSROption(const GPSROption& other) : ::inetveins::TLVOptionBase(other)
{
    copy(other);
}
...
GPSROptionDescriptor::GPSROptionDescriptor() : cClassDescriptor("inetveins::GPSROption", "inetveins::TLVOptionBase")
{
}
