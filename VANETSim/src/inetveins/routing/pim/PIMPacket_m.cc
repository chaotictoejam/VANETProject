//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/routing/pim/PIMPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::PIMPacketType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::PIMPacketType"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::PIMHelloOptionType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::PIMHelloOptionType"));
...
HelloOptionDescriptor::HelloOptionDescriptor() : cClassDescriptor("inetveins::HelloOption", "cObject")
{
}
...
const char *HelloOptionDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::PIMHelloOptionType";
            return NULL;
        default: return NULL;
    }
}
...
HoldtimeOption::HoldtimeOption() : ::inetveins::HelloOption()
{
...
HoldtimeOption::HoldtimeOption(const HoldtimeOption& other) : ::inetveins::HelloOption(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::HelloOption::operator=(other);
    copy(other);
    return *this;
}
...
HoldtimeOptionDescriptor::HoldtimeOptionDescriptor() : cClassDescriptor("inetveins::HoldtimeOption", "inetveins::HelloOption")
{
}
...
LANPruneDelayOption::LANPruneDelayOption() : ::inetveins::HelloOption()
{
...
LANPruneDelayOption::LANPruneDelayOption(const LANPruneDelayOption& other) : ::inetveins::HelloOption(other)
{
    copy(other);
}
...
LANPruneDelayOptionDescriptor::LANPruneDelayOptionDescriptor() : cClassDescriptor("inetveins::LANPruneDelayOption", "inetveins::HelloOption")
{
}
...
DRPriorityOption::DRPriorityOption() : ::inetveins::HelloOption()
{
...
DRPriorityOption::DRPriorityOption(const DRPriorityOption& other) : ::inetveins::HelloOption(other)
{
    copy(other);
}
...
DRPriorityOptionDescriptor::DRPriorityOptionDescriptor() : cClassDescriptor("inetveins::DRPriorityOption", "inetveins::HelloOption")
{
}
...
GenerationIDOption::GenerationIDOption() : ::inetveins::HelloOption()
{
...
GenerationIDOption::GenerationIDOption(const GenerationIDOption& other) : ::inetveins::HelloOption(other)
{
    copy(other);
}
...
GenerationIDOptionDescriptor::GenerationIDOptionDescriptor() : cClassDescriptor("inetveins::GenerationIDOption", "inetveins::HelloOption")
{
}
...
EncodedAddressDescriptor::EncodedAddressDescriptor() : cClassDescriptor("inetveins::EncodedAddress", "")
{
}
...
JoinPruneGroupDescriptor::JoinPruneGroupDescriptor() : cClassDescriptor("inetveins::JoinPruneGroup", "cObject")
{
}
...
PIMPacketDescriptor::PIMPacketDescriptor() : cClassDescriptor("inetveins::PIMPacket", "cPacket")
{
}
...
const char *PIMPacketDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 1:
            if (!strcmp(propertyname,"enum")) return "inetveins::PIMPacketType";
            return NULL;
        default: return NULL;
    }
}
...
PIMHello_Base::PIMHello_Base(const char *name, int kind) : ::inetveins::PIMPacket(name,kind)
{
    this->setType(Hello);

}

PIMHello_Base::PIMHello_Base(const PIMHello_Base& other) : ::inetveins::PIMPacket(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::PIMPacket::operator=(other);
    copy(other);
    return *this;
}
...
PIMHelloDescriptor::PIMHelloDescriptor() : cClassDescriptor("inetveins::PIMHello", "inetveins::PIMPacket")
{
}
...
PIMJoinPrune::PIMJoinPrune(const char *name, int kind) : ::inetveins::PIMPacket(name,kind)
{
...
PIMJoinPrune::PIMJoinPrune(const PIMJoinPrune& other) : ::inetveins::PIMPacket(other)
{
    joinPruneGroups_arraysize = 0;
    this->joinPruneGroups_var = 0;
    copy(other);
...
PIMJoinPruneDescriptor::PIMJoinPruneDescriptor() : cClassDescriptor("inetveins::PIMJoinPrune", "inetveins::PIMPacket")
{
}
...
PIMAssert::PIMAssert(const char *name, int kind) : ::inetveins::PIMPacket(name,kind)
{
...
PIMAssert::PIMAssert(const PIMAssert& other) : ::inetveins::PIMPacket(other)
{
    copy(other);
}
...
PIMAssertDescriptor::PIMAssertDescriptor() : cClassDescriptor("inetveins::PIMAssert", "inetveins::PIMPacket")
{
}
...
PIMGraft::PIMGraft(const char *name, int kind) : ::inetveins::PIMJoinPrune(name,kind)
{
    this->type_var = Graft;
    this->holdTime_var = 0;
}

PIMGraft::PIMGraft(const PIMGraft& other) : ::inetveins::PIMJoinPrune(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::PIMJoinPrune::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::PIMJoinPrune::parsimPack(b);
    doPacking(b,this->type_var);
    doPacking(b,this->holdTime_var);
}
...
{
    ::inetveins::PIMJoinPrune::parsimUnpack(b);
    doUnpacking(b,this->type_var);
    doUnpacking(b,this->holdTime_var);
}
...
PIMGraftDescriptor::PIMGraftDescriptor() : cClassDescriptor("inetveins::PIMGraft", "inetveins::PIMJoinPrune")
{
}
...
PIMGraftAck::PIMGraftAck(const char *name, int kind) : ::inetveins::PIMGraft(name,kind)
{
    this->type_var = GraftAck;
}

PIMGraftAck::PIMGraftAck(const PIMGraftAck& other) : ::inetveins::PIMGraft(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::PIMGraft::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::PIMGraft::parsimPack(b);
    doPacking(b,this->type_var);
}

void PIMGraftAck::parsimUnpack(cCommBuffer *b)
{
    ::inetveins::PIMGraft::parsimUnpack(b);
    doUnpacking(b,this->type_var);
}
...
PIMGraftAckDescriptor::PIMGraftAckDescriptor() : cClassDescriptor("inetveins::PIMGraftAck", "inetveins::PIMGraft")
{
}
...
PIMStateRefresh::PIMStateRefresh(const char *name, int kind) : ::inetveins::PIMPacket(name,kind)
{
...
PIMStateRefresh::PIMStateRefresh(const PIMStateRefresh& other) : ::inetveins::PIMPacket(other)
{
    copy(other);
}
...
PIMStateRefreshDescriptor::PIMStateRefreshDescriptor() : cClassDescriptor("inetveins::PIMStateRefresh", "inetveins::PIMPacket")
{
}
...
PIMRegister::PIMRegister(const char *name, int kind) : ::inetveins::PIMPacket(name,kind)
{
...
PIMRegister::PIMRegister(const PIMRegister& other) : ::inetveins::PIMPacket(other)
{
    copy(other);
}
...
PIMRegisterDescriptor::PIMRegisterDescriptor() : cClassDescriptor("inetveins::PIMRegister", "inetveins::PIMPacket")
{
}
...
PIMRegisterStop::PIMRegisterStop(const char *name, int kind) : ::inetveins::PIMPacket(name,kind)
{
    this->type_var = RegisterStop;
}

PIMRegisterStop::PIMRegisterStop(const PIMRegisterStop& other) : ::inetveins::PIMPacket(other)
{
    copy(other);
}
...
PIMRegisterStopDescriptor::PIMRegisterStopDescriptor() : cClassDescriptor("inetveins::PIMRegisterStop", "inetveins::PIMPacket")
{
}
