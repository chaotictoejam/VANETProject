...
#ifndef __INETVEINS_ENERGYSOURCEBASE_H
#define __INETVEINS_ENERGYSOURCEBASE_H
 ...
 */
class INETVEINS_API EnergySourceBase : public virtual IEnergySource
{
  protected:
...
#endif // ifndef __INETVEINS_ENERGYSOURCEBASE_H
