...
#ifndef __INETVEINS_PHYSICALOBJECT_H
#define __INETVEINS_PHYSICALOBJECT_H
 ...
 * time.
 */
class INETVEINS_API PhysicalObject : public cNamedObject, public IPhysicalObject
{
  protected:
    /**
...
#endif // ifndef __INETVEINS_PHYSICALOBJECT_H
