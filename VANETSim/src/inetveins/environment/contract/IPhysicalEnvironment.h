...
#ifndef __INETVEINS_IPHYSICALENVIRONMENT_H
#define __INETVEINS_IPHYSICALENVIRONMENT_H
...
class INETVEINS_API IPhysicalEnvironment
{
  public:
...
#endif // ifndef __INETVEINS_IPHYSICALENVIRONMENT_H
