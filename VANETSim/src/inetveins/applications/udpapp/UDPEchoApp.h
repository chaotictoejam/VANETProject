...
#ifndef __INETVEINS_UDPECHOAPP_H
#define __INETVEINS_UDPECHOAPP_H
 ...
 */
class INETVEINS_API UDPEchoApp : public ApplicationBase
{
  protected:
    UDPSocket socket;
...
#endif // ifndef __INETVEINS_UDPECHOAPP_H
