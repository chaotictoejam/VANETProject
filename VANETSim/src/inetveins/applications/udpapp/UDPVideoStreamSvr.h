...
#ifndef __INETVEINS_UDPVIDEOSTREAMSVR_H
#define __INETVEINS_UDPVIDEOSTREAMSVR_H
 ...
 */
class INETVEINS_API UDPVideoStreamSvr : public ApplicationBase
{
  public:
...
#endif // ifndef __INETVEINS_UDPVIDEOSTREAMSVR_H
