//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/applications/pingapp/PingPayload.msg.
//
...
PingPayloadDescriptor::PingPayloadDescriptor() : cClassDescriptor("inetveins::PingPayload", "cPacket")
{
}
