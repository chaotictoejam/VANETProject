//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/applications/dhcp/DHCPMessage.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::DHCPOpcode");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::DHCPOpcode"));
    e->insert(BOOTREQUEST, "BOOTREQUEST");
    e->insert(BOOTREPLY, "BOOTREPLY");
);

EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::DHCPMessageType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::DHCPMessageType"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::DHCPOptionCode");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::DHCPOptionCode"));
...
DHCPOptionsDescriptor::DHCPOptionsDescriptor() : cClassDescriptor("inetveins::DHCPOptions", "cObject")
{
}
...
const char *DHCPOptionsDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::DHCPMessageType";
            return NULL;
        default: return NULL;
    }
}
...
DHCPMessageDescriptor::DHCPMessageDescriptor() : cClassDescriptor("inetveins::DHCPMessage", "cPacket")
{
}
...
const char *DHCPMessageDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::DHCPOpcode";
            return NULL;
        default: return NULL;
    }
}
