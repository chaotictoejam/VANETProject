...
#ifndef __INETVEINS_TCPSINKAPP_H
#define __INETVEINS_TCPSINKAPP_H
 ...
 * on them.
 */
class INETVEINS_API TCPSinkApp : public cSimpleModule, public ILifecycle
{
  protected:
    long bytesRcvd;
...
#endif // ifndef __INETVEINS_TCPSINKAPP_H
