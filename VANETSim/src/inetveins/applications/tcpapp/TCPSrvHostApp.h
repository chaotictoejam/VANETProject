 ...
 */
class INETVEINS_API TCPSrvHostApp : public cSimpleModule, public ILifecycle
{
  protected:
 ...
 * @see TCPSrvHostApp
 */
class INETVEINS_API TCPServerThreadBase : public cObject, public TCPSocket::CallbackInterface
{
  protected:
