...
#ifndef __INETVEINS_TELNETAPP_H
#define __INETVEINS_TELNETAPP_H
 ...
 */
class INETVEINS_API TelnetApp : public TCPAppBase, public ILifecycle
{
  protected:
...
#endif // ifndef __INETVEINS_TELNETAPP_H
