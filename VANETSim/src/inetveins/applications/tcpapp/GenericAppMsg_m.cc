//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/applications/tcpapp/GenericAppMsg.msg.
//
...
GenericAppMsgDescriptor::GenericAppMsgDescriptor() : cClassDescriptor("inetveins::GenericAppMsg", "cPacket")
{
}
