...
#include "inetveins/applications/tcpapp/TCPGenericSrvApp.h"
...
void TCPGenericSrvApp::handleMessage(cMessage *msg)
{
    if (msg->isSelfMessage()) {
        ...
        EV_WARN << "drop msg: " << msg->getName() << ", kind:" << msg->getKind() << "(" << cEnum::get("inetveins::TcpStatusInd")->getStringFor(msg->getKind()) << ")\n";
        delete msg;
    }
