//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/applications/netperfmeter/NetPerfMeter.msg.
//
...
NetPerfMeterTransmitTimerDescriptor::NetPerfMeterTransmitTimerDescriptor() : cClassDescriptor("inetveins::NetPerfMeterTransmitTimer", "cMessage")
{
}
...
NetPerfMeterDataMessage::NetPerfMeterDataMessage() : ::inetveins::SCTPSimpleMessage()
{
}

NetPerfMeterDataMessage::NetPerfMeterDataMessage(const NetPerfMeterDataMessage& other) : ::inetveins::SCTPSimpleMessage(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::SCTPSimpleMessage::operator=(other);
    copy(other);
    return *this;
}
...
{
    doPacking(b,(::inetveins::SCTPSimpleMessage&)*this);
}

void NetPerfMeterDataMessage::parsimUnpack(cCommBuffer *b)
{
    doUnpacking(b,(::inetveins::SCTPSimpleMessage&)*this);
}
...
NetPerfMeterDataMessageDescriptor::NetPerfMeterDataMessageDescriptor() : cClassDescriptor("inetveins::NetPerfMeterDataMessage", "inetveins::SCTPSimpleMessage")
{
}
