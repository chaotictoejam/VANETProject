...
#ifndef __INETVEINS_ETHERTRAFGEN_H
#define __INETVEINS_ETHERTRAFGEN_H
 ...
 */
class INETVEINS_API EtherTrafGen : public cSimpleModule, public ILifecycle
{
  protected:
...
#endif // ifndef __INETVEINS_ETHERTRAFGEN_H
