//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/linklayer/lmac/LMacFrame.msg.
//
...
LMacFrame::LMacFrame(const char *name, int kind) : ::inetveins::MACFrameBase(name,kind)
{
    this->mySlot_var = 0;
...
LMacFrame::LMacFrame(const LMacFrame& other) : ::inetveins::MACFrameBase(other)
{
    occupiedSlots_arraysize = 0;
    this->occupiedSlots_var = 0;
    copy(other);
...
LMacFrameDescriptor::LMacFrameDescriptor() : cClassDescriptor("inetveins::LMacFrame", "inetveins::MACFrameBase")
{
}
