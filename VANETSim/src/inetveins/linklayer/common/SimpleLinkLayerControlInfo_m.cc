//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/linklayer/common/SimpleLinkLayerControlInfo.msg.
//
...
SimpleLinkLayerControlInfoDescriptor::SimpleLinkLayerControlInfoDescriptor() : cClassDescriptor("inetveins::SimpleLinkLayerControlInfo", "cObject")
{
}
