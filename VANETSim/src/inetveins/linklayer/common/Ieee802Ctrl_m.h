...
#ifndef _INETVEINS_IEEE802CTRL_M_H_
#define _INETVEINS_IEEE802CTRL_M_H_
...
/**
 * Enum generated from <tt>inetveins/linklayer/common/Ieee802Ctrl.msg:31</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Enum generated from <tt>inetveins/linklayer/common/Ieee802Ctrl.msg:43</tt> by nedtool.
 * <pre>
 * //
...
/**
 * Enum generated from <tt>inetveins/linklayer/common/Ieee802Ctrl.msg:60</tt> by nedtool.
 * <pre>
 * //
 ...
 *     ETHERTYPE_INETVEINS_GENERIC = 0x86FF;    // not in standard, INETVEINS spceific value for @GenericNetworkProtocol
...
enum EtherType {
    ...
    ETHERTYPE_RARP = 0x8035,
    ETHERTYPE_IPv6 = 0x86DD,
    ETHERTYPE_INETVEINS_GENERIC = 0x86FF,
    ETHERTYPE_MPLS_UNICAST = 0x8847,
    ETHERTYPE_MPLS_MULTICAST = 0x8848
};

/**
 * Class generated from <tt>inetveins/linklayer/common/Ieee802Ctrl.msg:77</tt> by nedtool.
 * <pre>
 * //
...
#endif // ifndef _INETVEINS_IEEE802CTRL_M_H_
