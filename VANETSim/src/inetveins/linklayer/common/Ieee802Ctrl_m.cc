//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/linklayer/common/Ieee802Ctrl.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::Ieee802MessageKind");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::Ieee802MessageKind"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::SAPCode");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::SAPCode"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::EtherType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::EtherType"));
    ...
    e->insert(ETHERTYPE_INETVEINS_GENERIC, "ETHERTYPE_INETVEINS_GENERIC");
    e->insert(ETHERTYPE_MPLS_UNICAST, "ETHERTYPE_MPLS_UNICAST");
    e->insert(ETHERTYPE_MPLS_MULTICAST, "ETHERTYPE_MPLS_MULTICAST");
);

Ieee802Ctrl_Base::Ieee802Ctrl_Base() : ::cObject()
{
    this->etherType_var = 0;
    this->interfaceId_var = 0;
    this->switchPort_var = -1;
    this->userPriority_var = -1;
    this->ssap_var = 0;
    this->dsap_var = 0;
    this->pauseUnits_var = 0;
}

Ieee802Ctrl_Base::Ieee802Ctrl_Base(const Ieee802Ctrl_Base& other) : ::cObject(other)
{
    copy(other);
}
...
void Ieee802Ctrl_Base::parsimPack(cCommBuffer *b)
{
...
void Ieee802Ctrl_Base::parsimUnpack(cCommBuffer *b)
{
...
Ieee802CtrlDescriptor::Ieee802CtrlDescriptor() : cClassDescriptor("inetveins::Ieee802Ctrl", "cObject")
{
}
...
{
    return dynamic_cast<Ieee802Ctrl_Base *>(obj)!=NULL;
}
