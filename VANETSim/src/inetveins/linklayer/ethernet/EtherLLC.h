...
#ifndef __INETVEINS_ETHERLLC_H
#define __INETVEINS_ETHERLLC_H
 ...
 */
class INETVEINS_API EtherLLC : public cSimpleModule, public ILifecycle
{
  protected:
    int seqNum;
...
#endif // ifndef __INETVEINS_ETHERLLC_H
