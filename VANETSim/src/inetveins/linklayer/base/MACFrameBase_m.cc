//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/linklayer/base/MACFrameBase.msg.
//
...
MACFrameBaseDescriptor::MACFrameBaseDescriptor() : cClassDescriptor("inetveins::MACFrameBase", "cPacket")
{
}
