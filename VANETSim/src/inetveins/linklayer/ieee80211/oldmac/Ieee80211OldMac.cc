...
#include "inetveins/linklayer/ieee80211/oldmac/Ieee80211OldMac.h"
...
Register_Enum(inetveins::ieee80211::Ieee80211OldMac,
...
void Ieee80211OldMac::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_LOCAL) {
        ...
        stateVector.setEnum("inetveins::ieee80211::Ieee80211OldMac");
        for (int i = 0; i < numCategories(); i++) {
