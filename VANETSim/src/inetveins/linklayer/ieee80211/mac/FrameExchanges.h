...
class INETVEINS_API SendDataWithAckFsmBasedFrameExchange : public FsmBasedFrameExchange
{
    protected:
...
class INETVEINS_API SendDataWithAckFrameExchange : public StepBasedFrameExchange
{
    protected:
...
class INETVEINS_API SendDataWithRtsCtsFrameExchange : public StepBasedFrameExchange
{
    protected:
        Ieee80211DataOrMgmtFrame *dataFrame = nullptr;
...
class INETVEINS_API SendMulticastDataFrameExchange : public FrameExchange
{
    protected:
