...
class INETVEINS_API NoDuplicateDetector : public IDuplicateDetector
{
    public:
...
class INETVEINS_API LegacyDuplicateDetector : public IDuplicateDetector
{
    protected:
        struct SeqVal
        {
...
class INETVEINS_API NonQoSDuplicateDetector : public LegacyDuplicateDetector
{
    protected:
...
class INETVEINS_API QoSDuplicateDetector : public IDuplicateDetector
{
    private:
        enum CacheType
        {
