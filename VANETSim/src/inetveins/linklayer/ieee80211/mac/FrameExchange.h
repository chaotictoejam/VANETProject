 ...
 */
class INETVEINS_API FrameExchangeContext
{
    public:
 ...
 */
class INETVEINS_API FrameExchange : public MacPlugin, public IFrameExchange, public ITxCallback, public IContentionCallback
{
    protected:
...
class INETVEINS_API FsmBasedFrameExchange : public FrameExchange
{
    protected:
        cFSM fsm;
...
class INETVEINS_API StepBasedFrameExchange : public FrameExchange
{
    protected:
