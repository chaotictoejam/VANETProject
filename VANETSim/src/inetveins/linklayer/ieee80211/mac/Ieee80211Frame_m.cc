//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/linklayer/ieee80211/mac/Ieee80211Frame.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ieee80211::Ieee80211FrameType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ieee80211::Ieee80211FrameType"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ieee80211::AckPolicy");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ieee80211::AckPolicy"));
...
Ieee80211FrameDescriptor::Ieee80211FrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211Frame", "cPacket")
{
}
...
const char *Ieee80211FrameDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::ieee80211::Ieee80211FrameType";
            return NULL;
        default: return NULL;
    }
}
...
Ieee80211OneAddressFrame::Ieee80211OneAddressFrame(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211Frame(name,kind)
{
}

Ieee80211OneAddressFrame::Ieee80211OneAddressFrame(const Ieee80211OneAddressFrame& other) : ::inetveins::ieee80211::Ieee80211Frame(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::ieee80211::Ieee80211Frame::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::ieee80211::Ieee80211Frame::parsimPack(b);
}

void Ieee80211OneAddressFrame::parsimUnpack(cCommBuffer *b)
{
    ::inetveins::ieee80211::Ieee80211Frame::parsimUnpack(b);
}
...
Ieee80211OneAddressFrameDescriptor::Ieee80211OneAddressFrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211OneAddressFrame", "inetveins::ieee80211::Ieee80211Frame")
{
}
...
Ieee80211ACKFrame::Ieee80211ACKFrame(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211OneAddressFrame(name,kind)
{
    this->setByteLength(LENGTH_ACK / 8);
    this->setType(ST_ACK);
}

Ieee80211ACKFrame::Ieee80211ACKFrame(const Ieee80211ACKFrame& other) : ::inetveins::ieee80211::Ieee80211OneAddressFrame(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::ieee80211::Ieee80211OneAddressFrame::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::ieee80211::Ieee80211OneAddressFrame::parsimPack(b);
}

void Ieee80211ACKFrame::parsimUnpack(cCommBuffer *b)
{
    ::inetveins::ieee80211::Ieee80211OneAddressFrame::parsimUnpack(b);
}
...
Ieee80211ACKFrameDescriptor::Ieee80211ACKFrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211ACKFrame", "inetveins::ieee80211::Ieee80211OneAddressFrame")
{
}
...
Ieee80211TwoAddressFrame::Ieee80211TwoAddressFrame(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211OneAddressFrame(name,kind)
{
    this->setByteLength(LENGTH_RTS / 8);

}

Ieee80211TwoAddressFrame::Ieee80211TwoAddressFrame(const Ieee80211TwoAddressFrame& other) : ::inetveins::ieee80211::Ieee80211OneAddressFrame(other)
{
    copy(other);
}
...
Ieee80211TwoAddressFrameDescriptor::Ieee80211TwoAddressFrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211TwoAddressFrame", "inetveins::ieee80211::Ieee80211OneAddressFrame")
{
}
...
Ieee80211RTSFrame::Ieee80211RTSFrame(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211TwoAddressFrame(name,kind)
{
    this->setByteLength(LENGTH_RTS / 8);
    this->setType(ST_RTS);
}

Ieee80211RTSFrame::Ieee80211RTSFrame(const Ieee80211RTSFrame& other) : ::inetveins::ieee80211::Ieee80211TwoAddressFrame(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::ieee80211::Ieee80211TwoAddressFrame::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::ieee80211::Ieee80211TwoAddressFrame::parsimPack(b);
}

void Ieee80211RTSFrame::parsimUnpack(cCommBuffer *b)
{
    ::inetveins::ieee80211::Ieee80211TwoAddressFrame::parsimUnpack(b);
}
...
Ieee80211RTSFrameDescriptor::Ieee80211RTSFrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211RTSFrame", "inetveins::ieee80211::Ieee80211TwoAddressFrame")
{
}
...
Ieee80211CTSFrame::Ieee80211CTSFrame(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211OneAddressFrame(name,kind)
{
    this->setByteLength(LENGTH_CTS / 8);
    this->setType(ST_CTS);
}

Ieee80211CTSFrame::Ieee80211CTSFrame(const Ieee80211CTSFrame& other) : ::inetveins::ieee80211::Ieee80211OneAddressFrame(other)
{
    copy(other);
}
...
Ieee80211CTSFrameDescriptor::Ieee80211CTSFrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211CTSFrame", "inetveins::ieee80211::Ieee80211OneAddressFrame")
{
}
...
Ieee80211DataOrMgmtFrame::Ieee80211DataOrMgmtFrame(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211TwoAddressFrame(name,kind)
{
...
Ieee80211DataOrMgmtFrame::Ieee80211DataOrMgmtFrame(const Ieee80211DataOrMgmtFrame& other) : ::inetveins::ieee80211::Ieee80211TwoAddressFrame(other)
{
    copy(other);
}
...
Ieee80211DataOrMgmtFrameDescriptor::Ieee80211DataOrMgmtFrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211DataOrMgmtFrame", "inetveins::ieee80211::Ieee80211TwoAddressFrame")
{
}
...
Ieee80211DataFrame::Ieee80211DataFrame(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211DataOrMgmtFrame(name,kind)
{
...
Ieee80211DataFrame::Ieee80211DataFrame(const Ieee80211DataFrame& other) : ::inetveins::ieee80211::Ieee80211DataOrMgmtFrame(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::ieee80211::Ieee80211DataOrMgmtFrame::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::ieee80211::Ieee80211DataOrMgmtFrame::parsimPack(b);
...
{
    ::inetveins::ieee80211::Ieee80211DataOrMgmtFrame::parsimUnpack(b);
...
Ieee80211DataFrameDescriptor::Ieee80211DataFrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211DataFrame", "inetveins::ieee80211::Ieee80211DataOrMgmtFrame")
{
}
...
const char *Ieee80211DataFrameDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 2:
            if (!strcmp(propertyname,"enum")) return "inetveins::ieee80211::AckPolicy";
            return NULL;
        default: return NULL;
    }
}
...
Ieee80211DataFrameWithSNAP::Ieee80211DataFrameWithSNAP(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211DataFrame(name,kind)
{
...
Ieee80211DataFrameWithSNAP::Ieee80211DataFrameWithSNAP(const Ieee80211DataFrameWithSNAP& other) : ::inetveins::ieee80211::Ieee80211DataFrame(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::ieee80211::Ieee80211DataFrame::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::ieee80211::Ieee80211DataFrame::parsimPack(b);
    doPacking(b,this->etherType_var);
}

void Ieee80211DataFrameWithSNAP::parsimUnpack(cCommBuffer *b)
{
    ::inetveins::ieee80211::Ieee80211DataFrame::parsimUnpack(b);
...
Ieee80211DataFrameWithSNAPDescriptor::Ieee80211DataFrameWithSNAPDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211DataFrameWithSNAP", "inetveins::ieee80211::Ieee80211DataFrame")
{
}
...
Ieee80211ManagementFrame::Ieee80211ManagementFrame(const char *name, int kind) : ::inetveins::ieee80211::Ieee80211DataOrMgmtFrame(name,kind)
{
    this->Category_var = 0;
}

Ieee80211ManagementFrame::Ieee80211ManagementFrame(const Ieee80211ManagementFrame& other) : ::inetveins::ieee80211::Ieee80211DataOrMgmtFrame(other)
{
    copy(other);
}
...
Ieee80211ManagementFrameDescriptor::Ieee80211ManagementFrameDescriptor() : cClassDescriptor("inetveins::ieee80211::Ieee80211ManagementFrame", "inetveins::ieee80211::Ieee80211DataOrMgmtFrame")
{
}
