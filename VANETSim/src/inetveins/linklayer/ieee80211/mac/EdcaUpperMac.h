...
#ifndef __INETVEINS_EDCAUPPERMAC_H
#define __INETVEINS_EDCAUPPERMAC_H
 ...
 */
class INETVEINS_API EdcaUpperMac : public cSimpleModule, public IUpperMac, protected IFrameExchange::IFinishedCallback
{
    public:
