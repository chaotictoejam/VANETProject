...
#include "inetveins/physicallayer/ieee80211/mode/Ieee80211ModeSet.h" //TODO not needed here
 ...
 */
class INETVEINS_API Ieee80211Mac : public MACProtocolBase, public IMacRadioInterface
{
  protected:
