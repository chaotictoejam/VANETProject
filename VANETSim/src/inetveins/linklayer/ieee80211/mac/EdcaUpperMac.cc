...
void EdcaUpperMac::initialize()
{
    ...
    fragmenter = check_and_cast<IFragmenter *>(inetveins::utils::createOne(par("fragmenterClass")));
    reassembly = check_and_cast<IReassembly *>(inetveins::utils::createOne(par("reassemblyClass")));
