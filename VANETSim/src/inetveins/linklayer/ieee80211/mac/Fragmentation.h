...
class INETVEINS_API FragmentationNotSupported : public IFragmenter, public cObject
{
    public:
        virtual std::vector<Ieee80211DataOrMgmtFrame*> fragment(Ieee80211DataOrMgmtFrame *frame, int fragmentationThreshold);
};

class INETVEINS_API ReassemblyNotSupported : public IReassembly, public cObject
{
    public:
...
class INETVEINS_API BasicFragmentation : public IFragmenter, public cObject
{
    public:
        virtual std::vector<Ieee80211DataOrMgmtFrame*> fragment(Ieee80211DataOrMgmtFrame *frame, int fragmentationThreshold);
};

class INETVEINS_API BasicReassembly : public IReassembly, public cObject
{
    protected:
        struct Key {
