...
#ifndef __INETVEINS_OPTIMIZEDCOLLISIONCONTROLLER_H
#define __INETVEINS_OPTIMIZEDCOLLISIONCONTROLLER_H
 ...
 */
class INETVEINS_API OptimizedCollisionController : public cSimpleModule, public ICollisionController
{
    private:
