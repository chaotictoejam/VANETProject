...
#ifndef __INETVEINS_INTERPOLATINGANTENNA_H
#define __INETVEINS_INTERPOLATINGANTENNA_H
...
class INETVEINS_API InterpolatingAntenna : public AntennaBase
{
  protected:
    double minGain;
    double maxGain;
...
#endif // ifndef __INETVEINS_INTERPOLATINGANTENNA_H
