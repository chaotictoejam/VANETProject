...
#ifndef __INETVEINS_ISOTROPICANTENNA_H
#define __INETVEINS_ISOTROPICANTENNA_H
...
class INETVEINS_API IsotropicAntenna : public AntennaBase
{
  public:
    IsotropicAntenna();
...
#endif // ifndef __INETVEINS_ISOTROPICANTENNA_H
