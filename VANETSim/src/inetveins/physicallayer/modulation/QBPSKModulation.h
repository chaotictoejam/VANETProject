...
#ifndef __INETVEINS_QBPSKMODULATION_H
#define __INETVEINS_QBPSKMODULATION_H
 ...
 */
class INETVEINS_API QBPSKModulation : public MQAMModulationBase
{
  public:
...
#endif // ifndef __INETVEINS_QBPSKMODULATION_H
