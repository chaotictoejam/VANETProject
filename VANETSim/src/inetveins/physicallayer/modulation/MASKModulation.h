...
#ifndef __INETVEINS_MASKMODULATION_H
#define __INETVEINS_MASKMODULATION_H
 ...
 */
class INETVEINS_API MASKModulation : public APSKModulationBase
{
  public:
...
#endif // ifndef __INETVEINS_MASKMODULATION_H
