...
#ifndef __INETVEINS_MPSKMODULATION_H
#define __INETVEINS_MPSKMODULATION_H
 ...
 */
class INETVEINS_API MPSKModulation : public APSKModulationBase
{
  public:
...
#endif // ifndef __INETVEINS_MPSKMODULATION_H
