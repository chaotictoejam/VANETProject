...
#include "inetveins/physicallayer/analogmodel/bitlevel/LayeredDimensionalAnalogModel.h"
...
#include "inetveins/physicallayer/analogmodel/packetlevel/DimensionalSNIR.h"
