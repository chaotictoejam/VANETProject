...
#ifndef __INETVEINS_SCALARNOISE_H
#define __INETVEINS_SCALARNOISE_H
...
class INETVEINS_API ScalarNoise : public NarrowbandNoiseBase
{
  protected:
...
#endif // ifndef __INETVEINS_SCALARNOISE_H
