...
#ifndef __INETVEINS_LAYEREDTRANSMISSION_H
#define __INETVEINS_LAYEREDTRANSMISSION_H
...
class INETVEINS_API LayeredTransmission : public TransmissionBase
{
  protected:
...
#endif // ifndef __INETVEINS_LAYEREDTRANSMISSION_H
