...
class INETVEINS_API SignalSampleModel : public virtual ISignalSampleModel
{
  protected:
...
class INETVEINS_API TransmissionSampleModel : public SignalSampleModel, public virtual ITransmissionSampleModel
{
  public:
    TransmissionSampleModel(int sampleLength, double sampleRate, const std::vector<W> *samples);
};

class INETVEINS_API ReceptionSampleModel : public SignalSampleModel, public virtual IReceptionSampleModel
{
  protected:
    const W rssi;
