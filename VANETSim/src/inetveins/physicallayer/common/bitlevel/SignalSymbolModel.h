...
#ifndef __INETVEINS_SIGNALSYMBOLMODEL_H
#define __INETVEINS_SIGNALSYMBOLMODEL_H
...
class INETVEINS_API SignalSymbolModel : public virtual ISignalSymbolModel
{
  protected:
...
class INETVEINS_API TransmissionSymbolModel : public SignalSymbolModel, public virtual ITransmissionSymbolModel
{
  protected:
...
class INETVEINS_API ReceptionSymbolModel : public SignalSymbolModel, public virtual IReceptionSymbolModel
{
  public:
...
#endif /* ifndef __INETVEINS_SIGNALSYMBOLMODEL_H */
