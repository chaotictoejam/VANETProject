...
#ifndef __INETVEINS_CONVOLUTIONALCODE_H
#define __INETVEINS_CONVOLUTIONALCODE_H
...
class INETVEINS_API ConvolutionalCode : public IForwardErrorCorrection
{
  protected:
...
#endif // ifndef __INETVEINS_CONVOLUTIONALCODE_H
