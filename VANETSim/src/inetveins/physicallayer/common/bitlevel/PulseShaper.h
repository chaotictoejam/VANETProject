...
#ifndef __INETVEINS_PULSESHAPER_H
#define __INETVEINS_PULSESHAPER_H
...
class INETVEINS_API PulseShaper : public IPulseShaper
{
  protected:
...
#endif // ifndef __INETVEINS_PULSESHAPER_H
