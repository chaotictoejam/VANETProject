...
class INETVEINS_API SignalPacketModel : public virtual ISignalPacketModel
{
  protected:
...
class INETVEINS_API TransmissionPacketModel : public SignalPacketModel, public virtual ITransmissionPacketModel
{
  public:
    TransmissionPacketModel(const cPacket *packet, const BitVector *serializedPacket, bps bitrate);
};

class INETVEINS_API ReceptionPacketModel : public SignalPacketModel, public IReceptionPacketModel
{
  protected:
    const double per;
