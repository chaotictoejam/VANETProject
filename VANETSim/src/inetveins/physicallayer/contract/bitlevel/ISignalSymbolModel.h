 ...
 */
class INETVEINS_API ISignalSymbolModel : public IPrintableObject
{
  public:
...
class INETVEINS_API ITransmissionSymbolModel : public virtual ISignalSymbolModel
{
  public:
...
class INETVEINS_API IReceptionSymbolModel : public virtual ISignalSymbolModel
{
};
