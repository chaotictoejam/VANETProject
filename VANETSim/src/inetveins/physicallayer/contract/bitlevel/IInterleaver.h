...
#ifndef __INETVEINS_IINTERLEAVER_H
#define __INETVEINS_IINTERLEAVER_H
...
class INETVEINS_API IInterleaving : public IPrintableObject
{
};

class INETVEINS_API IInterleaver : public IPrintableObject
{
  public:
...
#endif // ifndef __INETVEINS_IINTERLEAVER_H
