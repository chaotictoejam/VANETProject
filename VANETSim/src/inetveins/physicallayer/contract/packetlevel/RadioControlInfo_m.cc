...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::physicallayer::RadioCommandCode");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::physicallayer::RadioCommandCode"));
...
ConfigureRadioCommandDescriptor::ConfigureRadioCommandDescriptor() : cClassDescriptor("inetveins::physicallayer::ConfigureRadioCommand", "cObject")
{
}
...
TransmissionRequestDescriptor::TransmissionRequestDescriptor() : cClassDescriptor("inetveins::physicallayer::TransmissionRequest", "cObject")
{
}
...
ReceptionIndicationDescriptor::ReceptionIndicationDescriptor() : cClassDescriptor("inetveins::physicallayer::ReceptionIndication", "cObject")
{
}
