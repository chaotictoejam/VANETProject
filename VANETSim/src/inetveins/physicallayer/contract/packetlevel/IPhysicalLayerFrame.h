...
#ifndef __INETVEINS_IPHYSICALLAYERFRAME_H
#define __INETVEINS_IPHYSICALLAYERFRAME_H
 ...
 */
class INETVEINS_API IPhysicalLayerFrame
{
  public:
...
#endif // ifndef __INETVEINS_IPHYSICALLAYERFRAME_H
