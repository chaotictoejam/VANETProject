...
#ifndef __INETVEINS_IERRORMODEL_H
#define __INETVEINS_IERRORMODEL_H
 ...
 */
class INETVEINS_API IErrorModel : public IPrintableObject
{
  public:
...
#endif // ifndef __INETVEINS_IERRORMODEL_H
