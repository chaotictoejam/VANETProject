...
Register_Enum(inetveins::physicallayer::IRadio::RadioMode,
...
Register_Enum(inetveins::physicallayer::IRadio::ReceptionState,
    (IRadio::RECEPTION_STATE_UNDEFINED,
     IRadio::RECEPTION_STATE_IDLE,
     IRadio::RECEPTION_STATE_BUSY,
     IRadio::RECEPTION_STATE_RECEIVING));

Register_Enum(inetveins::physicallayer::IRadio::TransmissionState,
