...
#ifndef __INETVEINS_STATEBASEDENERGYCONSUMER_H
#define __INETVEINS_STATEBASEDENERGYCONSUMER_H
...
using namespace inetveins::power;
 ...
 */
class INETVEINS_API StateBasedEnergyConsumer : public cSimpleModule, public IEnergyConsumer, public cListener
{
  protected:
    // parameters
...
#endif // ifndef __INETVEINS_STATEBASEDENERGYCONSUMER_H
