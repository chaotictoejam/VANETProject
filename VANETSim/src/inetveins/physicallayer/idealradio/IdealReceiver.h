...
#ifndef __INETVEINS_IDEALRECEIVER_H
#define __INETVEINS_IDEALRECEIVER_H
 ...
 */
class INETVEINS_API IdealReceiver : public ReceiverBase
{
  protected:
...
#endif // ifndef __INETVEINS_IDEALRECEIVER_H
