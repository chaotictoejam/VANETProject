...
#ifndef __INETVEINS_SNIRRECEIVERBASE_H
#define __INETVEINS_SNIRRECEIVERBASE_H
...
class INETVEINS_API SNIRReceiverBase : public ReceiverBase
{
  protected:
...
#endif // ifndef __INETVEINS_SNIRRECEIVERBASE_H
