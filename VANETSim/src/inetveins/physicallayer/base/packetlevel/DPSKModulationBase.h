...
#ifndef __INETVEINS_DPSKMODULATIONBASE_H
#define __INETVEINS_DPSKMODULATIONBASE_H
...
class INETVEINS_API DPSKModulationBase : public IModulation
{
  protected:
...
#endif // ifndef __INETVEINS_DPSKMODULATIONBASE_H
