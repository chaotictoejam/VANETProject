...
#ifndef __INETVEINS_FLATRECEIVERBASE_H
#define __INETVEINS_FLATRECEIVERBASE_H
...
class INETVEINS_API FlatReceiverBase : public NarrowbandReceiverBase
{
  protected:
...
#endif // ifndef __INETVEINS_FLATRECEIVERBASE_H
