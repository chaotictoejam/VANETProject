...
#ifndef __INETVEINS_RECEIVERBASE_H
#define __INETVEINS_RECEIVERBASE_H

#include "inetveins/physicallayer/contract/packetlevel/IReceiver.h"
...
class INETVEINS_API ReceiverBase : public cModule, public virtual IReceiver
{
  protected:
...
#endif // ifndef __INETVEINS_RECEIVERBASE_H
