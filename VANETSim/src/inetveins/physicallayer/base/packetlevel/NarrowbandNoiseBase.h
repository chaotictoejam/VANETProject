...
#ifndef __INETVEINS_NARROWBANDNOISEBASE_H
#define __INETVEINS_NARROWBANDNOISEBASE_H
...
class INETVEINS_API NarrowbandNoiseBase : public NoiseBase
{
  protected:
...
#endif // ifndef __INETVEINS_NARROWBANDNOISEBASE_H
