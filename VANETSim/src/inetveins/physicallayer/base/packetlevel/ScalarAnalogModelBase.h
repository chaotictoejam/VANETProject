...
#ifndef __INETVEINS_SCALARANALOGMODELBASE_H
#define __INETVEINS_SCALARANALOGMODELBASE_H
...
class INETVEINS_API ScalarAnalogModelBase : public AnalogModelBase
{
  protected:
...
#endif // ifndef __INETVEINS_SCALARANALOGMODELBASE_H
