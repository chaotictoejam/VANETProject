...
#ifndef __INETVEINS_FLATRECEPTIONBASE_H
#define __INETVEINS_FLATRECEPTIONBASE_H
...
class INETVEINS_API FlatReceptionBase : public NarrowbandReceptionBase
{
  public:
...
#endif // ifndef __INETVEINS_FLATRECEPTIONBASE_H
