...
#ifndef __INETVEINS_IEEE80211ERRORMODELBASE_H
#define __INETVEINS_IEEE80211ERRORMODELBASE_H
...
class INETVEINS_API Ieee80211ErrorModelBase : public ErrorModelBase
{
  protected:
...
#endif // ifndef __INETVEINS_IEEE80211ERRORMODELBASE_H
