...
#ifndef __INETVEINS_IEEE80211DSSSOFDMMODE_H
#define __INETVEINS_IEEE80211DSSSOFDMMODE_H
 ...
 * 19.3.2.6.
 */
class INETVEINS_API Ieee80211DsssOfdmMode : public Ieee80211ModeBase
{
  protected:
  ...
  public:
    ...
    // TODO: fill in
    virtual inline const simtime_t getDuration(int dataBitLength) const override { return 0; }
...
#endif // ifndef __INETVEINS_IEEE80211DSSSOFDMMODE_H
