...
#ifndef __INETVEINS_IIEEE80211MODE_H
#define __INETVEINS_IIEEE80211MODE_H
...
class INETVEINS_API IIeee80211PreambleMode : public IPrintableObject
{
  public:
    virtual const simtime_t getDuration() const = 0;
};

class INETVEINS_API IIeee80211HeaderMode : public IPrintableObject
{
  public:
...
class INETVEINS_API IIeee80211DataMode : public IPrintableObject
{
  public:
    virtual bps getNetBitrate() const = 0;
    virtual bps getGrossBitrate() const = 0;
...
class INETVEINS_API IIeee80211Mode : public IPrintableObject
{
  public:
...
#endif // ifndef __INETVEINS_IIEEE80211MODE_H
