...
#ifndef __INETVEINS_IEEE80211OFDMMODE_H
#define __INETVEINS_IEEE80211OFDMMODE_H
...
class INETVEINS_API Ieee80211OFDMTimingRelatedParametersBase
{
  protected:
    Hz channelSpacing;
...
class INETVEINS_API Ieee80211OFDMModeBase : public Ieee80211OFDMTimingRelatedParametersBase
{
  protected:
...
class INETVEINS_API Ieee80211OFDMPreambleMode : public IIeee80211PreambleMode, public Ieee80211OFDMTimingRelatedParametersBase
{
  public:
...
class INETVEINS_API Ieee80211OFDMSignalMode : public IIeee80211HeaderMode, public Ieee80211OFDMModeBase
{
  protected:
    unsigned int rate;
...
class INETVEINS_API Ieee80211OFDMDataMode : public IIeee80211DataMode, public Ieee80211OFDMModeBase
{
  public:
...
class INETVEINS_API Ieee80211OFDMMode : public Ieee80211ModeBase, public Ieee80211OFDMTimingRelatedParametersBase
{
  protected:
...
class INETVEINS_API Ieee80211OFDMCompliantModes
{
  public:
...
#endif // ifndef __INETVEINS_IEEE80211OFDMMODE_H
