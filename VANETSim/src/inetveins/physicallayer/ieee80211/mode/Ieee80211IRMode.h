...
class INETVEINS_API Ieee80211IrPreambleMode : public IIeee80211PreambleMode
{
  protected:
...
class INETVEINS_API Ieee80211IrHeaderMode : public IIeee80211HeaderMode
{
  protected:
...
class INETVEINS_API Ieee80211IrDataMode : public IIeee80211DataMode
{
  protected:
    const PPMModulationBase *modulation;
 ...
 * clause 15.
 */
class INETVEINS_API Ieee80211IrMode : public Ieee80211ModeBase
{
  protected:
 ...
 */
class INETVEINS_API Ieee80211IrCompliantModes
{
  public:
    // preamble modes
