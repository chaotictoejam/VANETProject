...
class INETVEINS_API Ieee80211HrDsssPreambleMode : public IIeee80211PreambleMode
{
  protected:
...
class INETVEINS_API Ieee80211HrDsssHeaderMode : public IIeee80211HeaderMode
{
  protected:
    const Ieee80211HrDsssPreambleType preambleType;
...
class INETVEINS_API Ieee80211HrDsssDataMode : public IIeee80211DataMode
{
  protected:
    const bps bitrate;
 ...
 */
class INETVEINS_API Ieee80211HrDsssMode : public Ieee80211ModeBase
{
  protected:
 ...
 */
class INETVEINS_API Ieee80211HrDsssCompliantModes
{
  public:
    // preamble modes
