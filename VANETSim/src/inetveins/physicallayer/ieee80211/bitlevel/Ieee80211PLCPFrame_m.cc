//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/physicallayer/ieee80211/bitlevel/Ieee80211PLCPFrame.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::physicallayer::Ieee80211PLCPType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::physicallayer::Ieee80211PLCPType"));
    e->insert(OFDM, "OFDM");
    e->insert(DSSS, "DSSS");
...
Ieee80211PLCPFrameDescriptor::Ieee80211PLCPFrameDescriptor() : cClassDescriptor("inetveins::physicallayer::Ieee80211PLCPFrame", "cPacket")
{
}
...
const char *Ieee80211PLCPFrameDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::physicallayer::Ieee80211PLCPType";
            return NULL;
        default: return NULL;
    }
}
