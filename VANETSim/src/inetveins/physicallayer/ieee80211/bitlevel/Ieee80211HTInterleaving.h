...
#ifndef __INETVEINS_IEEE80211HTINTERLEAVING_H
#define __INETVEINS_IEEE80211HTINTERLEAVING_H
...
class INETVEINS_API Ieee80211HTInterleaving : public IInterleaving
{
    protected:
...
#endif // ifndef __INETVEINS_IEEE80211HTINTERLEAVING_H
