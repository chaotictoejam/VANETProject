...
#ifndef __INETVEINS_CIRCLEMOBILITY_H
#define __INETVEINS_CIRCLEMOBILITY_H
 ...
 * @author Andras Varga
 */
class INETVEINS_API CircleMobility : public MovingMobilityBase
{
  protected:
    double cx;
    double cy;
...
#endif // ifndef __INETVEINS_CIRCLEMOBILITY_H
