...
#ifndef __INETVEINS_ANSIMMOBILITY_H
#define __INETVEINS_ANSIMMOBILITY_H
 ...
 * @author Andras Varga
 */
class INETVEINS_API ANSimMobility : public LineSegmentsMobilityBase
{
  protected:
    // config
...
#endif // ifndef __INETVEINS_ANSIMMOBILITY_H
