 ...
 */
class INETVEINS_API Ieee80211Serializer : public SerializerBase
{
    protected:
        void parseDataOrMgmtFrame(const Buffer &b, inetveins::ieee80211::Ieee80211DataOrMgmtFrame *Frame, short type);
