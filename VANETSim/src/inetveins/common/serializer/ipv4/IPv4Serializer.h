...
class INETVEINS_API IPv4OptionSerializerBase : public cOwnedObject
{
  public:
...
class INETVEINS_API IPv4OptionDefaultSerializer : public IPv4OptionSerializerBase
{
  public:
...
class INETVEINS_API IPv4OptionSerializerRegistrationList : public cNamedObject, noncopyable
{
    protected:
        typedef int Key;
...
INETVEINS_API extern IPv4OptionSerializerRegistrationList ipv4OptionSerializers; ///< List of IPv4Option serializers (IPv4OptionSerializerBase)
 ...
 */
class INETVEINS_API IPv4Serializer : public SerializerBase
{
  protected:
