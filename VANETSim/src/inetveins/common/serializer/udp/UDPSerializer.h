...
#ifndef __INETVEINS_UDPSERIALIZER_H
#define __INETVEINS_UDPSERIALIZER_H
 ...
 */
class INETVEINS_API UDPSerializer : public SerializerBase
{
  protected:
...
#endif // ifndef __INETVEINS_UDPSERIALIZER_H
