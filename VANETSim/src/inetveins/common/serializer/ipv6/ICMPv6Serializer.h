...
#ifndef __INETVEINS_ICMPV6SERIALIZER_H
#define __INETVEINS_ICMPV6SERIALIZER_H
 ...
 */
class INETVEINS_API ICMPv6Serializer : public SerializerBase
{
  protected:
...
#endif // ifndef __INETVEINS_ICMPSERIALIZER_H
