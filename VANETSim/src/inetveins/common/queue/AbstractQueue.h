...
#ifndef __INETVEINS_ABSTRACTQUEUE_H
#define __INETVEINS_ABSTRACTQUEUE_H
 ...
 */
class INETVEINS_API AbstractQueue : public cSimpleModule
{
  public:
    AbstractQueue();
...
#endif // ifndef __INETVEINS_ABSTRACTQUEUE_H
