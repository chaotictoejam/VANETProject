...
#ifndef __INETVEINS_PRIORITYSCHEDULER_H
#define __INETVEINS_PRIORITYSCHEDULER_H
 ...
 */
class INETVEINS_API PriorityScheduler : public SchedulerBase
{
  protected:
...
#endif // ifndef __INETVEINS_PRIORITYSCHEDULER_H
