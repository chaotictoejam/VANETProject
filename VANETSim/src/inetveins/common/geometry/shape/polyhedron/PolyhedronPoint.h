...
#ifndef __INETVEINS_POLYHEDRONPOINT_H
#define __INETVEINS_POLYHEDRONPOINT_H
 ...
 */
class INETVEINS_API PolyhedronPoint : public Coord
{
    protected:
...
#endif // ifndef __INETVEINS_POLYHEDRONPOINT_H
