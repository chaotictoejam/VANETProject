 ...
 */
class INETVEINS_API NodeOperation : public LifecycleOperation
{
  public:
 ...
 */
class INETVEINS_API NodeStartOperation : public NodeOperation
{
  public:
    enum Stage {
 ...
 */
class INETVEINS_API NodeShutdownOperation : public NodeOperation
{
  public:
    enum Stage {
        STAGE_LOCAL,    // for changes that don't depend on other modules
 ...
 * stages are organized top-down similarly to the OSI network layers.
 * /
   class INETVEINS_API NodeSuspendOperation : public NodeOperation {
   public:
    enum Stage {
      STAGE_LOCAL, // for changes that don't depend on other modules
      STAGE_APPLICATION_LAYER,
 ...
 * simulation time.
 */
class INETVEINS_API NodeCrashOperation : public NodeOperation
{
  public:
    enum Stage {
