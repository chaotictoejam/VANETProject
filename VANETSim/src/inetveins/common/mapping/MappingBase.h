 ...
 * @ingroup mapping
 */
class INETVEINS_API DimensionSet    /*:public std::set<Dimension>*/
{
  protected:
 ...
 * @ingroup mapping
 */
class INETVEINS_API NoNextIteratorException
{
};
 ...
 * @ingroup mapping
 */
class INETVEINS_API ConstMappingIterator
{
  public:
 ...
 * @ingroup mapping
 */
class INETVEINS_API ConstMapping
{
  public:
    typedef Argument::mapped_type argument_value_t;
    typedef Argument::mapped_type_cref argument_value_cref_t;
 ...
 * @ingroup mapping
 */
class INETVEINS_API MappingIterator : public ConstMappingIterator
{
  public:
 ...
 * @ingroup mapping
 */
class INETVEINS_API Mapping : public ConstMapping
{
  public:
 ...
 * @ingroup mapping
 */
class INETVEINS_API SimpleConstMappingIterator : public ConstMappingIterator
{
  protected:
 ...
 * @ingroup mapping
 */
class INETVEINS_API SimpleConstMapping : public ConstMapping
{
  protected:
    /** @brief Type for a set of Arguments defining key entries.*/
    typedef std::set<Argument> KeyEntrySet;
