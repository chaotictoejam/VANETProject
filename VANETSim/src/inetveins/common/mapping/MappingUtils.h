 ...
 * @ingroup mappingDetails
 */
class INETVEINS_API FilteredMappingIterator : public BaseFilteredIterator<MappingIterator>
{
  public:
 ...
 * @ingroup mappingDetails
 */
class INETVEINS_API LinearIntplMappingIterator : public MappingIterator
{
  protected:
 ...
 * @ingroup mappingDetails
 */
class INETVEINS_API LinearIntplMapping : public Mapping
{
  protected:
 ...
 * @ingroup mapping
 */
class INETVEINS_API ConstantSimpleConstMapping : public SimpleConstMapping
{
  protected:
 ...
 * @ingroup mappingDetails
 */
class INETVEINS_API ConstMappingIteratorWrapper : public MappingIterator
{
  protected:
 ...
 * @ingroup mappingDetails
 */
class INETVEINS_API ConstMappingWrapper : public Mapping
{
  protected:
 ...
 * @ingroup mappingDetails
 */
class INETVEINS_API FilledUpMappingIterator : public MultiDimMappingIterator<Linear>
{
  public:
 ...
 * @ingroup mappingDetails
 */
class INETVEINS_API FilledUpMapping : public MultiDimMapping<Linear>
{
//--------members----------
 ...
 * @ingroup mapping
 */
class INETVEINS_API MappingUtils
{
  public:
 ...
 * @ingroup mappingDetails
 */
class INETVEINS_API ConcatConstMappingIterator : public FilteredConstMappingIterator
{
//--------members----------
 ...
 * @author Karl Wessel
 */
class INETVEINS_API ConstDelayedMapping : public BaseDelayedMapping<const ConstMapping>
{
  public:
 ...
 * @author Karl Wessel
 */
class INETVEINS_API DelayedMapping : public BaseDelayedMapping<Mapping>
{
  public:
...
INETVEINS_API Mapping *operator*(const ConstMapping& f1, const ConstMapping& f2);
INETVEINS_API Mapping *operator/(const ConstMapping& f1, const ConstMapping& f2);
INETVEINS_API Mapping *operator+(const ConstMapping& f1, const ConstMapping& f2);
INETVEINS_API Mapping *operator-(const ConstMapping& f1, const ConstMapping& f2);
