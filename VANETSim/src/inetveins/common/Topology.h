...
class INETVEINS_API Topology : public cOwnedObject
{
  public:
    class Link;
    class LinkIn;
     ...
     */
    class INETVEINS_API LinkIn : public Link
    {
      public:
        /**
     ...
     * 'local' and 'remote' end of the connection when traversing the topology.
     */
    class INETVEINS_API LinkOut : public Link
    {
      public:
        /**
         * Returns the node at the remote end of this connection.
