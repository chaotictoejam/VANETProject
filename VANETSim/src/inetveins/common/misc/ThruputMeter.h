...
#ifndef __INETVEINS_THRUPUTMETER_H
#define __INETVEINS_THRUPUTMETER_H
...
class INETVEINS_API ThruputMeter : public cSimpleModule
{
  protected:
    // config
...
#endif // ifndef __INETVEINS_THRUPUTMETER_H
