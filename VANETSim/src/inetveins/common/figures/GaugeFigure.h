...
class INETVEINS_API GaugeFigure : public cOvalFigure, protected cListener, protected cISimulationLifecycleListener
{
    cPathFigure *needle;
...
class INETVEINS_API GaugeFigure : public cGroupFigure {
