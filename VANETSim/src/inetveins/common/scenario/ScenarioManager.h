...
#ifndef __INETVEINS_SCENARIOMANAGER_H
#define __INETVEINS_SCENARIOMANAGER_H
 ...
 * @author Andras Varga
 */
class INETVEINS_API ScenarioManager : public cSimpleModule
{
  protected:
...
#endif // ifndef __INETVEINS_SCENARIOMANAGER_H
