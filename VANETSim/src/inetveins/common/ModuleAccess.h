...
#ifndef __INETVEINS_MODULEACCESS_H
#define __INETVEINS_MODULEACCESS_H
 ...
 */
INETVEINS_API bool isNetworkNode(cModule *mod);
 ...
 * of the given name.
 */
INETVEINS_API cModule *findModuleSomewhereUp(const char *name, cModule *from);

/**
 * Find the node containing the given module.
 * Returns nullptr, if no containing node.
 */
INETVEINS_API cModule *findContainingNode(cModule *from);

/**
 * Find the node containing the given module.
 * throws error if no containing node.
 */
INETVEINS_API cModule *getContainingNode(cModule *from);

/**
 * Find the ancestor module under the node containing the given module.
 * Returns nullptr, if no such node found.
 */
INETVEINS_API cModule *findModuleUnderContainingNode(cModule *from);
 ...
 */
template<typename T>
INETVEINS_API T *findModuleFromPar(cPar& par, cModule *from, bool required = true);
 ...
 */
template<typename T>
INETVEINS_API T *getModuleFromPar(cPar& par, cModule *from, bool required = true);
...
#endif // ifndef __INETVEINS_MODULEACCESS_H
