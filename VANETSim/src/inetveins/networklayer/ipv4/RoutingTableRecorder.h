 ...
 */
class INETVEINS_API RoutingTableRecorder : public cSimpleModule, public cIndexedEventlogManager::cEventlogListener
{
 ...
 * @see IPv4RoutingTable, IPv4Route
 */
class INETVEINS_API RoutingTableRecorder : public cSimpleModule, public cListener
{
  private:
    FILE *routingLogFile;
  ...
  public:
    ...
    virtual void receiveSignal(cComponent *source, simsignal_t signalID, cObject *obj DETAILS_ARG) override { receiveChangeNotification(source, signalID, obj); }
