...
#include "inetveins/networklayer/ipv4/IPv4FragBuf.h"
 ...
 */
class INETVEINS_API IPv4 : public QueueBase, public INetfilter, public ILifecycle, public INetworkProtocol, public cListener
{
  public:
    /**
