...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::IPOptionClass");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::IPOptionClass"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::IPOption");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::IPOption"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::TimestampFlag");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::TimestampFlag"));
...
IPv4Option::IPv4Option() : ::inetveins::TLVOptionBase()
{
}

IPv4Option::IPv4Option(const IPv4Option& other) : ::inetveins::TLVOptionBase(other)
{
    copy(other);
}
...
{
    doPacking(b,(::inetveins::TLVOptionBase&)*this);
}

void IPv4Option::parsimUnpack(cCommBuffer *b)
{
    doUnpacking(b,(::inetveins::TLVOptionBase&)*this);
}
...
IPv4OptionDescriptor::IPv4OptionDescriptor() : cClassDescriptor("inetveins::IPv4Option", "inetveins::TLVOptionBase")
{
}
...
IPv4OptionNop::IPv4OptionNop() : ::inetveins::IPv4Option()
{
    this->setType(IPOPTION_NO_OPTION);
    this->setLength(1);
}

IPv4OptionNop::IPv4OptionNop(const IPv4OptionNop& other) : ::inetveins::IPv4Option(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::IPv4Option::operator=(other);
    copy(other);
    return *this;
}
...
{
    doPacking(b,(::inetveins::IPv4Option&)*this);
}

void IPv4OptionNop::parsimUnpack(cCommBuffer *b)
{
    doUnpacking(b,(::inetveins::IPv4Option&)*this);
}
...
IPv4OptionNopDescriptor::IPv4OptionNopDescriptor() : cClassDescriptor("inetveins::IPv4OptionNop", "inetveins::IPv4Option")
{
}
...
IPv4OptionEnd::IPv4OptionEnd() : ::inetveins::IPv4Option()
{
    this->setType(IPOPTION_END_OF_OPTIONS);
    this->setLength(1);
}

IPv4OptionEnd::IPv4OptionEnd(const IPv4OptionEnd& other) : ::inetveins::IPv4Option(other)
{
    copy(other);
}
...
IPv4OptionEndDescriptor::IPv4OptionEndDescriptor() : cClassDescriptor("inetveins::IPv4OptionEnd", "inetveins::IPv4Option")
{
}
...
IPv4OptionRecordRoute::IPv4OptionRecordRoute() : ::inetveins::IPv4Option()
{
...
IPv4OptionRecordRoute::IPv4OptionRecordRoute(const IPv4OptionRecordRoute& other) : ::inetveins::IPv4Option(other)
{
    recordAddress_arraysize = 0;
    this->recordAddress_var = 0;
    copy(other);
...
IPv4OptionRecordRouteDescriptor::IPv4OptionRecordRouteDescriptor() : cClassDescriptor("inetveins::IPv4OptionRecordRoute", "inetveins::IPv4Option")
{
}
...
IPv4OptionTimestamp::IPv4OptionTimestamp() : ::inetveins::IPv4Option()
{
...
IPv4OptionTimestamp::IPv4OptionTimestamp(const IPv4OptionTimestamp& other) : ::inetveins::IPv4Option(other)
{
    recordAddress_arraysize = 0;
    this->recordAddress_var = 0;
    recordTimestamp_arraysize = 0;
...
IPv4OptionTimestampDescriptor::IPv4OptionTimestampDescriptor() : cClassDescriptor("inetveins::IPv4OptionTimestamp", "inetveins::IPv4Option")
{
}
...
const char *IPv4OptionTimestampDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::TimestampFlag";
            return NULL;
        default: return NULL;
    }
}
...
IPv4OptionStreamId::IPv4OptionStreamId() : ::inetveins::IPv4Option()
{
...
IPv4OptionStreamId::IPv4OptionStreamId(const IPv4OptionStreamId& other) : ::inetveins::IPv4Option(other)
{
    copy(other);
}
...
IPv4OptionStreamIdDescriptor::IPv4OptionStreamIdDescriptor() : cClassDescriptor("inetveins::IPv4OptionStreamId", "inetveins::IPv4Option")
{
}
...
IPv4OptionUnknown::IPv4OptionUnknown() : ::inetveins::IPv4Option()
{
    bytes_arraysize = 0;
    this->bytes_var = 0;
}

IPv4OptionUnknown::IPv4OptionUnknown(const IPv4OptionUnknown& other) : ::inetveins::IPv4Option(other)
{
    bytes_arraysize = 0;
    this->bytes_var = 0;
    copy(other);
...
IPv4OptionUnknownDescriptor::IPv4OptionUnknownDescriptor() : cClassDescriptor("inetveins::IPv4OptionUnknown", "inetveins::IPv4Option")
{
}
...
IPv4DatagramDescriptor::IPv4DatagramDescriptor() : cClassDescriptor("inetveins::IPv4Datagram", "cPacket")
{
}
