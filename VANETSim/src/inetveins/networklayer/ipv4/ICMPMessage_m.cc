//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/ipv4/ICMPMessage.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ICMPType");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ICMPType"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ICMPRedirectSubcodes");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ICMPRedirectSubcodes"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ICMPTimeExceededSubcodes");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ICMPTimeExceededSubcodes"));
    e->insert(ICMP_TIMXCEED_INTRANS, "ICMP_TIMXCEED_INTRANS");
    e->insert(ICMP_TIMXCEED_REASS, "ICMP_TIMXCEED_REASS");
);

EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ICMPParameterProblemSubcodes");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ICMPParameterProblemSubcodes"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::ICMPDestinationUnreachableCodes");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::ICMPDestinationUnreachableCodes"));
...
ICMPMessageDescriptor::ICMPMessageDescriptor() : cClassDescriptor("inetveins::ICMPMessage", "cPacket")
{
}
...
const char *ICMPMessageDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "inetveins::ICMPType";
            return NULL;
        default: return NULL;
    }
}
