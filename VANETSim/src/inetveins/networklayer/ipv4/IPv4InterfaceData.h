...
struct INETVEINS_API IPv4MulticastSourceList
{
 ...
 */
struct INETVEINS_API IPv4MulticastGroupInfo : public cObject
{
 ...
 */
struct INETVEINS_API IPv4MulticastGroupSourceInfo : public IPv4MulticastGroupInfo
{
    typedef std::vector<IPv4Address> IPv4AddressVector;
...
class INETVEINS_API IPv4InterfaceData : public InterfaceProtocolData
{
  public:
    typedef std::vector<IPv4Address> IPv4AddressVector;
  ...
  protected:
    ...
    struct INETVEINS_API HostMulticastGroupData
    {
    ...
    struct INETVEINS_API HostMulticastData
    {
    ...
    struct INETVEINS_API RouterMulticastGroupData
    {
        IPv4Address multicastGroup;
        IPv4MulticastSourceList sourceList;
    ...
    struct INETVEINS_API RouterMulticastData
    {
