//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/ipv6/IPv6ExtensionHeaders.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::IPv6TLVOptionTypes");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::IPv6TLVOptionTypes"));
...
IPv6HopByHopOptionsHeader::IPv6HopByHopOptionsHeader() : ::inetveins::IPv6ExtensionHeader()
{
    this->setExtensionType(IP_PROT_IPv6EXT_HOP);

}

IPv6HopByHopOptionsHeader::IPv6HopByHopOptionsHeader(const IPv6HopByHopOptionsHeader& other) : ::inetveins::IPv6ExtensionHeader(other)
{
    copy(other);
}
...
IPv6HopByHopOptionsHeader& IPv6HopByHopOptionsHeader::operator=(const IPv6HopByHopOptionsHeader& other)
{
    ...
    ::inetveins::IPv6ExtensionHeader::operator=(other);
    copy(other);
    return *this;
}
...
{
    doPacking(b,(::inetveins::IPv6ExtensionHeader&)*this);
    doPacking(b,this->tlvOptions_var);
}

void IPv6HopByHopOptionsHeader::parsimUnpack(cCommBuffer *b)
{
    doUnpacking(b,(::inetveins::IPv6ExtensionHeader&)*this);
...
IPv6HopByHopOptionsHeaderDescriptor::IPv6HopByHopOptionsHeaderDescriptor() : cClassDescriptor("inetveins::IPv6HopByHopOptionsHeader", "inetveins::IPv6ExtensionHeader")
{
}
...
IPv6RoutingHeader_Base::IPv6RoutingHeader_Base() : ::inetveins::IPv6ExtensionHeader()
{
...
IPv6RoutingHeader_Base::IPv6RoutingHeader_Base(const IPv6RoutingHeader_Base& other) : ::inetveins::IPv6ExtensionHeader(other)
{
    address_arraysize = 0;
    this->address_var = 0;
    copy(other);
...
IPv6RoutingHeaderDescriptor::IPv6RoutingHeaderDescriptor() : cClassDescriptor("inetveins::IPv6RoutingHeader", "inetveins::IPv6ExtensionHeader")
{
}
...
IPv6FragmentHeader::IPv6FragmentHeader() : ::inetveins::IPv6ExtensionHeader()
{
...
IPv6FragmentHeader::IPv6FragmentHeader(const IPv6FragmentHeader& other) : ::inetveins::IPv6ExtensionHeader(other)
{
    copy(other);
}
...
IPv6FragmentHeaderDescriptor::IPv6FragmentHeaderDescriptor() : cClassDescriptor("inetveins::IPv6FragmentHeader", "inetveins::IPv6ExtensionHeader")
{
}
...
IPv6DestinationOptionsHeader::IPv6DestinationOptionsHeader() : ::inetveins::IPv6ExtensionHeader()
{
...
IPv6DestinationOptionsHeader::IPv6DestinationOptionsHeader(const IPv6DestinationOptionsHeader& other) : ::inetveins::IPv6ExtensionHeader(other)
{
    copy(other);
}
...
IPv6DestinationOptionsHeaderDescriptor::IPv6DestinationOptionsHeaderDescriptor() : cClassDescriptor("inetveins::IPv6DestinationOptionsHeader", "inetveins::IPv6ExtensionHeader")
{
}
...
IPv6AuthenticationHeader::IPv6AuthenticationHeader() : ::inetveins::IPv6ExtensionHeader()
{
    this->setExtensionType(IP_PROT_IPv6EXT_AUTH);
    this->setByteLength(8);
}

IPv6AuthenticationHeader::IPv6AuthenticationHeader(const IPv6AuthenticationHeader& other) : ::inetveins::IPv6ExtensionHeader(other)
{
    copy(other);
}
...
IPv6AuthenticationHeaderDescriptor::IPv6AuthenticationHeaderDescriptor() : cClassDescriptor("inetveins::IPv6AuthenticationHeader", "inetveins::IPv6ExtensionHeader")
{
}
...
IPv6EncapsulatingSecurityPayloadHeader::IPv6EncapsulatingSecurityPayloadHeader() : ::inetveins::IPv6ExtensionHeader()
{
    this->setExtensionType(IP_PROT_IPv6EXT_ESP);
    this->setByteLength(8);
}

IPv6EncapsulatingSecurityPayloadHeader::IPv6EncapsulatingSecurityPayloadHeader(const IPv6EncapsulatingSecurityPayloadHeader& other) : ::inetveins::IPv6ExtensionHeader(other)
{
    copy(other);
}
...
IPv6EncapsulatingSecurityPayloadHeaderDescriptor::IPv6EncapsulatingSecurityPayloadHeaderDescriptor() : cClassDescriptor("inetveins::IPv6EncapsulatingSecurityPayloadHeader", "inetveins::IPv6ExtensionHeader")
{
}
