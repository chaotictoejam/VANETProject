...
#ifndef __INETVEINS_IPV6ROUTE_H
#define __INETVEINS_IPV6ROUTE_H
 ...
 */
class INETVEINS_API IPv6Route : public cObject, public IRoute
{
  public:
...
#endif // ifndef __INETVEINS_IPV6ROUTE_H
