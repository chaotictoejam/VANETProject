//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/common/IPProtocolId.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::IPProtocolId");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::IPProtocolId"));
...
IPRegisterProtocolCommandDescriptor::IPRegisterProtocolCommandDescriptor() : cClassDescriptor("inetveins::IPRegisterProtocolCommand", "cObject")
{
}
