...
#ifndef __INETVEINS_INTERFACEENTRY_H
#define __INETVEINS_INTERFACEENTRY_H
...
#include "inetveins/networklayer/common/InterfaceToken.h"
...
class INETVEINS_API MacEstimateCostProcess
{
  public:
 ...
 */
class INETVEINS_API InterfaceProtocolData : public cObject
{
...
class INETVEINS_API InterfaceEntryChangeDetails : public cObject
{
    InterfaceEntry *ie;
    int field;
 ...
 * @see IInterfaceTable
 */
class INETVEINS_API InterfaceEntry : public cNamedObject
{
...
#endif // ifndef __INETVEINS_INTERFACEENTRY_H
