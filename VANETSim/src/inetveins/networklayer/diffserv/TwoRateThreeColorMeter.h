...
#ifndef __INETVEINS_TWORATETHREECOLORMETER_H
#define __INETVEINS_TWORATETHREECOLORMETER_H
 ...
 * See RFC 2698.
 */
class INETVEINS_API TwoRateThreeColorMeter : public cSimpleModule
{
  protected:
...
#endif // ifndef __INETVEINS_TWORATETHREECOLORMETER_H
