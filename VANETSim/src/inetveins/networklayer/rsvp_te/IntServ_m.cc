//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/rsvp_te/IntServ.msg.
//
...
SessionObj_tDescriptor::SessionObj_tDescriptor() : cClassDescriptor("inetveins::SessionObj_t", "")
{
}
...
RsvpHopObj_tDescriptor::RsvpHopObj_tDescriptor() : cClassDescriptor("inetveins::RsvpHopObj_t", "")
{
}
...
SenderTemplateObj_tDescriptor::SenderTemplateObj_tDescriptor() : cClassDescriptor("inetveins::SenderTemplateObj_t", "")
{
}
...
SenderTspecObj_tDescriptor::SenderTspecObj_tDescriptor() : cClassDescriptor("inetveins::SenderTspecObj_t", "")
{
}
...
{
    doPacking(b,(::inetveins::SenderTspecObj_t&)a);
}

void doUnpacking(cCommBuffer *b, FlowSpecObj_t& a)
{
    doUnpacking(b,(::inetveins::SenderTspecObj_t&)a);
}
...
FlowSpecObj_tDescriptor::FlowSpecObj_tDescriptor() : cClassDescriptor("inetveins::FlowSpecObj_t", "inetveins::SenderTspecObj_t")
{
}
...
{
    doPacking(b,(::inetveins::SenderTemplateObj_t&)a);
}

void doUnpacking(cCommBuffer *b, FilterSpecObj_t& a)
{
    doUnpacking(b,(::inetveins::SenderTemplateObj_t&)a);
}
...
FilterSpecObj_tDescriptor::FilterSpecObj_tDescriptor() : cClassDescriptor("inetveins::FilterSpecObj_t", "inetveins::SenderTemplateObj_t")
{
}
...
LabelRequestObj_tDescriptor::LabelRequestObj_tDescriptor() : cClassDescriptor("inetveins::LabelRequestObj_t", "")
{
}
...
SenderDescriptor_tDescriptor::SenderDescriptor_tDescriptor() : cClassDescriptor("inetveins::SenderDescriptor_t", "")
{
}
...
EroObj_tDescriptor::EroObj_tDescriptor() : cClassDescriptor("inetveins::EroObj_t", "")
{
}
...
FlowDescriptor_tDescriptor::FlowDescriptor_tDescriptor() : cClassDescriptor("inetveins::FlowDescriptor_t", "")
{
}
