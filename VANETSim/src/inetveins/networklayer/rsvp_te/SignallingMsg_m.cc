//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/rsvp_te/SignallingMsg.msg.
//
...
SignallingMsgDescriptor::SignallingMsgDescriptor() : cClassDescriptor("inetveins::SignallingMsg", "cMessage")
{
}
...
PsbTimerMsg::PsbTimerMsg(const char *name, int kind) : ::inetveins::SignallingMsg(name,kind)
{
    this->id_var = 0;
    this->command_var = MSG_PSB_TIMER;
}

PsbTimerMsg::PsbTimerMsg(const PsbTimerMsg& other) : ::inetveins::SignallingMsg(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::SignallingMsg::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::SignallingMsg::parsimPack(b);
...
{
    ::inetveins::SignallingMsg::parsimUnpack(b);
...
PsbTimerMsgDescriptor::PsbTimerMsgDescriptor() : cClassDescriptor("inetveins::PsbTimerMsg", "inetveins::SignallingMsg")
{
}
...
PsbTimeoutMsg::PsbTimeoutMsg(const char *name, int kind) : ::inetveins::SignallingMsg(name,kind)
{
    this->id_var = 0;
    this->command_var = MSG_PSB_TIMEOUT;
}

PsbTimeoutMsg::PsbTimeoutMsg(const PsbTimeoutMsg& other) : ::inetveins::SignallingMsg(other)
{
    copy(other);
}
...
PsbTimeoutMsgDescriptor::PsbTimeoutMsgDescriptor() : cClassDescriptor("inetveins::PsbTimeoutMsg", "inetveins::SignallingMsg")
{
}
...
RsbRefreshTimerMsg::RsbRefreshTimerMsg(const char *name, int kind) : ::inetveins::SignallingMsg(name,kind)
{
    this->id_var = 0;
    this->command_var = MSG_RSB_REFRESH_TIMER;
}

RsbRefreshTimerMsg::RsbRefreshTimerMsg(const RsbRefreshTimerMsg& other) : ::inetveins::SignallingMsg(other)
{
    copy(other);
}
...
RsbRefreshTimerMsgDescriptor::RsbRefreshTimerMsgDescriptor() : cClassDescriptor("inetveins::RsbRefreshTimerMsg", "inetveins::SignallingMsg")
{
}
...
RsbCommitTimerMsg::RsbCommitTimerMsg(const char *name, int kind) : ::inetveins::SignallingMsg(name,kind)
{
    this->id_var = 0;
    this->command_var = MSG_RSB_COMMIT_TIMER;
}

RsbCommitTimerMsg::RsbCommitTimerMsg(const RsbCommitTimerMsg& other) : ::inetveins::SignallingMsg(other)
{
    copy(other);
}
...
RsbCommitTimerMsgDescriptor::RsbCommitTimerMsgDescriptor() : cClassDescriptor("inetveins::RsbCommitTimerMsg", "inetveins::SignallingMsg")
{
}
...
RsbTimeoutMsg::RsbTimeoutMsg(const char *name, int kind) : ::inetveins::SignallingMsg(name,kind)
{
    this->id_var = 0;
    this->command_var = MSG_RSB_TIMEOUT;
}

RsbTimeoutMsg::RsbTimeoutMsg(const RsbTimeoutMsg& other) : ::inetveins::SignallingMsg(other)
{
    copy(other);
}
...
RsbTimeoutMsgDescriptor::RsbTimeoutMsgDescriptor() : cClassDescriptor("inetveins::RsbTimeoutMsg", "inetveins::SignallingMsg")
{
}
...
HelloTimerMsg::HelloTimerMsg(const char *name, int kind) : ::inetveins::SignallingMsg(name,kind)
{
    this->command_var = MSG_HELLO_TIMER;
}

HelloTimerMsg::HelloTimerMsg(const HelloTimerMsg& other) : ::inetveins::SignallingMsg(other)
{
    copy(other);
}
...
HelloTimerMsgDescriptor::HelloTimerMsgDescriptor() : cClassDescriptor("inetveins::HelloTimerMsg", "inetveins::SignallingMsg")
{
}
...
HelloTimeoutMsg::HelloTimeoutMsg(const char *name, int kind) : ::inetveins::SignallingMsg(name,kind)
{
    this->command_var = MSG_HELLO_TIMEOUT;
}

HelloTimeoutMsg::HelloTimeoutMsg(const HelloTimeoutMsg& other) : ::inetveins::SignallingMsg(other)
{
    copy(other);
}
...
HelloTimeoutMsgDescriptor::HelloTimeoutMsgDescriptor() : cClassDescriptor("inetveins::HelloTimeoutMsg", "inetveins::SignallingMsg")
{
}
...
PathNotifyMsg::PathNotifyMsg(const char *name, int kind) : ::inetveins::SignallingMsg(name,kind)
{
    this->status_var = 0;
    this->command_var = MSG_PATH_NOTIFY;
}

PathNotifyMsg::PathNotifyMsg(const PathNotifyMsg& other) : ::inetveins::SignallingMsg(other)
{
    copy(other);
}
...
PathNotifyMsgDescriptor::PathNotifyMsgDescriptor() : cClassDescriptor("inetveins::PathNotifyMsg", "inetveins::SignallingMsg")
{
}
