 ...
 */
class INETVEINS_API RSVPPathMsg : public RSVPPathMsg_Base
{
  public:
 ...
 * base class, but no extra data.
 */
class INETVEINS_API RSVPPathTear : public RSVPPathTear_Base
{
  public:
 ...
 * base class, but no extra data.
 */
class INETVEINS_API RSVPPathError : public RSVPPathError_Base
{
  public:
