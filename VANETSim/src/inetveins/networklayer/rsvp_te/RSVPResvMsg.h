 ...
 */
class INETVEINS_API RSVPResvMsg : public RSVPResvMsg_Base
{
  public:
    RSVPResvMsg(const char *name = nullptr, int kind = RESV_MESSAGE) : RSVPResvMsg_Base(name, kind) {}
 ...
 * base class, but no extra data.
 */
class INETVEINS_API RSVPResvTear : public RSVPResvTear_Base
{
  public:
 ...
 * base class, but no extra data.
 */
class INETVEINS_API RSVPResvError : public RSVPResvError_Base
{
  public:
