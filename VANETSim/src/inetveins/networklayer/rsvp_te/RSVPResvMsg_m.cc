//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/rsvp_te/RSVPResvMsg.msg.
//
...
RSVPResvMsg_Base::RSVPResvMsg_Base(const char *name, int kind) : ::inetveins::RSVPPacket(name,kind)
{
    this->rsvpKind_var = RESV_MESSAGE;
}

RSVPResvMsg_Base::RSVPResvMsg_Base(const RSVPResvMsg_Base& other) : ::inetveins::RSVPPacket(other)
{
    copy(other);
}
...
RSVPResvMsg_Base& RSVPResvMsg_Base::operator=(const RSVPResvMsg_Base& other)
{
    ...
    ::inetveins::RSVPPacket::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::RSVPPacket::parsimPack(b);
...
{
    ::inetveins::RSVPPacket::parsimUnpack(b);
...
RSVPResvMsgDescriptor::RSVPResvMsgDescriptor() : cClassDescriptor("inetveins::RSVPResvMsg", "inetveins::RSVPPacket")
{
}
...
RSVPResvTear_Base::RSVPResvTear_Base(const char *name, int kind) : ::inetveins::RSVPPacket(name,kind)
{
    this->rsvpKind_var = RTEAR_MESSAGE;
}

RSVPResvTear_Base::RSVPResvTear_Base(const RSVPResvTear_Base& other) : ::inetveins::RSVPPacket(other)
{
    copy(other);
}
...
RSVPResvTearDescriptor::RSVPResvTearDescriptor() : cClassDescriptor("inetveins::RSVPResvTear", "inetveins::RSVPPacket")
{
}
...
RSVPResvError_Base::RSVPResvError_Base(const char *name, int kind) : ::inetveins::RSVPPacket(name,kind)
{
    this->errorCode_var = 0;
    this->rsvpKind_var = RERROR_MESSAGE;
}

RSVPResvError_Base::RSVPResvError_Base(const RSVPResvError_Base& other) : ::inetveins::RSVPPacket(other)
{
    copy(other);
}
...
RSVPResvErrorDescriptor::RSVPResvErrorDescriptor() : cClassDescriptor("inetveins::RSVPResvError", "inetveins::RSVPPacket")
{
}
