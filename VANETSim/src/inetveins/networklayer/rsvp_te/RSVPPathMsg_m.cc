...
RSVPPathMsg_Base::RSVPPathMsg_Base(const char *name, int kind) : ::inetveins::RSVPPacket(name,kind)
{
    this->color_var = 0;
    this->rsvpKind_var = PATH_MESSAGE;
}

RSVPPathMsg_Base::RSVPPathMsg_Base(const RSVPPathMsg_Base& other) : ::inetveins::RSVPPacket(other)
{
    copy(other);
}
...
RSVPPathMsgDescriptor::RSVPPathMsgDescriptor() : cClassDescriptor("inetveins::RSVPPathMsg", "inetveins::RSVPPacket")
{
}
...
RSVPPathTear_Base::RSVPPathTear_Base(const char *name, int kind) : ::inetveins::RSVPPacket(name,kind)
{
    this->force_var = 0;
    this->rsvpKind_var = PTEAR_MESSAGE;
}

RSVPPathTear_Base::RSVPPathTear_Base(const RSVPPathTear_Base& other) : ::inetveins::RSVPPacket(other)
{
    copy(other);
}
...
RSVPPathTearDescriptor::RSVPPathTearDescriptor() : cClassDescriptor("inetveins::RSVPPathTear", "inetveins::RSVPPacket")
{
}
...
RSVPPathError_Base::RSVPPathError_Base(const char *name, int kind) : ::inetveins::RSVPPacket(name,kind)
{
    this->errorCode_var = 0;
    this->rsvpKind_var = PERROR_MESSAGE;
}

RSVPPathError_Base::RSVPPathError_Base(const RSVPPathError_Base& other) : ::inetveins::RSVPPacket(other)
{
    copy(other);
}
...
RSVPPathErrorDescriptor::RSVPPathErrorDescriptor() : cClassDescriptor("inetveins::RSVPPathError", "inetveins::RSVPPacket")
{
}
