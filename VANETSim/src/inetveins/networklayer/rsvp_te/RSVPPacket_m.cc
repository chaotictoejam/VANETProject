//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/rsvp_te/RSVPPacket.msg.
//
...
RSVPMessageDescriptor::RSVPMessageDescriptor() : cClassDescriptor("inetveins::RSVPMessage", "cPacket")
{
}
...
RSVPPacket_Base::RSVPPacket_Base(const char *name, int kind) : ::inetveins::RSVPMessage(name,kind)
{
    this->checksumValid_var = true;
}

RSVPPacket_Base::RSVPPacket_Base(const RSVPPacket_Base& other) : ::inetveins::RSVPMessage(other)
{
    copy(other);
}
...
RSVPPacketDescriptor::RSVPPacketDescriptor() : cClassDescriptor("inetveins::RSVPPacket", "inetveins::RSVPMessage")
{
}
