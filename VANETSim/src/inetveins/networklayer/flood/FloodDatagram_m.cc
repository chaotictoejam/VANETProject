...
FloodDatagram_Base::FloodDatagram_Base(const char *name, int kind) : ::inetveins::NetworkDatagramBase(name,kind)
{
    this->ttl_var = 1;
    this->seqNum_var = 0;
...
FloodDatagram_Base::FloodDatagram_Base(const FloodDatagram_Base& other) : ::inetveins::NetworkDatagramBase(other)
{
    copy(other);
}
...
FloodDatagramDescriptor::FloodDatagramDescriptor() : cClassDescriptor("inetveins::FloodDatagram", "inetveins::NetworkDatagramBase")
{
}
