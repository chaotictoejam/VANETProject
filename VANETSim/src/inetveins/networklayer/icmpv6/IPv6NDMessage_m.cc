//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/icmpv6/IPv6NDMessage.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::IPv6NDOptionLength");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::IPv6NDOptionLength"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::IPv6NDOptionTypes");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::IPv6NDOptionTypes"));
...
IPv6NDPrefixInformationDescriptor::IPv6NDPrefixInformationDescriptor() : cClassDescriptor("inetveins::IPv6NDPrefixInformation", "cObject")
{
}
...
MIPv6NDAdvertisementIntervalDescriptor::MIPv6NDAdvertisementIntervalDescriptor() : cClassDescriptor("inetveins::MIPv6NDAdvertisementInterval", "cObject")
{
}
...
MIPv6HAInformationDescriptor::MIPv6HAInformationDescriptor() : cClassDescriptor("inetveins::MIPv6HAInformation", "cObject")
{
}
...
IPv6NDMessage::IPv6NDMessage(const char *name, int kind) : ::inetveins::ICMPv6Message(name,kind)
{
    this->code_var = 0;
}

IPv6NDMessage::IPv6NDMessage(const IPv6NDMessage& other) : ::inetveins::ICMPv6Message(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::ICMPv6Message::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::ICMPv6Message::parsimPack(b);
    doPacking(b,this->code_var);
}

void IPv6NDMessage::parsimUnpack(cCommBuffer *b)
{
    ::inetveins::ICMPv6Message::parsimUnpack(b);
...
IPv6NDMessageDescriptor::IPv6NDMessageDescriptor() : cClassDescriptor("inetveins::IPv6NDMessage", "inetveins::ICMPv6Message")
{
}
...
IPv6RouterSolicitation::IPv6RouterSolicitation(const char *name, int kind) : ::inetveins::IPv6NDMessage(name,kind)
{
}

IPv6RouterSolicitation::IPv6RouterSolicitation(const IPv6RouterSolicitation& other) : ::inetveins::IPv6NDMessage(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::IPv6NDMessage::operator=(other);
    copy(other);
    return *this;
}
...
IPv6RouterSolicitationDescriptor::IPv6RouterSolicitationDescriptor() : cClassDescriptor("inetveins::IPv6RouterSolicitation", "inetveins::IPv6NDMessage")
{
}
...
IPv6RouterAdvertisement::IPv6RouterAdvertisement(const char *name, int kind) : ::inetveins::IPv6NDMessage(name,kind)
{
...
IPv6RouterAdvertisement::IPv6RouterAdvertisement(const IPv6RouterAdvertisement& other) : ::inetveins::IPv6NDMessage(other)
{
    prefixInformation_arraysize = 0;
    this->prefixInformation_var = 0;
    copy(other);
...
IPv6RouterAdvertisementDescriptor::IPv6RouterAdvertisementDescriptor() : cClassDescriptor("inetveins::IPv6RouterAdvertisement", "inetveins::IPv6NDMessage")
{
}
...
IPv6NeighbourSolicitation::IPv6NeighbourSolicitation(const char *name, int kind) : ::inetveins::IPv6NDMessage(name,kind)
{
}

IPv6NeighbourSolicitation::IPv6NeighbourSolicitation(const IPv6NeighbourSolicitation& other) : ::inetveins::IPv6NDMessage(other)
{
    copy(other);
}
...
IPv6NeighbourSolicitationDescriptor::IPv6NeighbourSolicitationDescriptor() : cClassDescriptor("inetveins::IPv6NeighbourSolicitation", "inetveins::IPv6NDMessage")
{
}
...
IPv6NeighbourAdvertisement::IPv6NeighbourAdvertisement(const char *name, int kind) : ::inetveins::IPv6NDMessage(name,kind)
{
...
IPv6NeighbourAdvertisement::IPv6NeighbourAdvertisement(const IPv6NeighbourAdvertisement& other) : ::inetveins::IPv6NDMessage(other)
{
    copy(other);
}
...
IPv6NeighbourAdvertisementDescriptor::IPv6NeighbourAdvertisementDescriptor() : cClassDescriptor("inetveins::IPv6NeighbourAdvertisement", "inetveins::IPv6NDMessage")
{
}
...
IPv6Redirect::IPv6Redirect(const char *name, int kind) : ::inetveins::IPv6NDMessage(name,kind)
{
}

IPv6Redirect::IPv6Redirect(const IPv6Redirect& other) : ::inetveins::IPv6NDMessage(other)
{
    copy(other);
}
...
IPv6RedirectDescriptor::IPv6RedirectDescriptor() : cClassDescriptor("inetveins::IPv6Redirect", "inetveins::IPv6NDMessage")
{
}
...
IPv6NDControlInfoDescriptor::IPv6NDControlInfoDescriptor() : cClassDescriptor("inetveins::IPv6NDControlInfo", "cObject")
{
}
