...
class INETVEINS_API NetworkConfiguratorBase : public cSimpleModule, public L3AddressResolver
{
  public:
    class LinkInfo;
    class InterfaceInfo;
     ...
     */
    class Node : public inetveins::Topology::Node
    {
      public:
      ...
      public:
        Node(cModule *module) : inetveins::Topology::Node(module->getId()), module(module) { }
     ...
     */
    class Link : public inetveins::Topology::Link
    {
      public:
     ...
     */
    class Topology : public inetveins::Topology
    {
      public:
    ...
    class Matcher
    {
      protected:
        ...
        std::vector<inetveins::PatternMatcher *> matchers;    // TODO replace with a MatchExpression once it becomes available in OMNeT++
    ...
    class InterfaceMatcher
    {
      protected:
        bool matchesany = false;
        std::vector<inetveins::PatternMatcher *> nameMatchers;
        std::vector<inetveins::PatternMatcher *> towardsMatchers;
