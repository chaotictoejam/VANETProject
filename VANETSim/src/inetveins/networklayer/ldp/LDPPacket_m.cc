...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::LDP_MESSAGE_TYPES");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::LDP_MESSAGE_TYPES"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::LDP_STATUS_TYPES");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::LDP_STATUS_TYPES"));
...
FEC_TLVDescriptor::FEC_TLVDescriptor() : cClassDescriptor("inetveins::FEC_TLV", "")
{
}
...
LDPPacketDescriptor::LDPPacketDescriptor() : cClassDescriptor("inetveins::LDPPacket", "cPacket")
{
}
...
LDPLabelMapping::LDPLabelMapping(const char *name, int kind) : ::inetveins::LDPPacket(name,kind)
{
    this->label_var = 0;
}

LDPLabelMapping::LDPLabelMapping(const LDPLabelMapping& other) : ::inetveins::LDPPacket(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::inetveins::LDPPacket::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::LDPPacket::parsimPack(b);
...
{
    ::inetveins::LDPPacket::parsimUnpack(b);
...
LDPLabelMappingDescriptor::LDPLabelMappingDescriptor() : cClassDescriptor("inetveins::LDPLabelMapping", "inetveins::LDPPacket")
{
}
...
LDPLabelRequest::LDPLabelRequest(const char *name, int kind) : ::inetveins::LDPPacket(name,kind)
{
}

LDPLabelRequest::LDPLabelRequest(const LDPLabelRequest& other) : ::inetveins::LDPPacket(other)
{
    copy(other);
}
...
LDPLabelRequestDescriptor::LDPLabelRequestDescriptor() : cClassDescriptor("inetveins::LDPLabelRequest", "inetveins::LDPPacket")
{
}
...
LDPHello::LDPHello(const char *name, int kind) : ::inetveins::LDPPacket(name,kind)
{
    this->holdTime_var = 0;
    this->tbit_var = 0;
    this->rbit_var = 0;
...
LDPHello::LDPHello(const LDPHello& other) : ::inetveins::LDPPacket(other)
{
    copy(other);
}
...
LDPHelloDescriptor::LDPHelloDescriptor() : cClassDescriptor("inetveins::LDPHello", "inetveins::LDPPacket")
{
}
...
LDPNotify::LDPNotify(const char *name, int kind) : ::inetveins::LDPPacket(name,kind)
{
    this->status_var = 0;
}

LDPNotify::LDPNotify(const LDPNotify& other) : ::inetveins::LDPPacket(other)
{
    copy(other);
}
...
LDPNotifyDescriptor::LDPNotifyDescriptor() : cClassDescriptor("inetveins::LDPNotify", "inetveins::LDPPacket")
{
}
...
LDPIni::LDPIni(const char *name, int kind) : ::inetveins::LDPPacket(name,kind)
{
...
LDPIni::LDPIni(const LDPIni& other) : ::inetveins::LDPPacket(other)
{
    copy(other);
}
...
LDPIniDescriptor::LDPIniDescriptor() : cClassDescriptor("inetveins::LDPIni", "inetveins::LDPPacket")
{
}
...
LDPAddress::LDPAddress(const char *name, int kind) : ::inetveins::LDPPacket(name,kind)
{
...
LDPAddress::LDPAddress(const LDPAddress& other) : ::inetveins::LDPPacket(other)
{
    addresses_arraysize = 0;
    this->addresses_var = 0;
    copy(other);
...
LDPAddressDescriptor::LDPAddressDescriptor() : cClassDescriptor("inetveins::LDPAddress", "inetveins::LDPPacket")
{
}
