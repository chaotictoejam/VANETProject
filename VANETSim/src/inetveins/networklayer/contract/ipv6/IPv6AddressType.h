...
#ifndef __INETVEINS_IPV6ADDRESSTYPE_H
#define __INETVEINS_IPV6ADDRESSTYPE_H
...
class INETVEINS_API IPv6AddressType : public IL3AddressType
{
  public:
...
#endif // ifndef __INETVEINS_IPV6ADDRESSTYPE_H
