//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/contract/ipv4/IPv4ControlInfo.msg.
//
...
IPv4ControlInfoDescriptor::IPv4ControlInfoDescriptor() : cClassDescriptor("inetveins::IPv4ControlInfo", "cObject")
{
}
