...
WiseRouteDatagram_Base::WiseRouteDatagram_Base(const char *name, int kind) : ::inetveins::NetworkDatagramBase(name,kind)
{
    this->seqNum_var = 0;
    this->isFlood_var = 0;
    this->nbHops_var = 0;
...
WiseRouteDatagram_Base::WiseRouteDatagram_Base(const WiseRouteDatagram_Base& other) : ::inetveins::NetworkDatagramBase(other)
{
    copy(other);
}
...
WiseRouteDatagramDescriptor::WiseRouteDatagramDescriptor() : cClassDescriptor("inetveins::WiseRouteDatagram", "inetveins::NetworkDatagramBase")
{
}
