...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inetveins::GenericTLVOptionTypes");
    if (!e) enums.getInstance()->add(e = new cEnum("inetveins::GenericTLVOptionTypes"));
...
GenericDatagramDescriptor::GenericDatagramDescriptor() : cClassDescriptor("inetveins::GenericDatagram", "cPacket")
{
}
