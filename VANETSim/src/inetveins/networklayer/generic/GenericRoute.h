...
#ifndef __INETVEINS_GENERICROUTE_H
#define __INETVEINS_GENERICROUTE_H
 ...
 */
class INETVEINS_API GenericRoute : public cObject, public IRoute
{
  private:
...
class INETVEINS_API GenericMulticastRoute : public cObject
{
};
 ...
 * TODO
 */
class INETVEINS_API GenericMulticastRoute : public cObject, public IGenericMulticastRoute
{
  private:
...
#endif // ifndef __INETVEINS_GENERICROUTE_H
