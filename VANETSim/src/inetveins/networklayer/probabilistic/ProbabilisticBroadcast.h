...
#include "inetveins/networklayer/base/NetworkProtocolBase.h"
#include "inetveins/networklayer/probabilistic/ProbabilisticBroadcastDatagram.h"
 ...
 * @author Damien Piguet
 **/
class INETVEINS_API ProbabilisticBroadcast : public NetworkProtocolBase, public INetworkProtocol
{
  private:
