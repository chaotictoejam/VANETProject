//
// Generated file, do not edit! Created by nedtool 4.6 from inetveins/networklayer/probabilistic/ProbabilisticBroadcastDatagram.msg.
//
...
ProbabilisticBroadcastDatagram_Base::ProbabilisticBroadcastDatagram_Base(const char *name, int kind) : ::inetveins::NetworkDatagramBase(name,kind)
{
    this->id_var = 0;
    this->nbHops_var = 0;
...
ProbabilisticBroadcastDatagram_Base::ProbabilisticBroadcastDatagram_Base(const ProbabilisticBroadcastDatagram_Base& other) : ::inetveins::NetworkDatagramBase(other)
{
    copy(other);
}
...
ProbabilisticBroadcastDatagram_Base& ProbabilisticBroadcastDatagram_Base::operator=(const ProbabilisticBroadcastDatagram_Base& other)
{
    ...
    ::inetveins::NetworkDatagramBase::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::inetveins::NetworkDatagramBase::parsimPack(b);
...
{
    ::inetveins::NetworkDatagramBase::parsimUnpack(b);
...
ProbabilisticBroadcastDatagramDescriptor::ProbabilisticBroadcastDatagramDescriptor() : cClassDescriptor("inetveins::ProbabilisticBroadcastDatagram", "inetveins::NetworkDatagramBase")
{
}
