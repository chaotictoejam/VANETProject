...
/* If expanding ring search is used, blackvslist_TIMEOUT should be?: */
#define blackvslist_TIMEOUT       RREQ_RETRIES * NET_TRAVERSAL_TIME + (TTL_THRESHOLD - TTL_START)/TTL_INCREMENT + 1 + RREQ_RETRIES
