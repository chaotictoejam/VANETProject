//
// Generated file, do not edit! Created by opp_msgc 4.4 from src/routing/aodv/VS_AODVControlPackets.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("AODVControlPacketType");
    if (!e) enums.getInstance()->add(e = new cEnum("AODVControlPacketType"));
    e->insert(RREQ, "RREQ");
    e->insert(RREP, "RREP");
    e->insert(RERR, "RERR");
...
AODVControlPacketDescriptor::AODVControlPacketDescriptor() : cClassDescriptor("AODVControlPacket", "cPacket")
{
}
...
AODVRREQ::AODVRREQ(const char *name) : AODVControlPacket(name)
{
...
IPv4Address& AODVRREQ::getDestAddr()
{
    return destAddr_var;
}

void AODVRREQ::setDestAddr(const IPv4Address& destAddr)
{
...
IPv4Address& AODVRREQ::getOriginatorAddr()
{
    return originatorAddr_var;
}

void AODVRREQ::setOriginatorAddr(const IPv4Address& originatorAddr)
{
...
AODVRREQDescriptor::AODVRREQDescriptor() : cClassDescriptor("AODVRREQ", "AODVControlPacket")
{
}
...
AODVRREP::AODVRREP(const char *name) : AODVControlPacket(name)
{
...
IPv4Address& AODVRREP::getDestAddr()
{
    return destAddr_var;
}

void AODVRREP::setDestAddr(const IPv4Address& destAddr)
{
    this->destAddr_var = destAddr;
}
...
IPv4Address& AODVRREP::getOriginatorAddr()
{
    return originatorAddr_var;
}

void AODVRREP::setOriginatorAddr(const IPv4Address& originatorAddr)
{
    this->originatorAddr_var = originatorAddr;
}
...
AODVRREPDescriptor::AODVRREPDescriptor() : cClassDescriptor("AODVRREP", "AODVControlPacket")
{
}
...
AODVRERR::AODVRERR(const char *name) : AODVControlPacket(name)
{
...
AODVRERR::AODVRERR(const AODVRERR& other) : AODVControlPacket(other)
{
    unreachableNodes_arraysize = 0;
    this->unreachableNodes_var = 0;
    copy(other);
...
AODVRERRDescriptor::AODVRERRDescriptor() : cClassDescriptor("AODVRERR", "AODVControlPacket")
{
}
...
AODVRREPACK::AODVRREPACK(const char *name) : AODVControlPacket(name)
{
    this->packetType_var = RREPACK;
}

AODVRREPACK::AODVRREPACK(const AODVRREPACK& other) : AODVControlPacket(other)
{
    copy(other);
}
...
AODVRREPACKDescriptor::AODVRREPACKDescriptor() : cClassDescriptor("AODVRREPACK", "AODVControlPacket")
{
}
