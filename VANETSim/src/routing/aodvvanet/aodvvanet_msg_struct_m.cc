//
// Generated file, do not edit! Created by nedtool 4.6 from routing/aodvvanet/aodvvanet_msg_struct.msg.
//
...
RERRDescriptor::RERRDescriptor() : cClassDescriptor("RERR", "AODVVANET_msg")
{
}
