//
// Generated file, do not edit! Created by nedtool 4.6 from linklayer/ideal/IdealMacFrame.msg.
//
...
IdealMacFrameDescriptor::IdealMacFrameDescriptor() : cClassDescriptor("inet::IdealMacFrame", "cPacket")
{
}
