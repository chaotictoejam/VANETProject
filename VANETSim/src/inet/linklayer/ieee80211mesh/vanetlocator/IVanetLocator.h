...
#ifndef IVANETLOCATOR_H_
#define IVANETLOCATOR_H_
...
class INET_API IVanetLocator
{
    public:
        virtual ~IVanetLocator() {}
...
class INET_API VanetLocatorModuleAccess : public ModuleAccess<IVanetLocator>
{
  public:
    VanetLocatorModuleAccess() : ModuleAccess<IVanetLocator>("locator") {}
};
