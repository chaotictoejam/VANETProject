...
#ifndef VANETLOCATORMODULE_H_
#define VANETLOCATORMODULE_H_

#include <csimplemodule.h>
#include <map>
#include <set>
#include "IVanetLocator.h"
...
class VanetLocatorModule : public cSimpleModule, public IVanetLocator, protected INotifiable, protected cListener
{
    protected:
        struct LocEntry
        {
        ...
        std::map<VanetAddress,unsigned int> sequenceMap;
    ...
    public:
        friend std::ostream& operator<<(std::ostream& os, const VanetLocatorModule::LocEntry& e);
        VanetLocatorModule();
        virtual ~VanetLocatorModule();
