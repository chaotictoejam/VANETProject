...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::Ieee802MessageKind");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::Ieee802MessageKind"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::SAPCode");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::SAPCode"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::EtherType");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::EtherType"));
...
Ieee802CtrlDescriptor::Ieee802CtrlDescriptor() : cClassDescriptor("inet::Ieee802Ctrl", "cObject")
{
}
