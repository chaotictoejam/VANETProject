//
// Generated file, do not edit! Created by nedtool 4.6 from src/inet/transport/rtp/RTPInterfacePacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("RTP_IFP_TYPE");
    if (!e) enums.getInstance()->add(e = new cEnum("RTP_IFP_TYPE"));
...
RTPControlMsgDescriptor::RTPControlMsgDescriptor() : cClassDescriptor("RTPControlMsg", "cMessage")
{
}
...
RTPControlInfoDescriptor::RTPControlInfoDescriptor() : cClassDescriptor("RTPControlInfo", "cObject")
{
}
...
const char *RTPControlInfoDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 0:
            if (!strcmp(propertyname,"enum")) return "RTP_IFP_TYPE";
            return NULL;
        default: return NULL;
    }
}
...
RTPSessionControlInfo::RTPSessionControlInfo() : ::RTPControlInfo()
{
    this->ssrc_var = 0;
}

RTPSessionControlInfo::RTPSessionControlInfo(const RTPSessionControlInfo& other) : ::RTPControlInfo(other)
{
    copy(other);
}
...
RTPSessionControlInfoDescriptor::RTPSessionControlInfoDescriptor() : cClassDescriptor("RTPSessionControlInfo", "RTPControlInfo")
{
}
...
RTPCIEnterSession::RTPCIEnterSession() : ::RTPControlInfo()
{
...
RTPCIEnterSession::RTPCIEnterSession(const RTPCIEnterSession& other) : ::RTPControlInfo(other)
{
    copy(other);
}
...
RTPCIEnterSessionDescriptor::RTPCIEnterSessionDescriptor() : cClassDescriptor("RTPCIEnterSession", "RTPControlInfo")
{
}
...
RTPCISessionEntered::RTPCISessionEntered() : ::RTPSessionControlInfo()
{
    this->setType(RTP_IFP_SESSION_ENTERED);
}

RTPCISessionEntered::RTPCISessionEntered(const RTPCISessionEntered& other) : ::RTPSessionControlInfo(other)
{
    copy(other);
}
...
{
    if (this==&other) return *this;
    ::RTPSessionControlInfo::operator=(other);
    copy(other);
    return *this;
}
...
{
    ::RTPSessionControlInfo::parsimPack(b);
}

void RTPCISessionEntered::parsimUnpack(cCommBuffer *b)
{
    ::RTPSessionControlInfo::parsimUnpack(b);
}
...
RTPCISessionEnteredDescriptor::RTPCISessionEnteredDescriptor() : cClassDescriptor("RTPCISessionEntered", "RTPSessionControlInfo")
{
}
...
RTPCISenderControl::RTPCISenderControl() : ::RTPSessionControlInfo()
{
...
RTPCISenderControl::RTPCISenderControl(const RTPCISenderControl& other) : ::RTPSessionControlInfo(other)
{
    copy(other);
}
...
RTPCISenderControlDescriptor::RTPCISenderControlDescriptor() : cClassDescriptor("RTPCISenderControl", "RTPSessionControlInfo")
{
}
...
RTPCISenderStatus::RTPCISenderStatus() : ::RTPSessionControlInfo()
{
...
RTPCISenderStatus::RTPCISenderStatus(const RTPCISenderStatus& other) : ::RTPSessionControlInfo(other)
{
    copy(other);
}
...
RTPCISenderStatusDescriptor::RTPCISenderStatusDescriptor() : cClassDescriptor("RTPCISenderStatus", "RTPSessionControlInfo")
{
}
...
RTPCILeaveSession::RTPCILeaveSession() : ::RTPControlInfo()
{
    this->setType(RTP_IFP_LEAVE_SESSION);
}

RTPCILeaveSession::RTPCILeaveSession(const RTPCILeaveSession& other) : ::RTPControlInfo(other)
{
    copy(other);
}
...
RTPCILeaveSessionDescriptor::RTPCILeaveSessionDescriptor() : cClassDescriptor("RTPCILeaveSession", "RTPControlInfo")
{
}
...
RTPCISessionLeft::RTPCISessionLeft() : ::RTPControlInfo()
{
    this->setType(RTP_IFP_SESSION_LEFT);
}

RTPCISessionLeft::RTPCISessionLeft(const RTPCISessionLeft& other) : ::RTPControlInfo(other)
{
    copy(other);
}
...
RTPCISessionLeftDescriptor::RTPCISessionLeftDescriptor() : cClassDescriptor("RTPCISessionLeft", "RTPControlInfo")
{
}
...
RTPCICreateSenderModule::RTPCICreateSenderModule() : ::RTPSessionControlInfo()
{
...
RTPCICreateSenderModule::RTPCICreateSenderModule(const RTPCICreateSenderModule& other) : ::RTPSessionControlInfo(other)
{
    copy(other);
}
...
RTPCICreateSenderModuleDescriptor::RTPCICreateSenderModuleDescriptor() : cClassDescriptor("RTPCICreateSenderModule", "RTPSessionControlInfo")
{
}
...
RTPCISenderModuleCreated::RTPCISenderModuleCreated() : ::RTPSessionControlInfo()
{
    this->setType(RTP_IFP_SENDER_MODULE_CREATED);
}

RTPCISenderModuleCreated::RTPCISenderModuleCreated(const RTPCISenderModuleCreated& other) : ::RTPSessionControlInfo(other)
{
    copy(other);
}
...
RTPCISenderModuleCreatedDescriptor::RTPCISenderModuleCreatedDescriptor() : cClassDescriptor("RTPCISenderModuleCreated", "RTPSessionControlInfo")
{
}
...
RTPCIDeleteSenderModule::RTPCIDeleteSenderModule() : ::RTPSessionControlInfo()
{
    this->setType(RTP_IFP_DELETE_SENDER_MODULE);
}

RTPCIDeleteSenderModule::RTPCIDeleteSenderModule(const RTPCIDeleteSenderModule& other) : ::RTPSessionControlInfo(other)
{
    copy(other);
}
...
RTPCIDeleteSenderModuleDescriptor::RTPCIDeleteSenderModuleDescriptor() : cClassDescriptor("RTPCIDeleteSenderModule", "RTPSessionControlInfo")
{
}
...
RTPCISenderModuleDeleted::RTPCISenderModuleDeleted() : ::RTPSessionControlInfo()
{
    this->setType(RTP_IFP_SENDER_MODULE_DELETED);
}

RTPCISenderModuleDeleted::RTPCISenderModuleDeleted(const RTPCISenderModuleDeleted& other) : ::RTPSessionControlInfo(other)
{
    copy(other);
}
...
RTPCISenderModuleDeletedDescriptor::RTPCISenderModuleDeletedDescriptor() : cClassDescriptor("RTPCISenderModuleDeleted", "RTPSessionControlInfo")
{
}
