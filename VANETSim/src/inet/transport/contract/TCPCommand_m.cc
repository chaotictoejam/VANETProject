//
// Generated file, do not edit! Created by nedtool 4.6 from src/inet/transport/contract/TCPCommand.msg.
//
...
TCPErrorInfo::TCPErrorInfo(const TCPErrorInfo& other) : ::TCPCommand(other)
{
    copy(other);
}
...
TCPOpenCommand::TCPOpenCommand(const TCPOpenCommand& other) : ::TCPCommand(other)
{
    copy(other);
}
...
void TCPOpenCommand::setLocalAddr(const IPvXAddress& localAddr)
{
...
void TCPOpenCommand::setRemoteAddr(const IPvXAddress& remoteAddr)
{
...
const char *TCPOpenCommandDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 5:
            if (!strcmp(propertyname,"enum")) return "TCPDataTransferMode";
            return NULL;
        default: return NULL;
    }
}
...
TCPSendCommand::TCPSendCommand(const TCPSendCommand& other) : ::TCPCommand(other)
{
    copy(other);
}
...
TCPConnectInfo::TCPConnectInfo(const TCPConnectInfo& other) : ::TCPCommand(other)
{
    copy(other);
}
...
void TCPConnectInfo::setLocalAddr(const IPvXAddress& localAddr)
{
    this->localAddr_var = localAddr;
}
...
void TCPConnectInfo::setRemoteAddr(const IPvXAddress& remoteAddr)
{
    this->remoteAddr_var = remoteAddr;
}
...
TCPStatusInfo::TCPStatusInfo(const TCPStatusInfo& other) : ::TCPCommand(other)
{
    copy(other);
}
...
void TCPStatusInfo::setLocalAddr(const IPvXAddress& localAddr)
{
    this->localAddr_var = localAddr;
}
...
void TCPStatusInfo::setRemoteAddr(const IPvXAddress& remoteAddr)
{
    this->remoteAddr_var = remoteAddr;
}
