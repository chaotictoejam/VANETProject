...
class aodvTraCIScenarioManagerLaunchdAccess : public ModuleAccess<aodvTraCIScenarioManagerLaunchd>
{
    public:
        aodvTraCIScenarioManagerLaunchdAccess() : ModuleAccess<aodvTraCIScenarioManagerLaunchd>("manager") {};
};
