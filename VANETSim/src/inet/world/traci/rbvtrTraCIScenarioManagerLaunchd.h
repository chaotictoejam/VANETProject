...
class rbvtrTraCIScenarioManagerLaunchdAccess : public ModuleAccess<rbvtrTraCIScenarioManagerLaunchd>
{
    public:
        rbvtrTraCIScenarioManagerLaunchdAccess() : ModuleAccess<rbvtrTraCIScenarioManagerLaunchd>("manager") {};
};
