...
#ifndef __INET_UDPBASICP2P2_H
#define __INET_UDPBASICP2P2_H
 ...
 */
class INET_API UDPBasicP2P2 : public cSimpleModule
{
public:
    enum  modoP2P
    {
...
private:
  ...
  protected:
    ...
    virtual std::vector<UDPBasicP2P2::InfoData> selectBestList(const std::vector<uint64_t> &address, const std::vector<SegmentList> &List);
    virtual std::vector<UDPBasicP2P2::InfoData>  chooseDestAddrList();



   public:
    UDPBasicP2P2();
    virtual ~UDPBasicP2P2();
