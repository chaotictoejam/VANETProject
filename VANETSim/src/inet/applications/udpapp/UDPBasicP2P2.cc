...
L3Address UDPBasicP2P2::chooseDestAddrBurst()
{
...
L3Address UDPBasicP2P2::DelayMessage::getNodeId() const
{
    return nodeId_var;
}

void UDPBasicP2P2::DelayMessage::setNodeId(L3Address nodeId)
{
    this->nodeId_var = nodeId;
}

L3Address UDPBasicP2P2::DelayMessage::getDestination() const
{
    return destination_var;
}

void UDPBasicP2P2::DelayMessage::setDestination(L3Address destination)
{
