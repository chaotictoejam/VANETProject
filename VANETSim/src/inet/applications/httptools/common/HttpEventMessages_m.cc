//
// Generated file, do not edit! Created by nedtool 4.6 from inet/applications/httptools/common/HttpEventMessages.msg.
//
...
HttpServerStatusUpdateMsgDescriptor::HttpServerStatusUpdateMsgDescriptor() : cClassDescriptor("inet::httptools::HttpServerStatusUpdateMsg", "cPacket")
{
}
