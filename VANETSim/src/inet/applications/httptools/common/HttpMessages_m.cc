...
HttpBaseMessageDescriptor::HttpBaseMessageDescriptor() : cClassDescriptor("inet::httptools::HttpBaseMessage", "cPacket")
{
}
...
HttpRequestMessageDescriptor::HttpRequestMessageDescriptor() : cClassDescriptor("inet::httptools::HttpRequestMessage", "inet::httptools::HttpBaseMessage")
{
}
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::httptools::HttpContentType");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::httptools::HttpContentType"));
...
HttpReplyMessageDescriptor::HttpReplyMessageDescriptor() : cClassDescriptor("inet::httptools::HttpReplyMessage", "inet::httptools::HttpBaseMessage")
{
}
