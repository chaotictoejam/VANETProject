...
#include "LineSegmentsVANETMobilityBase.h"
#include "FWMath.h"


LineSegmentsVANETMobilityBase::LineSegmentsVANETMobilityBase()
{
    targetPosition = Coord::ZERO;
}

void LineSegmentsVANETMobilityBase::initializePosition()
{
...
void LineSegmentsVANETMobilityBase::move()
{
