//
// Generated file, do not edit! Created by nedtool 4.6 from inet/networklayer/arp/ipv4/ARPPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::ARPOpcode");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::ARPOpcode"));
...
ARPPacketDescriptor::ARPPacketDescriptor() : cClassDescriptor("inet::ARPPacket", "cPacket")
{
}
