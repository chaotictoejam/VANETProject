...
vis_dataDescriptor::vis_dataDescriptor() : cClassDescriptor("vis_data", "")
{
}
...
HnaElementDescriptor::HnaElementDescriptor() : cClassDescriptor("HnaElement", "")
{
}
...
ManetAddress& BatmanPacket::getOrig()
{
    return orig_var;
}

void BatmanPacket::setOrig(const ManetAddress& orig)
{
    this->orig_var = orig;
}

ManetAddress& BatmanPacket::getPrevSender()
{
    return prevSender_var;
}

void BatmanPacket::setPrevSender(const ManetAddress& prevSender)
{
...
ManetAddress& visPacket::getSenderIp()
{
    return senderIp_var;
}

void visPacket::setSenderIp(const ManetAddress& senderIp)
{
