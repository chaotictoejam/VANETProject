...
DYMO_RREP::DYMO_RREP(const char *name, int kind) : ::DYMO_RM(name,kind)
{
}

DYMO_RREP::DYMO_RREP(const DYMO_RREP& other) : ::DYMO_RM(other)
{
    copy(other);
}
...
{
    ::DYMO_RM::parsimPack(b);
}

void DYMO_RREP::parsimUnpack(cCommBuffer *b)
{
    ::DYMO_RM::parsimUnpack(b);
}
...
DYMO_RREPDescriptor::DYMO_RREPDescriptor() : cClassDescriptor("DYMO_RREP", "DYMO_RM")
{
}
