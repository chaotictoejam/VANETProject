...
DYMO_RREQ::DYMO_RREQ(const char *name, int kind) : ::DYMO_RM(name,kind)
{
}

DYMO_RREQ::DYMO_RREQ(const DYMO_RREQ& other) : ::DYMO_RM(other)
{
    copy(other);
}
...
DYMO_RREQDescriptor::DYMO_RREQDescriptor() : cClassDescriptor("DYMO_RREQ", "DYMO_RM")
{
}
