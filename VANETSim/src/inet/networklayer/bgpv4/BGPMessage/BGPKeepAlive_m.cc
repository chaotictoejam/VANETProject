...
BGPKeepAliveMessage::BGPKeepAliveMessage(const char *name, int kind) : ::BGPHeader(name,kind)
{
    this->setType(BGP_KEEPALIVE);
}

BGPKeepAliveMessage::BGPKeepAliveMessage(const BGPKeepAliveMessage& other) : ::BGPHeader(other)
{
    copy(other);
}
...
BGPKeepAliveMessageDescriptor::BGPKeepAliveMessageDescriptor() : cClassDescriptor("BGPKeepAliveMessage", "BGPHeader")
{
}
