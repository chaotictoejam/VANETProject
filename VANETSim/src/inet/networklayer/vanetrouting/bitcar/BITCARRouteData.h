...
#ifndef BITCARROUTEDATA_H_
#define BITCARROUTEDATA_H_

#include <set>
#include "IPv4Address.h"
#include "INETDefs.h"

class BITCARRouteData : public cObject
{
  protected:
...
std::ostream& operator<<(std::ostream& out, const BITCARRouteData *data);

#endif // ifndef BITCARROUTEDATA_H_
