...
void NS_CLASS local_repair_timeout(void *arg)
{
    ...
    rerr_dest.s_addr = VanetAddress(IPv4Address(AODVVANET_BROADCAST));  /* Default destination */
    ...
    if (rt->nprec)
    {
        ...
        DEBUG(LOG_DEBUG, 0, "Sending AODVVANETRERR about %s to %s",
