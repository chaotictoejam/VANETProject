 ...
 *
 *****************************************************************************/
#ifndef _AVSEEK_LIST_H
#define _AVSEEK_LIST_H
...
avseek_list_t *avseek_list_insert(struct in_addr dest_addr, u_int32_t dest_seqno,
                              int ttl, u_int8_t flags, struct ip_data *ipd);
int avseek_list_remove(avseek_list_t * entry);
avseek_list_t *avseek_list_find(struct in_addr dest_addr);
