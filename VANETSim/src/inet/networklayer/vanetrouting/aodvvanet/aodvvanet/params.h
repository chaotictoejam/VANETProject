...
/* If expanding ring search is used, BLACKAVLIST_TIMEOUT should be?: */
#define BLACKAVLIST_TIMEOUT       AODVVANETRREQ_RETRIES * NET_TRAVERSAL_TIME + (TTL_THRESHOLD - TTL_START)/TTL_INCREMENT + 1 + AODVVANETRREQ_RETRIES
...
#define AODVVANETRERR_RATELIMIT          10
#define RING_TRAVERSAL_TIME     2 * NODE_TRAVERSAL_TIME * (TTL_VALUE + TIMEOUT_BUFFER)
#define AODVVANETRREQ_RETRIES            2
#define AODVVANETRREQ_RATELIMIT          10
