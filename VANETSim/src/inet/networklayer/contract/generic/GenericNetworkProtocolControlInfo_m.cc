...
GenericNetworkProtocolControlInfoDescriptor::GenericNetworkProtocolControlInfoDescriptor() : cClassDescriptor("inet::GenericNetworkProtocolControlInfo", "cObject")
{
}
...
GenericRoutingDecisionDescriptor::GenericRoutingDecisionDescriptor() : cClassDescriptor("inet::GenericRoutingDecision", "cObject")
{
}
