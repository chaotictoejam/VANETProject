//
// Generated file, do not edit! Created by nedtool 4.6 from inet/networklayer/contract/ipv6/IPv6ControlInfo.msg.
//
...
IPv6ControlInfoDescriptor::IPv6ControlInfoDescriptor() : cClassDescriptor("inet::IPv6ControlInfo", "cObject")
{
}
