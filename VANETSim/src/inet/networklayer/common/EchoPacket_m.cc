//
// Generated file, do not edit! Created by nedtool 4.6 from networklayer/common/EchoPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::EchoProtocolType");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::EchoProtocolType"));
...
EchoPacketDescriptor::EchoPacketDescriptor() : cClassDescriptor("inet::EchoPacket", "cPacket")
{
}
