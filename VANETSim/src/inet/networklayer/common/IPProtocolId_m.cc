...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::IPProtocolId");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::IPProtocolId"));
...
IPRegisterProtocolCommandDescriptor::IPRegisterProtocolCommandDescriptor() : cClassDescriptor("inet::IPRegisterProtocolCommand", "cObject")
{
}
