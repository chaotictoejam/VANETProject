//
// Generated file, do not edit! Created by nedtool 4.6 from inet/networklayer/common/SimpleNetworkProtocolControlInfo.msg.
//
...
SimpleNetworkProtocolControlInfoDescriptor::SimpleNetworkProtocolControlInfoDescriptor() : cClassDescriptor("inet::SimpleNetworkProtocolControlInfo", "cObject")
{
}
