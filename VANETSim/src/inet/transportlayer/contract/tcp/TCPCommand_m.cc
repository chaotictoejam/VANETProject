...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::TcpCommandCode");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::TcpCommandCode"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::TcpStatusInd");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::TcpStatusInd"));
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::TCPErrorCode");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::TCPErrorCode"));
);
...
TCPCommandDescriptor::TCPCommandDescriptor() : cClassDescriptor("inet::TCPCommand", "cObject")
{
}
...
TCPErrorInfoDescriptor::TCPErrorInfoDescriptor() : cClassDescriptor("inet::TCPErrorInfo", "inet::TCPCommand")
{
}
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::TCPDataTransferMode");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::TCPDataTransferMode"));
...
TCPOpenCommandDescriptor::TCPOpenCommandDescriptor() : cClassDescriptor("inet::TCPOpenCommand", "inet::TCPCommand")
{
}
...
TCPSendCommandDescriptor::TCPSendCommandDescriptor() : cClassDescriptor("inet::TCPSendCommand", "inet::TCPCommand")
{
}
...
TCPConnectInfoDescriptor::TCPConnectInfoDescriptor() : cClassDescriptor("inet::TCPConnectInfo", "inet::TCPCommand")
{
}
...
TCPStatusInfoDescriptor::TCPStatusInfoDescriptor() : cClassDescriptor("inet::TCPStatusInfo", "inet::TCPCommand")
{
}
