...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::rtp::RTPSenderStatus");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::rtp::RTPSenderStatus"));
...
RTPSenderStatusMessageDescriptor::RTPSenderStatusMessageDescriptor() : cClassDescriptor("inet::rtp::RTPSenderStatusMessage", "cPacket")
{
}
