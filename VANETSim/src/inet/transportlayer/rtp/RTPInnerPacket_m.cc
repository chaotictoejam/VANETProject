...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::rtp::RTP_INP_TYPE");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::rtp::RTP_INP_TYPE"));
...
RTPInnerPacketDescriptor::RTPInnerPacketDescriptor() : cClassDescriptor("inet::rtp::RTPInnerPacket", "cPacket")
{
}
