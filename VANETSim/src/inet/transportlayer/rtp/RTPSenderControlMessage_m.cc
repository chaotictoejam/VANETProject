...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::rtp::RTPSenderControlMessageCommands");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::rtp::RTPSenderControlMessageCommands"));
...
RTPSenderControlMessageDescriptor::RTPSenderControlMessageDescriptor() : cClassDescriptor("inet::rtp::RTPSenderControlMessage", "cPacket")
{
}
