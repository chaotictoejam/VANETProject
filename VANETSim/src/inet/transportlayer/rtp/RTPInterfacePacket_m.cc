...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::rtp::RTP_IFP_TYPE");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::rtp::RTP_IFP_TYPE"));
...
RTPControlMsgDescriptor::RTPControlMsgDescriptor() : cClassDescriptor("inet::rtp::RTPControlMsg", "cMessage")
{
}
...
RTPControlInfoDescriptor::RTPControlInfoDescriptor() : cClassDescriptor("inet::rtp::RTPControlInfo", "cObject")
{
}
...
RTPSessionControlInfoDescriptor::RTPSessionControlInfoDescriptor() : cClassDescriptor("inet::rtp::RTPSessionControlInfo", "inet::rtp::RTPControlInfo")
{
}
...
RTPCIEnterSessionDescriptor::RTPCIEnterSessionDescriptor() : cClassDescriptor("inet::rtp::RTPCIEnterSession", "inet::rtp::RTPControlInfo")
{
}
...
RTPCISessionEnteredDescriptor::RTPCISessionEnteredDescriptor() : cClassDescriptor("inet::rtp::RTPCISessionEntered", "inet::rtp::RTPSessionControlInfo")
{
}
...
RTPCISenderControlDescriptor::RTPCISenderControlDescriptor() : cClassDescriptor("inet::rtp::RTPCISenderControl", "inet::rtp::RTPSessionControlInfo")
{
}
...
RTPCISenderStatusDescriptor::RTPCISenderStatusDescriptor() : cClassDescriptor("inet::rtp::RTPCISenderStatus", "inet::rtp::RTPSessionControlInfo")
{
}
...
RTPCILeaveSessionDescriptor::RTPCILeaveSessionDescriptor() : cClassDescriptor("inet::rtp::RTPCILeaveSession", "inet::rtp::RTPControlInfo")
{
}
...
RTPCISessionLeftDescriptor::RTPCISessionLeftDescriptor() : cClassDescriptor("inet::rtp::RTPCISessionLeft", "inet::rtp::RTPControlInfo")
{
}
...
RTPCICreateSenderModuleDescriptor::RTPCICreateSenderModuleDescriptor() : cClassDescriptor("inet::rtp::RTPCICreateSenderModule", "inet::rtp::RTPSessionControlInfo")
{
}
...
RTPCISenderModuleCreatedDescriptor::RTPCISenderModuleCreatedDescriptor() : cClassDescriptor("inet::rtp::RTPCISenderModuleCreated", "inet::rtp::RTPSessionControlInfo")
{
}
...
RTPCIDeleteSenderModuleDescriptor::RTPCIDeleteSenderModuleDescriptor() : cClassDescriptor("inet::rtp::RTPCIDeleteSenderModule", "inet::rtp::RTPSessionControlInfo")
{
}
...
RTPCISenderModuleDeletedDescriptor::RTPCISenderModuleDeletedDescriptor() : cClassDescriptor("inet::rtp::RTPCISenderModuleDeleted", "inet::rtp::RTPSessionControlInfo")
{
}
