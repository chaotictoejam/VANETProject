...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::rtp::RTCPPacketType");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::rtp::RTCPPacketType"));
...
RTCPPacketDescriptor::RTCPPacketDescriptor() : cClassDescriptor("inet::rtp::RTCPPacket", "cPacket")
{
}
...
RTCPCompoundPacketDescriptor::RTCPCompoundPacketDescriptor() : cClassDescriptor("inet::rtp::RTCPCompoundPacket", "cPacket")
{
}
