...
RTCPReceiverReportPacketDescriptor::RTCPReceiverReportPacketDescriptor() : cClassDescriptor("inet::rtp::RTCPReceiverReportPacket", "inet::rtp::RTCPPacket")
{
}
...
RTCPSDESPacketDescriptor::RTCPSDESPacketDescriptor() : cClassDescriptor("inet::rtp::RTCPSDESPacket", "inet::rtp::RTCPPacket")
{
}
...
RTCPByePacketDescriptor::RTCPByePacketDescriptor() : cClassDescriptor("inet::rtp::RTCPByePacket", "inet::rtp::RTCPPacket")
{
}
