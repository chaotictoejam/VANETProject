//
// Generated file, do not edit! Created by nedtool 4.6 from inet/transportlayer/rtp/RTPPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::rtp::RTPPacketEnums");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::rtp::RTPPacketEnums"));
...
RTPPacketDescriptor::RTPPacketDescriptor() : cClassDescriptor("inet::rtp::RTPPacket", "cPacket")
{
}
