//
// Generated file, do not edit! Created by nedtool 4.6 from inet/routing/rip/RIPPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::RIPCommand");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::RIPCommand"));
    e->insert(RIP_REQUEST, "RIP_REQUEST");
    e->insert(RIP_RESPONSE, "RIP_RESPONSE");
);

EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::RIP_AF");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::RIP_AF"));
...
RIPEntryDescriptor::RIPEntryDescriptor() : cClassDescriptor("inet::RIPEntry", "")
{
}
...
RIPPacketDescriptor::RIPPacketDescriptor() : cClassDescriptor("inet::RIPPacket", "cPacket")
{
}
