...
{
    doPacking(b,(::inet::Ieee802Ctrl&)*this);
...
{
    doUnpacking(b,(::inet::Ieee802Ctrl&)*this);
...
MeshControlInfoDescriptor::MeshControlInfoDescriptor() : cClassDescriptor("inet::inetmanet::MeshControlInfo", "inet::Ieee802Ctrl")
{
}
