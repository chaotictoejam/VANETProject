//
// Generated file, do not edit! Created by nedtool 4.6 from inet/routing/extras/base/ControlManetRouting.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::inetmanet::ManetControlType");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::inetmanet::ManetControlType"));
...
L3Address& ControlManetRouting::getSrcAddress()
{
    return srcAddress_var;
}

void ControlManetRouting::setSrcAddress(const L3Address& srcAddress)
{
    this->srcAddress_var = srcAddress;
}

L3Address& ControlManetRouting::getDestAddress()
{
    return destAddress_var;
}

void ControlManetRouting::setDestAddress(const L3Address& destAddress)
{
...
ControlManetRoutingDescriptor::ControlManetRoutingDescriptor() : cClassDescriptor("inet::inetmanet::ControlManetRouting", "cPacket")
{
}
...
const char *ControlManetRoutingDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    ...
    switch (field) {
        case 2:
            if (!strcmp(propertyname,"enum")) return "inet::inetmanet::ManetControlType";
            return NULL;
        default: return NULL;
    }
}
