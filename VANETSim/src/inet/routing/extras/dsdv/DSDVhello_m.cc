//
// Generated file, do not edit! Created by nedtool 4.6 from inet/routing/extras/dsdv/DSDVhello.msg.
//
...
DSDV_HelloMessageDescriptor::DSDV_HelloMessageDescriptor() : cClassDescriptor("inet::inetmanet::DSDV_HelloMessage", "cPacket")
{
}
