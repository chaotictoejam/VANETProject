//
// Generated file, do not edit! Created by nedtool 4.6 from inet/routing/extras/dymo_fau/DYMO_Packet.msg.
//
...
DYMO_PacketDescriptor::DYMO_PacketDescriptor() : cClassDescriptor("inet::inetmanet::DYMO_Packet", "cPacket")
{
}
