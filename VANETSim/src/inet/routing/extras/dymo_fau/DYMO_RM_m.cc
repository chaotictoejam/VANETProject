//
// Generated file, do not edit! Created by nedtool 4.6 from inet/routing/extras/dymo_fau/DYMO_RM.msg.
//
...
DYMO_RM::DYMO_RM(const char *name, int kind) : ::inet::inetmanet::DYMO_PacketBBMessage(name,kind)
{
}

DYMO_RM::DYMO_RM(const DYMO_RM& other) : ::inet::inetmanet::DYMO_PacketBBMessage(other)
{
    copy(other);
}
...
DYMO_RMDescriptor::DYMO_RMDescriptor() : cClassDescriptor("inet::inetmanet::DYMO_RM", "inet::inetmanet::DYMO_PacketBBMessage")
{
}
