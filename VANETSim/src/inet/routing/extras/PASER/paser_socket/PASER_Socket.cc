...
void PASER_Socket::MY_omnet_chg_rte(const L3Address &destination, const L3Address &nextHop,
        const L3Address &mask, short int hops, bool del_entry, int ifaceIndex) {
