...
#ifndef __INET_IPv4_paser_H
#define __INET_IPv4_paser_H
 ...
 */
class INET_API IPv4_paser : public QueueBase, public INetfilter, public ILifecycle, public cListener, public INetworkProtocol
{
  public:
    /**
