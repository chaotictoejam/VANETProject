//
// Generated file, do not edit! Created by nedtool 4.6 from routing/extras/olsr/OLSRpkt.msg.
//
...
OLSR_pktDescriptor::OLSR_pktDescriptor() : cClassDescriptor("inet::inetmanet::OLSR_pkt", "cPacket")
{
}
