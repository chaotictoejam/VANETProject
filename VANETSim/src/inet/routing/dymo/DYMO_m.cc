//
// Generated file, do not edit! Created by nedtool 4.6 from inet/routing/dymo/DYMO.msg.
//
...
AddressBlock::AddressBlock() : ::cObject()
{
    ...
    this->metricType_var = (DYMOMetricType)-1;
...
AddressBlockDescriptor::AddressBlockDescriptor() : cClassDescriptor("inet::dymo::AddressBlock", "cObject")
{
}
...
RREQTimerDescriptor::RREQTimerDescriptor() : cClassDescriptor("inet::dymo::RREQTimer", "cMessage")
{
}
...
RREQWaitRREPTimerDescriptor::RREQWaitRREPTimerDescriptor() : cClassDescriptor("inet::dymo::RREQWaitRREPTimer", "inet::dymo::RREQTimer")
{
}
...
RREQBackoffTimerDescriptor::RREQBackoffTimerDescriptor() : cClassDescriptor("inet::dymo::RREQBackoffTimer", "inet::dymo::RREQTimer")
{
}
...
RREQHolddownTimerDescriptor::RREQHolddownTimerDescriptor() : cClassDescriptor("inet::dymo::RREQHolddownTimer", "inet::dymo::RREQTimer")
{
}
...
DYMOPacketDescriptor::DYMOPacketDescriptor() : cClassDescriptor("inet::dymo::DYMOPacket", "cPacket")
{
}
...
RteMsgDescriptor::RteMsgDescriptor() : cClassDescriptor("inet::dymo::RteMsg", "inet::dymo::DYMOPacket")
{
}
...
RREQDescriptor::RREQDescriptor() : cClassDescriptor("inet::dymo::RREQ", "inet::dymo::RteMsg")
{
}
...
RREPDescriptor::RREPDescriptor() : cClassDescriptor("inet::dymo::RREP", "inet::dymo::RteMsg")
{
}
...
RREP_ACKDescriptor::RREP_ACKDescriptor() : cClassDescriptor("inet::dymo::RREP_ACK", "inet::dymo::DYMOPacket")
{
}
...
RERRDescriptor::RERRDescriptor() : cClassDescriptor("inet::dymo::RERR", "inet::dymo::DYMOPacket")
{
}
