//
// Generated file, do not edit! Created by nedtool 4.6 from inet/routing/ospfv2/OSPFPacket.msg.
//
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::ospf::OSPFPacketType");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::ospf::OSPFPacketType"));
...
OSPFOptionsDescriptor::OSPFOptionsDescriptor() : cClassDescriptor("inet::ospf::OSPFOptions", "")
{
}
...
OSPFPacketDescriptor::OSPFPacketDescriptor() : cClassDescriptor("inet::ospf::OSPFPacket", "cPacket")
{
}
...
OSPFHelloPacketDescriptor::OSPFHelloPacketDescriptor() : cClassDescriptor("inet::ospf::OSPFHelloPacket", "inet::ospf::OSPFPacket")
{
}
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::ospf::LSAType");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::ospf::LSAType"));
...
OSPFLSAHeaderDescriptor::OSPFLSAHeaderDescriptor() : cClassDescriptor("inet::ospf::OSPFLSAHeader", "cObject")
{
}
...
OSPFLSADescriptor::OSPFLSADescriptor() : cClassDescriptor("inet::ospf::OSPFLSA", "cObject")
{
}
...
EXECUTE_ON_STARTUP(
    cEnum *e = cEnum::find("inet::ospf::LinkType");
    if (!e) enums.getInstance()->add(e = new cEnum("inet::ospf::LinkType"));
...
TOSDataDescriptor::TOSDataDescriptor() : cClassDescriptor("inet::ospf::TOSData", "")
{
}
...
LinkDescriptor::LinkDescriptor() : cClassDescriptor("inet::ospf::Link", "cObject")
{
}
...
OSPFRouterLSADescriptor::OSPFRouterLSADescriptor() : cClassDescriptor("inet::ospf::OSPFRouterLSA", "inet::ospf::OSPFLSA")
{
}
...
OSPFNetworkLSADescriptor::OSPFNetworkLSADescriptor() : cClassDescriptor("inet::ospf::OSPFNetworkLSA", "inet::ospf::OSPFLSA")
{
}
...
OSPFSummaryLSADescriptor::OSPFSummaryLSADescriptor() : cClassDescriptor("inet::ospf::OSPFSummaryLSA", "inet::ospf::OSPFLSA")
{
}
...
ExternalTOSInfoDescriptor::ExternalTOSInfoDescriptor() : cClassDescriptor("inet::ospf::ExternalTOSInfo", "")
{
}
...
OSPFASExternalLSAContentsDescriptor::OSPFASExternalLSAContentsDescriptor() : cClassDescriptor("inet::ospf::OSPFASExternalLSAContents", "cObject")
{
}
...
OSPFASExternalLSADescriptor::OSPFASExternalLSADescriptor() : cClassDescriptor("inet::ospf::OSPFASExternalLSA", "inet::ospf::OSPFLSA")
{
}
...
OSPFDDOptionsDescriptor::OSPFDDOptionsDescriptor() : cClassDescriptor("inet::ospf::OSPFDDOptions", "")
{
}
...
OSPFDatabaseDescriptionPacketDescriptor::OSPFDatabaseDescriptionPacketDescriptor() : cClassDescriptor("inet::ospf::OSPFDatabaseDescriptionPacket", "inet::ospf::OSPFPacket")
{
}
...
LSARequestDescriptor::LSARequestDescriptor() : cClassDescriptor("inet::ospf::LSARequest", "")
{
}
...
OSPFLinkStateRequestPacketDescriptor::OSPFLinkStateRequestPacketDescriptor() : cClassDescriptor("inet::ospf::OSPFLinkStateRequestPacket", "inet::ospf::OSPFPacket")
{
}
...
OSPFLinkStateUpdatePacketDescriptor::OSPFLinkStateUpdatePacketDescriptor() : cClassDescriptor("inet::ospf::OSPFLinkStateUpdatePacket", "inet::ospf::OSPFPacket")
{
}
...
OSPFLinkStateAcknowledgementPacketDescriptor::OSPFLinkStateAcknowledgementPacketDescriptor() : cClassDescriptor("inet::ospf::OSPFLinkStateAcknowledgementPacket", "inet::ospf::OSPFPacket")
{
}
