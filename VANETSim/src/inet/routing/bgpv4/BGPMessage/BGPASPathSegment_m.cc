//
// Generated file, do not edit! Created by nedtool 4.6 from inet/routing/bgpv4/BGPMessage/BGPASPathSegment.msg.
//
...
BGPASPathSegmentDescriptor::BGPASPathSegmentDescriptor() : cClassDescriptor("inet::bgp::BGPASPathSegment", "cObject")
{
}
