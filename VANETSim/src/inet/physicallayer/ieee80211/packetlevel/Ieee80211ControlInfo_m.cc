//
// Generated file, do not edit! Created by nedtool 4.6 from physicallayer/ieee80211/packetlevel/Ieee80211ControlInfo.msg.
//
...
{
    doPacking(b,(::inet::physicallayer::ConfigureRadioCommand&)*this);
...
{
    doUnpacking(b,(::inet::physicallayer::ConfigureRadioCommand&)*this);
...
char Ieee80211ConfigureRadioCommand::getOpMode() const
{
    return opMode_var;
}

void Ieee80211ConfigureRadioCommand::setOpMode(char opMode)
{
...
Ieee80211ConfigureRadioCommandDescriptor::Ieee80211ConfigureRadioCommandDescriptor() : cClassDescriptor("inet::physicallayer::Ieee80211ConfigureRadioCommand", "inet::physicallayer::ConfigureRadioCommand")
{
}
...
std::string Ieee80211ConfigureRadioCommandDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    Ieee80211ConfigureRadioCommand *pp = (Ieee80211ConfigureRadioCommand *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getOpMode());
...
bool Ieee80211ConfigureRadioCommandDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    Ieee80211ConfigureRadioCommand *pp = (Ieee80211ConfigureRadioCommand *)object; (void)pp;
    switch (field) {
        case 0: pp->setOpMode(string2long(value)); return true;
...
{
    doPacking(b,(::inet::physicallayer::TransmissionRequest&)*this);
    doPacking(b,this->mode_var);
    doPacking(b,this->channelNumber_var);
    doPacking(b,this->channel_var);
}
...
{
    doUnpacking(b,(::inet::physicallayer::TransmissionRequest&)*this);
    doUnpacking(b,this->mode_var);
    doUnpacking(b,this->channelNumber_var);
    doUnpacking(b,this->channel_var);
}
...
Ieee80211TransmissionRequestDescriptor::Ieee80211TransmissionRequestDescriptor() : cClassDescriptor("inet::physicallayer::Ieee80211TransmissionRequest", "inet::physicallayer::TransmissionRequest")
{
}
...
{
    doPacking(b,(::inet::physicallayer::ReceptionIndication&)*this);
    doPacking(b,this->mode_var);
    doPacking(b,this->channel_var);
...
{
    doUnpacking(b,(::inet::physicallayer::ReceptionIndication&)*this);
    doUnpacking(b,this->mode_var);
    doUnpacking(b,this->channel_var);
...
Ieee80211ReceptionIndicationDescriptor::Ieee80211ReceptionIndicationDescriptor() : cClassDescriptor("inet::physicallayer::Ieee80211ReceptionIndication", "inet::physicallayer::ReceptionIndication")
{
}
