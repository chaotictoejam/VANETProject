...
#ifndef LINE_SEGMENTS_VANET_MOBILITY_BASE_H
#define LINE_SEGMENTS_VANET_MOBILITY_BASE_H
 ...
 * @author Andras Varga
 */
class LineSegmentsVANETMobilityBase : public MovingVANETMobilityBase
{
  protected:
