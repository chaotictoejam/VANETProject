...
class v_TraCIMobility : public VANETMobilityBase
{
    public:
        ...
        virtual std::string getExternalId() const {
            if (external_id == "") throw cRuntimeError("TraCIMobilityBase::getExternalId called with no external_id set yet");
            return external_id;
        }
        ...
        virtual std::string getRoadId() const {
            if (road_id == "") throw cRuntimeError("TraCIMobilityBase::getRoadId called with no road_id set yet");
            return road_id;
        }
        ...
        virtual double getAngleRad() const {
            if (angle == M_PI) throw cRuntimeError("TraCIMobilityBase::getAngleRad called with no angle set yet");
            return angle;
        }
