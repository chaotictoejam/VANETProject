 ...
 * through the IVANETMobility interface.
 *
 * @ingroup mobility
 * @ingroup basicModules
 * @author Daniel Willkomm, Andras Varga
 */
class VANETMobilityBase : public cSimpleModule, public IVANETMobility
{
  public:
    /**
