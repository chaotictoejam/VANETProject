...
#ifndef RBVTRROUTEDATA_H_
#define RBVTRROUTEDATA_H_

#include <set>
#include "IPv4Address.h"
#include "INETDefs.h"

class RBVTRRouteData : public cObject
{
  protected:
...
std::ostream& operator<<(std::ostream& out, const RBVTRRouteData *data);

#endif // ifndef RBVTRROUTEDATA_H_
