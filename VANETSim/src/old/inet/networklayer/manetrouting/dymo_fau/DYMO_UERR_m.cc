//
// Generated file, do not edit! Created by nedtool 4.6 from inet/networklayer/manetrouting/dymo_fau/DYMO_UERR.msg.
//
...
DYMO_UERR::DYMO_UERR(const char *name, int kind) : ::DYMO_PacketBBMessage(name,kind)
{
...
DYMO_UERR::DYMO_UERR(const DYMO_UERR& other) : ::DYMO_PacketBBMessage(other)
{
    copy(other);
}
...
DYMO_UERRDescriptor::DYMO_UERRDescriptor() : cClassDescriptor("DYMO_UERR", "DYMO_PacketBBMessage")
{
}
