...
class INET_API IPv4Route : public cObject
{
  public:
    ...
    enum SourceType
    {
        ...
        AODV,         ///< managed by the given routing protocol
        VANET,        ///< managed by vanet, search exact address
        VANET2,       ///< managed by vanet, search approximate address
        AODVVANET,    ///< managed by the given routing protocol
        BITCAR,       ///< managed by the given routing protocol
        RBVTR,        ///< managed by the given routing protocol
    };
